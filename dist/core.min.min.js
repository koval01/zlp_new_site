...
var site_domains = {
  ...
  getImageLightness = function getImageLightness(a, b) {
    ...
    c && (d.onload = function () {
      ...
      f = imageData.data;
      for (var h, l, m = 0, k = f.length; m < k; m += 4) g = f[m], h = f[m + 1], l = f[m + 2], g = Math.floor((g + h + l) / 3), e += g;
  ...
  appendPostsNews = function appendPostsNews() {
    var a = function a(b) {
      ...
      for (var d = function d(h) {
          ...
          f.style.fontSize = "calc(".concat(l(parseFloat(1.8 - g), g), "vw + ").concat(l(parseFloat(1.8 - g), g), "vh + ").concat(l(parseFloat(1.9 - g), g), "vmin)");
          f.style.padding = "".concat(l(parseFloat(1.3 - g), g, .22, 1.05), "rem");
          var m = function m() {
            var k = document.getElementById("news_text_".concat(h)),
              n = parseFloat(window.getComputedStyle(k, null).getPropertyValue("font-size").replace("px", ""));
            k.style.maxHeight = "32vh";
            12 < n ? (k.style.position = "absolute", k.style.textAlign = "center", k.style.alignItems = "center", k.style.display = "inline-block", k.style.paddingBottom = "5rem", k.style.paddingRight = "3rem") : (k.style.position = "", k.style.textAlign = "", k.style.alignItems = "", k.style.display = "", k.style.paddingBottom = "", k.style.paddingRight = "");
          };
          addEventListener("resize", function (k) {
            return m();
          });
          setInterval(m, 50);
          getImageLightness(b[h].cover, function (k) {
            k = "#000000".concat(((parseFloat(k) / 255 * 100).toFixed() + 64).toString(16).slice(0, 2));
            document.getElementById("news-overlay-".concat(h)).style.background = k;
          });
        }, e = 0; e < b.length; e++) {
        var f, g;
        d(e);
      ...
      c = function c() {
        setTimeout(function () {
          var h = document.getElementById("telegram_block_load"),
            l = document.getElementById("news_zlp_buttons");
          try {
            h.parentNode.removeChild(h), l.style.display = "";
          } catch (m) {}
        }, 150);
      };
          ...
          if (console.debug(f), f.success) {
            ...
            if (glob_auth_player_data = f.player_data) {
              ...
              setInterval(function () {
                (!g.style.backgroundImage || 1 > g.style.backgroundImage.length) && loadPlayerAvatar(l);
              }, 150);
            }
            telegram_glob_session = {
              auth_data: d,
  ...
  ytVideoSetter = function ytVideoSetter() {
    for (var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : !1, b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !0, c = function c(l, m, k) {
        ...
        b ? c(l, m, k) : get_yt_video_(function (n) {
          n && n.video.x720.url && !a ? l.innerHTML = '\n                    <video class="video-container" '.concat(null != k.autoplay ? 'autoplay=""' : "", " ").concat(null != k.muted ? 'muted=""' : "", " ").concat(null != k.loop ? 'loop=""' : "", " ").concat(null != k.controls ? 'controls=""' : "", ' style="object-fit: contain">\n                        <source src="').concat(n.video.x720.url, '" type="video/mp4">\n                    </video>\n                ') : c(l, m, k);
        }, m, a);
  ...
  switch_modal_containers = function switch_modal_containers() {
    ...
    for (e = 0; e < d.length; e++) f = "none", a === d[e].name && (f = "block", l.innerText = d[e].title), d[e].selector.style.display = f;
    "info" === a && (l.innerText = b.title, b.content.length && (document.getElementById("info-content-modal").innerHTML = b.content));
    c.onclick = function () {
      modal_close_();
    };
  },
  ...
  displayTokens = function displayTokens() {
    var a = document.querySelector(".balance-container"),
      b = document.querySelector(".balance-value"),
      c = glob_auth_player_data.BALANCE;
    c && (a.style.display = "", b.innerText = c);
  },
    ...
    (function (b) {
      ...
      requestCall(function (c) {
        ...
        getPlayersSkins(function (g) {
          for (var h = function h(m) {
              glob_players.push(c[m].name);
              g = function () {
                var n = "";
                c[m].badges.sort();
                for (var p = 0; p < c[m].badges.length; p++) {
                  var q = c[m].badges[p];
              ...
              var k = function () {
                for (var n = 0; n < c[m].badges.length; n++) if (c[m].badges[n].includes("clan-")) return c[m].badges[n].replace("clan-", "");
              }();
              c[m].head = prepare_img_link(c[m].head);
              a.innerHTML += '\n                        <div class="swiper-slide text-center">\n                            <span class="d-block py-3">\n                                <div class="player_head_container">\n                                    '.concat(k ? '<div \n                                        class="player_clan_badge"\n                                        data-bs-toggle="tooltip" data-bs-placement="top"\n                                        title="'.concat(k, '"\n                                    ></div>') : "", '\n                                    <div \n                                        class="player-head d-block mx-auto" \n                                        style="background-image: url(').concat(c[m].head, ')"\n                                    ></div>\n                                </div>\n                                <div class="card-body p-3">\n                                    <h3 class="fs-lg fw-semibold pt-1 mb-2">\n                                        ').concat(c[m].name, "\n                                        ").concat(c[m].badges.includes("verified") ? "\n                                            <i class=\"verified-icon\"\n                                            data-bs-toggle=\"tooltip\" data-bs-placement=\"top\"\n                                            title=\"\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u043D\u044B\u0439\"> \u2714</i>\n                                        " : "", '\n                                    </h3>\n                                    \x3c!-- <div class="player_badge_container" style="').concat(g.length ? "" : "display:none", '">\n                                        ').concat(g, '\n                                    </div> --\x3e\n                                    <p class="fs-sm mb-0">').concat(c[m].desc, "</p>\n                                </div>\n                            </span>\n                        </div>\n                    ");
            }, l = 0; l < c.length; l++) h(l);
          try {
  ...
  donate_element_click = function donate_element_click(a) {
    ...
    if ((b.includes(a.type) || "group" === a.type) && groupAlreadyInCart(h)) {
      ...
      var k = "";
      k = "group" === a.type ? "\u0412\u044B \u0443\u0436\u0435 \u0432\u044B\u0431\u0440\u0430\u043B\u0438 \u043F\u0440\u0438\u0432\u0438\u043B\u0435\u0433\u0438\u044E. \u0423\u0434\u0430\u043B\u0438\u0442\u0435 \u0435\u0451 \u0438\u0437 \u043A\u043E\u0440\u0437\u0438\u043D\u044B, \u0435\u0441\u043B\u0438 \u0445\u043E\u0442\u0438\u0442\u0435 \u0432\u044B\u0431\u0440\u0430\u0442\u044C \u0434\u0440\u0443\u0433\u0443\u044E." : m ? "\u041E\u0448\u0438\u0431\u043A\u0430, \u0432\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440 \n                <span class=\"text-primary fw-semibold\">".concat(a.name, "</span> \n                \u0442\u043E\u043B\u044C\u043A\u043E \u043E\u0434\u0438\u043D \u0440\u0430\u0437.") : "\u041C\u044B \u043D\u0435 \u0437\u043D\u0430\u0435\u043C \u043F\u043E\u0447\u0435\u043C\u0443, \u043D\u043E \u044D\u0442\u0430 \u043E\u0448\u0438\u0431\u043A\u0430 \u0432\u044B\u0437\u0432\u0430\u043D\u0430 \u043F\u043E \u043D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u043C \u043F\u0440\u0438\u0447\u0438\u043D\u0430\u043C.";
      document.getElementById("donate_info_block_text").innerHTML = k;
    }
    m = "block";
  ...
  couponCheck = function couponCheck(a) {
    ...
    var e = function e() {
      ...
      f = function f(h, l) {
        if (h) for (l = 0; l < h.length; l++) if (h[l].id === current_c_item) return !0;
        return !1;
      };
    if (d.length) {
        ...
        if (checked_coupon === d) notify("\u042D\u0442\u043E\u0442 \u043A\u0443\u043F\u043E\u043D \u0443\u0436\u0435 \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0435\u0442\u0441\u044F");else if (failed_coupon === d) e();else {
          ...
          check_coupon(function (h) {
            if (h) {
              ...
              coins_sell_mode ? f(h.products, current_c_item) ? (l(), document.getElementById("donate-coins-payment").innerHTML = "<li class=\"list-group-item d-flex justify-content-between bg-light\">\n                        <div class=\"text-primary\">\n                            <h6 class=\"my-0 text-start\">\u041A\u0443\u043F\u043E\u043D</h6>\n                            <small class=\"text-start\" style=\"float: left\">".concat(d, '</small>\n                        </div>\n                        <span class="text-muted text-end" style="width: 30%">\n                            ').concat(h.discount, "%</span>\n                    </li>")) : notify("\u042D\u0442\u043E\u0442 \u043A\u0443\u043F\u043E\u043D \u043D\u0435\u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0439") : (l(), donateCartCall(d, !1));
  ...
  donateModalCall = function donateModalCall(a, b) {
    ...
    (function (p) {
      k.innerText = k.innerText.replace(/\([\s\S]*?\)/).trim();
      k.innerText = "".concat(k.innerText, " (").concat(p, ")");
    })(n);
  },
