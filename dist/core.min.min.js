...
var site_domains = {
  ...
  alternateSort = function alternateSort(a) {
    for (var b, c = 0; c < a.length; c++) {
      b = c;
      for (var d = a[c], e = c + 1; e < a.length; e++) a[e] < d && (d = a[e], b = e);
      d < a[c] && (d = a[c], a[c] = a[b], a[b] = d);
    }
  },
  getImageLightness = function getImageLightness(a, b) {
    ...
    c && (d.onload = function () {
      ...
      g.width = _this.width;
      g.height = _this.height;
      var f = g.getContext("2d");
      try {
        f.drawImage(_this, 0, 0), f.getImageData(0, 0, g.width, g.height);
      } catch (n) {
        b(null);
        return;
      }
      g = imageData.data;
      for (var h, k, l = 0, m = g.length; l < m; l += 4) f = g[l], h = g[l + 1], k = g[l + 2], f = Math.floor((f + h + k) / 3), e += f;
  ...
  appendPostsNews = function appendPostsNews() {
    var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : !0,
      b = function b() {
        setTimeout(function () {
          var d = document.getElementById("telegram_block_load"),
            e = document.getElementById("news_zlp_buttons");
          try {
            d.parentNode.removeChild(d), e.style.display = "";
          } catch (g) {}
        }, 150);
      };
    if (a) a = document.getElementById("news-c-container"), a.innerHTML = '\n        <div class="shadow-vertical-overlay vertical-top-shadow" style="width:100vw!important"></div>\n        <div class="shadow-vertical-overlay vertical-bottom-shadow" style="width:100vw!important"></div>\n        <iframe \n            style="min-height:450px;width:100vw" \n            id="tg-iframe-view"\n            src="https://telegram-worker.zalupa.online/zalupaonline" \n            onload="try{document.getElementById(\'telegram_block_load\').remove()} catch {}">\n        </iframe>' + a.innerHTML, b(), document.getElementById("theme-mode").addEventListener("change", function () {
      var d = document.getElementById("tg-iframe-view"),
        e = new URL(d.src);
      e.hash = this.checked ? "#dark" : "#light";
      d.src = e.href;
    });else {
      var c = function c(d) {
        var e = document.getElementById("news_swipe_array");
        d = d.reverse();
        for (var g = function g(k) {
            h = d[k].text;
            var l = h.split(" "),
              m = new Date(d[k].datetime_utc);
            d[k].cover || (d[k].cover = "assets/images/spawn.webp");
            e.innerHTML += '\n                    <div class="swiper-slide h-auto px-2" style="max-height: 40vh !important;display: '.concat(5 <= l.length ? "block" : "none", '">\n                        <figure class="card h-100 position-relative border-0 news-figure" id="news_figure_').concat(k, '">\n                            <div class="background-news" id="background-news-').concat(k, '">\n                                <div class="background-news-overlay" id="news-overlay-').concat(k, '">\n                                    <div class="background-news-overlay-dark-mode">\n                                        <div \n                                        style="z-index:6;top:35.1%;height:65%"\n                                        class="shadow-vertical-overlay shadow-vertical-overlay-news vertical-bottom-shadow"\n                                        ></div>\n                                        <blockquote class="card-body mt-2 mb-3 news-text-container">\n                                            <p class="fs-md mb-0 news-text h6" id="news_text_').concat(k, '" style="font-family:sans-serif">\n                                                    ').concat(h, '</p>\n                                            <div class="news-bottom-container" style="z-index:8">\n                                                <a class="btn btn-primary shadow-primary btn-lg news-button-view"\n                                                   href="').concat(d[k].link, "\" target=\"_blank\">\n                                                        \u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n                                            </div>\n                                        </blockquote>\n                                    </div>\n                                </div> \n                            </div>\n                        </figure>\n                        <span class=\"news-date-text\">\n                            ").concat(m.toLocaleDateString(), " \n                            ").concat(m.toLocaleTimeString("ru-RU", {
              hour: "2-digit",
              minute: "2-digit"
            }), "\n                        </span>\n                    </div>\n                ");
            document.getElementById("background-news-".concat(k)).style.backgroundImage = "url(".concat(d[k].cover, ")");
            h = document.getElementById("news_text_".concat(k));
            h.style.width = "100%";
            h.classList.add("text-light");
            h.style.fontSize = "calc(1.35vw + .75vh)";
            getImageLightness(d[k].cover, function (n) {
              n = "#000000".concat(((parseFloat(n) / 255 * 100).toFixed() + 64).toString(16).slice(0, 2));
              document.getElementById("news-overlay-".concat(k)).style.background = n;
            });
          }, f = 0; f < d.length; f++) {
          var h;
          g(f);
      ...
      if (d && d.length) {
        ...
        for (var e = 0; e < d.length; e++) {
          ...
          var g = time_correction(new Date(d[e].date_start)),
            f = time_correction(new Date(d[e].date_end)),
  ...
  create_payment = function create_payment(a, b, c, d) {
    ...
    re_check(function (f) {
      requestCall(function (h) {
        ...
        products: c,
        email: e,
        coupon: 2 !== donatePayMethodSelector() ? g : null,
        token: f,
        server_id: d,
  ...
  loadPlayerAvatar = function loadPlayerAvatar(a) {
    var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "telegram-auth-avatar",
    ...
    a: {
      ...
      for (var g = 0; 10 > g; g++) if (!crypto_token && d) initCrypto();else {
  ...
  checkTelegramAuthData = function checkTelegramAuthData(a) {
    var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1,
      ...
      d = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : !1,
      e = getTelegramAuth(!0);
    e ? telegram_glob_session.auth_data !== e || d ? (console.debug("skip pos : ".concat(b)), b ? a(!0) : re_check(function (g) {
      requestCall(function (f) {
        if (f) {
          if (console.debug(f), f.success) {
            var h = document.getElementById("telegram-auth-avatar");
            glob_auth_player_data = f.player_data;
            console.debug(f);
            if (f.player_data) {
              var k = f.player_data,
                l = k.NICKNAME,
  ...
  cloudflareTraceJSON = function cloudflareTraceJSON(a) {
    a = a.split("\n");
    var b = {};
    a = _createForOfIteratorHelper(a);
    var c;
    try {
      for (a.s(); !(c = a.n()).done;) p = c.value.split("="), b[p[0]] = p[1];
    } catch (d) {
      a.e(d);
    } finally {
      a.f();
  ...
  getGitLauncherReleases = function getGitLauncherReleases(a) {
    requestCall(function (b) {
      if (b && b.id && "main" === b.target_commitish && "hevav" === b.author.login && !b.draft && b.assets.length) {
        for (var c = {}, d = 0, e = Object.keys(launcher_platforms); d < e.length; d++) {
          var g = e[d],
            f = _createForOfIteratorHelper(b.assets),
            h;
          try {
            for (f.s(); !(h = f.n()).done;) {
              var k = h.value;
              k.name.split(".").slice(-1)[0] === launcher_platforms[g] && (c[g] = k.browser_download_url);
            }
          } catch (l) {
            f.e(l);
          } finally {
  ...
  setLauncherLinks = function setLauncherLinks() {
    ...
    getGitLauncherReleases(function (b) {
      for (var c = 0, d = Object.keys(b); c < d.length; c++) {
        var e = d[c];
        a.innerHTML += '\n        <a href="'.concat(b[e], '" style="text-transform:capitalize"\n           class="btn btn-primary shadow-primary mt-3 m-1" download="">\n        ').concat(e.toLowerCase(), "</a>\n    ");
      }
    });
  },
    ...
    get_donate_services(function (a) {
      ...
      var b = ["row-cols-sm-2", "row-cols-md-3", "row-cols-lg-4"],
        ...
        d = function d(n, q) {
          n = n.toLowerCase();
          q = q.toLowerCase();
          if (n.includes("\u0442\u043E\u043A\u0435\u043D") && "currency" === q) return 1;
          if (n.includes("\u0441\u043B\u043E\u0442") && "currency" === q) return 3;
          if (n.includes("\u043F\u0440\u043E\u0445\u043E\u0434\u043A\u0430") && "other" === q) return 2;
        };
      if (a.length) {
        ...
        setTimeout(function () {
          ...
          for (n = 0; n < q.length; n++) try {
            ...
            console.log("Donate block loader error. Details: ".concat(r));
          }
        }, 100);
  ...
  ytVideoSetter = function ytVideoSetter() {
    for (var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : !1, b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !0, c = function c(k, l, m) {
        k.innerHTML = '\n            <iframe src="https://www.youtube.com/embed/'.concat(l, '" title="YouTube video player"\n                frameborder="0" class="video-container-yt" id="ytframe_').concat(l, '"\n                allow="accelerometer; ').concat(null != m.autoplay ? "autoplay" : "", '; clipboard-write; encrypted-media; gyroscope; picture-in-picture"\n                allowfullscreen="" loading="lazy"></iframe>\n        ');
      }, d = function d(k, l, m) {
        b ? c(k, l, m) : get_yt_video_(function (n) {
          n && n.video.x720.url && !a ? k.innerHTML = '\n                    <video class="video-container" '.concat(null != m.autoplay ? 'autoplay=""' : "", " ").concat(null != m.muted ? 'muted=""' : "", " ").concat(null != m.loop ? 'loop=""' : "", " ").concat(null != m.controls ? 'controls=""' : "", ' style="object-fit: contain">\n                        <source src="').concat(n.video.x720.url, '" type="video/mp4">\n                    </video>\n                ') : c(k, l, m);
        }, l, a);
      }, e = 0, g = Array.from(document.getElementsByClassName("ytVideoSetter")); e < g.length; e++) {
      var f = g[e],
        h = f.getAttribute("video_id");
      h && h.length && 20 > h.length && (d(f, h, {
        autoplay: f.getAttribute("autoplay"),
        muted: f.getAttribute("muted"),
        loop: f.getAttribute("loop"),
        controls: f.getAttribute("controls")
      }), f.getAttribute("bottomzero") && (document.getElementById("ytframe_".concat(h)).style.marginBottom = "0"));
    }
  },
  ...
  switch_modal_containers = function switch_modal_containers() {
    var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "service",
      ...
      g = document.getElementById("modal-donate-finish-container-b"),
      f = document.getElementById("modal-donate-success-container"),
    ...
    for (e = 0; e < d.length; e++) g = "none", a === d[e].name && (g = "block", k.innerText = d[e].title), d[e].selector.style.display = g;
  ...
  displayTokens = function displayTokens() {
    ...
    if (tokens_system_enabled && (document.querySelector(".zalupa-card-container").style.display = "", Number.isInteger(b))) if (a) {
      ...
      var c = document.querySelector(".card-holder-zalupa"),
        ...
        g = '<span class="text-primary">'.concat(b, "</span> ").concat(getNoun(b, "\u0442\u043E\u043A\u0435\u043D", "\u0442\u043E\u043A\u0435\u043D\u0430", "\u0442\u043E\u043A\u0435\u043D\u043E\u0432"));
      e.innerHTML = "\u0423 \u0442\u0435\u0431\u044F ".concat(g);
    ...
    requestCall(function (c) {
      ...
      b(function (d) {
        for (var e = 0; e < c.length; e++) {
          var g = 0;
          a: for (; g < d.length; g++) if (d[g].name === c[e].name) break a;
          ...
          g = document.getElementById("comment_text_".concat(e));
          var f = document.getElementById("comment_show_".concat(e));
          f.style.fontWeight = "400";
          g.style.transition = "height .8s cubic-bezier(1, -.3, 0, 1.21) 0s";
          g.setAttribute("fullShowComment", "0");
          112 < g.clientHeight ? (g.style.height = "100px", g.style.overflow = "hidden") : f.style.display = "none";
        }
      });
    ...
    (function (b) {
      ...
      requestCall(function (c) {
        ...
        var d = [],
          ...
          g;
        try {
          for (e.s(); !(g = e.n()).done;) d.push(g.value.name);
        } catch (f) {
          e.e(f);
        } finally {
          e.f();
    ...
    var a = document.getElementById("payments-history-swiper-array"),
      b = function b() {
        for (var c = document.querySelectorAll("#item-donate-history-desc>time"), d = 0; d < c.length; d++) {
          var e = c[d],
            g = e.getAttribute("datetime");
          e.innerHTML = formatDate(new Date(g), time_in_moscow_get());
        }
      };
  ...
  donate_bg_preload = function donate_bg_preload() {
    for (var a = ["emoji-background-donate-light", "emoji-background-donate"], b = 0; b <= a; b++) getImageLightness("assets/images/".concat(b, ".png"), void 0, !1);
  },
  ...
  donate_element_click = function donate_element_click(a) {
    ...
    var b = ["group"],
      ...
      g = document.getElementById("donate_count_text_hint"),
      f = document.getElementById("donate_button_add_to_cart"),
      h = get_cookie_cart(),
      k = function k() {
        f.setAttribute("onClick", "donate_cart(".concat(a.service_id, ", ").concat(e.value, ")"));
      };
    e.value = 1;
    k();
    ...
    if ((b.includes(a.type) || "group" === a.type) && groupAlreadyInCart(h)) {
      ...
      var m = "";
      m = "group" === a.type ? "\u0412\u044B \u0443\u0436\u0435 \u0432\u044B\u0431\u0440\u0430\u043B\u0438 \u043F\u0440\u0438\u0432\u0438\u043B\u0435\u0433\u0438\u044E. \u0423\u0434\u0430\u043B\u0438\u0442\u0435 \u0435\u0451 \u0438\u0437 \u043A\u043E\u0440\u0437\u0438\u043D\u044B, \u0435\u0441\u043B\u0438 \u0445\u043E\u0442\u0438\u0442\u0435 \u0432\u044B\u0431\u0440\u0430\u0442\u044C \u0434\u0440\u0443\u0433\u0443\u044E." : l ? "\u041E\u0448\u0438\u0431\u043A\u0430, \u0432\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440 \n                <span class=\"text-primary fw-semibold\">".concat(a.name, "</span> \n                \u0442\u043E\u043B\u044C\u043A\u043E \u043E\u0434\u0438\u043D \u0440\u0430\u0437.") : "\u041C\u044B \u043D\u0435 \u0437\u043D\u0430\u0435\u043C \u043F\u043E\u0447\u0435\u043C\u0443, \u043D\u043E \u044D\u0442\u0430 \u043E\u0448\u0438\u0431\u043A\u0430 \u0432\u044B\u0437\u0432\u0430\u043D\u0430 \u043F\u043E \u043D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u043C \u043F\u0440\u0438\u0447\u0438\u043D\u0430\u043C.";
      document.getElementById("donate_info_block_text").innerHTML = m;
    }
    l = "block";
    ...
    var n = function n() {
      ...
      if (!b.includes(a.type)) {
        var q = parseInt(e.value) * a.price,
          r = h[a.service_id],
          t = "";
        if (isNaN(q) || 1 > Math.sign(q)) q = 0;
        r && (t = "\n                    \u0423\u0436\u0435 \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0435 - \n                        <span class=\"text-primary fw-semibold\">\n                            ".concat(r, "\n                        </span>\n                "));
        c.innerHTML = "".concat(d, "\n                    <br/>\n                    \u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C - \n                        <span class=\"text-primary fw-semibold\">\n                            ").concat(q, " \n                            ").concat(getNoun(q, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), "\n                        </span>\n                    <br/>\n                    ").concat(t, "\n                ");
        k();
      }
    };
    c.innerHTML = d;
    n();
    e.addEventListener("input", function (q) {
      n();
    });
    modal_open_();
  },
  ...
  donateResetPaymentState = function donateResetPaymentState() {
    var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 1,
      ...
      e = ["donate_sum", "donate_customer_c", "donate_email_c", "coupon-input-c", "donate-pay-method"],
      g = "_c",
      f = document.getElementById("donate_sum").value.trim();
    coins_sell_mode || (g = "", f = 0);
    g = document.getElementById("payment-button-donate" + g);
    if (c) {
      d.innerHTML = "";
    ...
    g.setAttribute("onClick", "generatePaymentLink(".concat(a, ", ").concat(2 === a ? 1 : f, ")"));
    g.removeAttribute("disabled");
    g.innerText = b ? "\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C" : "\u0414\u0430\u043B\u044C\u0448\u0435";
  },
  ...
  donate_cart_button = function donate_cart_button() {
    ...
    if (!coins_sell_mode) for (var c = function c(e) {
        var g = b[e].style;
        countProperties(a) ? (g.display = "flex", setTimeout(function () {
          g.opacity = 1;
          g.marginTop = "15px";
          b[e].removeAttribute("disabled");
        }, 50)) : (b[e].setAttribute("disabled", ""), g.opacity = 0, g.marginTop = "-50px", setTimeout(function () {
          g.display = "none";
        }, 350));
  ...
  generatePaymentLink = function generatePaymentLink() {
    ...
    e.length ? 40 < e.length ? notify("\u0412\u0430\u0448 \u043D\u0438\u043A\u043D\u0435\u0439\u043C \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u0434\u043B\u0438\u043D\u043D\u044B\u0439") : 3 > e.length ? notify("\u0412\u0430\u0448 \u043D\u0438\u043A\u043D\u0435\u0439\u043C \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u043A\u043E\u0440\u043E\u0442\u043A\u0438\u0439") : /^[A-z\d_]+$/.test(e) ? c.length ? validateEmail(c) ? (g || (g = ""), products = coins_sell_mode ? JSON.parse('{"'.concat(current_c_item, '": ').concat(b, "}")) : get_cookie_cart(), d.setAttribute("disabled", ""), d.innerText = "\u041F\u0440\u043E\u0432\u0435\u0440\u044F\u0435\u043C \u0434\u0430\u043D\u043D\u044B\u0435...", b = get_data_service(current_c_item), create_payment(function (f) {
      f ? (d.removeAttribute("disabled"), d.innerText = "\u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C", f.zalupa_pay ? zalupa_pay_finish_modal() : (payment_url_global = f.url, d.setAttribute("onClick", "payment_action_bt()"))) : (notify("\u041E\u0448\u0438\u0431\u043A\u0430, \u043D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0441\u0444\u043E\u0440\u043C\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0447\u0435\u043A \u0434\u043B\u044F \u043E\u043F\u043B\u0430\u0442\u044B"), donateResetPaymentState(a, repeat = !0));
    }, e, products, b.server_id, c, g)) : notify("\u041E\u0448\u0438\u0431\u043A\u0430, \u0430\u0434\u0440\u0435\u0441 \u043F\u043E\u0447\u0442\u044B \u043D\u0435\u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0439") : notify("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430 \u0432\u0430\u0448 email") : notify("\u041D\u0438\u043A\u043D\u0435\u0439\u043C \u043D\u0435 \u0441\u043E\u043E\u0442\u0432\u0435\u0441\u0442\u0432\u0443\u0435\u0442 \u0444\u043E\u0440\u043C\u0430\u0442\u0443") : notify("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430 \u0432\u0430\u0448 \u043D\u0438\u043A\u043D\u0435\u0439\u043C");
  },
  ...
  payment_action_bt = function payment_action_bt() {
    ...
    enable_modal_result_sc();
    for (var e = ["donate_sum", "donate_customer_c", "donate_email_c", "coupon-input-c"], g = 0; g < e.length; g++) document.getElementById(e[g]).value = "";
    a.innerHTML = "";
    d.innerText = "";
  ...
  donateCartCall = function donateCartCall() {
    var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null,
      ...
      g = [document.getElementById("donate_customer"), document.getElementById("donate_email"), document.getElementById("coupon-input")];
    switch_modal_containers("donate_finish");
    modal_open_();
    e.innerHTML = "";
    for (var f = 0, h = 0; h < g.length; h++) g[h].addEventListener("input", function (l) {
      donateResetPaymentState();
    });
    for (g = 0; g < d.length; g++) {
      h = donate_get_service_by_id(d[g]);
  ...
  donateModalCall = function donateModalCall(a, b) {
    ...
    var d = document.getElementById("donate_sum"),
      ...
      g = document.getElementById("sum-tokens-container"),
      ...
      l,
      m = [document.getElementById("donate_sum"), document.getElementById("donate_customer_c"), document.getElementById("donate_email_c"), document.getElementById("coupon-input-c")],
    ...
    1 === a || 3 === a ? (k.setAttribute("disabled", ""), g.style.display = "", f.remove("col-sm-6"), f.add("col-12"), b = document.getElementById("donate-sum-title"), 1 === a ? (l = "\n                \u0412\u043E\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0432\u0448\u0438\u0441\u044C \u044D\u0442\u043E\u0439 \u0444\u043E\u0440\u043C\u043E\u0439, \u0432\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u043F\u0440\u043E\u0435\u043A\u0442 \u0444\u0438\u043D\u0430\u043D\u0441\u043E\u0432\u043E.\n                \u0417\u0430 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0443 \u0432\u044B \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u0435 \u0432\u043E\u0437\u043D\u0430\u0433\u0440\u0430\u0436\u0434\u0435\u043D\u0438\u0435 \u2013 \u0437\u0430 \u043A\u0430\u0436\u0434\u044B\u0439 \u0440\u0443\u0431\u043B\u044C \u043F\u043E \u043E\u0434\u043D\u043E\u043C\u0443 \u0438\u0433\u0440\u043E\u0432\u043E\u043C\u0443 \u0442\u043E\u043A\u0435\u043D\u0443.\n            ", q = "\u0422\u043E\u043A\u0435\u043D\u044B", b.innerText = "\u0421\u0443\u043C\u043C\u0430", d.addEventListener("input", function (r) {
      donateCoinsPay();
    })) : 3 === a && (l = "\n                \u0414\u043E\u0431\u0430\u0432\u043B\u044F\u0435\u0442 +1 \u0441\u043B\u043E\u0442 \u0432 \u043A\u043B\u0430\u043D. \u0421\u0438\u0441\u0442\u0435\u043C\u0430 \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u044F\u0435\u0442 \u0432\u0430\u0448 \u043A\u043B\u0430\u043D \u043F\u043E \u043D\u0438\u043A\u043D\u0435\u0439\u043C\u0443, \n                \u043F\u043E\u044D\u0442\u043E\u043C\u0443 \u0431\u0443\u0434\u044C\u0442\u0435 \u0432\u043D\u0438\u043C\u0430\u0442\u0435\u043B\u044C\u043D\u044B \u043F\u0435\u0440\u0435\u0434 \u043E\u043F\u043B\u0430\u0442\u043E\u0439. \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0432 \u043A\u0430\u043A\u043E\u043C \u043A\u043B\u0430\u043D\u0435 \u0432\u044B \u0441\u043E\u0441\u0442\u043E\u0438\u0442\u0435.\n            ", q = "\u0421\u043B\u043E\u0442\u044B", b.innerText = "\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E", e.addEventListener("input", function (r) {
      donateCoinsPay(a);
    }))) : 2 === a && (k.removeAttribute("disabled"), g.style.display = "none", f.remove("col-12"), f.add("col-sm-6"), (desc_get = get_data_service(current_c_item).description) || (desc_get = ""), l = "\n            \u0424\u043E\u0440\u043C\u0430 \u043E\u043F\u043B\u0430\u0442\u044B \u043F\u043E\u0436\u0435\u0440\u0442\u0432\u043E\u0432\u0430\u043D\u0438\u044F \u0434\u043B\u044F \u0438\u0433\u0440\u043E\u0432\u043E\u0433\u043E \u043F\u0440\u043E\u0435\u043A\u0442\u0430 Zalupa.Online\n            <br/>\n            <span class=\"text-primary\">\n                ".concat(desc_get, "\n            </span>\n        "), q = current_c_item_name, e.addEventListener("input", function (r) {
      donateCoinsPay(a);
    }));
    h.innerHTML = l.replaceAll("\n", "");
    for (d = 0; d < m.length; d++) m[d].addEventListener("input", function (r) {
    ...
    (function (r) {
      ...
      n.innerText = "".concat(n.innerText, " (").concat(r, ")");
    })(q);
  },
  linksSet = function linksSet(a) {
    var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
    a = document.getElementById(a);
    for (var c = "margin-left: 0 !important", d = 0; d < links_lt.length; d++) {
      if (!b || d) c = "";
  ...
  observerSystemTheme = function observerSystemTheme() {
    for (var a = ["dark", "light"], b = document.querySelector('[data-bs-toggle="mode"]').querySelector(".form-check-input"), c = function c(e) {
        window.matchMedia("(prefers-color-scheme: ".concat(a[e], ")")).addEventListener("change", function (g) {
          if (g = g.matches) "dark" === a[e] ? (root.classList.add("dark-mode"), b.checked = !0) : (root.classList.remove("dark-mode"), b.checked = !1), g = void 0;
          return g;
        });
  ...
  callSucessPayModal = function callSucessPayModal() {
    var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
      ...
      g = document.querySelector(".modal-title");
    donateSwitchContainer(!0);
    checkPayment(function (f) {
      if ("undefined" !== typeof f.status) {
        if (f.status && a == parseInt(f.id)) {
          ...
          var k = f.product.name.toLowerCase().includes("\u0442\u043E\u043A\u0435\u043D") ? 1 : 2,
            l = "\n                <li class=\"list-group-item d-flex justify-content-between lh-sm\">\n                    <div>\n                        <h6 class=\"my-0 text-start\">\n                            \u0421\u0438\u0441\u0442\u0435\u043C\u0430\n                        </h6>\n                    </div>\n                    <span>".concat(f.payment_system, "</span>\n                </li>\n            "),
            m = "\n                <li class=\"list-group-item d-flex justify-content-between\">\n                    <span>\u0421\u0443\u043C\u043C\u0430 \u0437\u0430\u0447\u0438\u0441\u043B\u0435\u043D\u0438\u044F</span>\n                    <strong class=\"bottom-line-set bottom-line-set-zlp color-set-zlp\">".concat(f.enrolled, " ").concat(getNoun(f.enrolled, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), "</strong>\n                </li>\n            ");
          coins_sell_mode && (1 === k ? m = "\n                        <li class=\"list-group-item d-flex justify-content-between\">\n                            <span>\u0421\u0443\u043C\u043C\u0430</span>\n                            <strong class=\"bottom-line-set bottom-line-set-zlp color-set-zlp\">".concat(f.enrolled, " ").concat(getNoun(f.enrolled, "\u0442\u043E\u043A\u0435\u043D", "\u0442\u043E\u043A\u0435\u043D\u0430", "\u0442\u043E\u043A\u0435\u043D\u043E\u0432"), "</strong>\n                        </li>\n                    ") : 2 === k && (m = "\n                        <li class=\"list-group-item d-flex justify-content-between\">\n                            <span>\u0421\u0443\u043C\u043C\u0430</span>\n                            <strong class=\"bottom-line-set bottom-line-set-zlp color-set-zlp\">".concat(f.product.price, " ").concat(getNoun(f.enrolled, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), "</strong>\n                        </li>\n                    "), document.querySelector("div.modal-footer").prepend(h)));
          if (!f.enrolled || 1 > f.enrolled) m = "";
          if (!f.email.length || f.email.match("undefined")) f.email = "\u041D\u0443 \u0443\u043A\u0430\u0437\u0430\u043D\u043E";
          if (!f.payment_system || f.payment_system.match("undefined")) l = "";
          f.created_at && f.created_at.length ? (h = new Date(f.created_at), f.created_at = "".concat(h.toLocaleDateString(), " ").concat(h.toLocaleTimeString())) : f.created_at = "\u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u043E";
          h = "";
          f.private_invite && (h = '\n                    <li class="list-group-item d-flex justify-content-between lh-sm mb-2 mb-lg-3 mt-4 mt-lg-5">\n                        <a href="'.concat(f.private_invite, "\" id=\"private-chat-button\" target=\"_blank\" style=\"margin:auto\"\n                                   class=\"btn btn-primary shadow-primary btn-lg btn-shadow-hide\">\n                                \u041F\u0440\u0438\u0433\u043B\u0430\u0448\u0435\u043D\u0438\u0435 \u0432 \u043F\u0440\u0438\u0432\u0430\u0442\u043D\u044B\u0439 \u0447\u0430\u0442 <i class=\"ms-1 bx bxl-telegram\"></i></a>\n                    </li>\n                "));
          c.innerHTML = "\n                <li class=\"list-group-item d-flex justify-content-between lh-sm\">\n                    <div>\n                        <h6 class=\"my-0 text-start\">\n                            \u041D\u0438\u043A\u043D\u0435\u0439\u043C\n                        </h6>\n                    </div>\n                    <span>".concat(f.customer, "</span>\n                </li>\n                <li class=\"list-group-item d-flex justify-content-between lh-sm\">\n                    <div>\n                        <h6 class=\"my-0 text-start\">\n                            \u041F\u043E\u0447\u0442\u0430\n                        </h6>\n                    </div>\n                    <span>").concat(f.email, "</span>\n                </li>\n                ").concat(l, "\n                <li class=\"list-group-item d-flex justify-content-between lh-sm\">\n                    <div>\n                        <h6 class=\"my-0 text-start\">\n                            \u0412\u0440\u0435\u043C\u044F\n                        </h6>\n                    </div>\n                    <span>").concat(f.created_at, "</span>\n                </li>\n                ").concat(m, "\n                ").concat(h, "\n            ");
        ...
        switch_modal_containers("success");
        modal_open_();
        (l = b.product.image) && l.length && (document.querySelector(".payment-sucess-vova").src = l, document.querySelector(".item-name-payment-result").style.marginBottom = "4vh");
        g.innerText = "\u0427\u0435\u043A #".concat(f.id);
