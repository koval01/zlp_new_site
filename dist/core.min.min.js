  ...
  loadPlayerAvatar = function loadPlayerAvatar(a) {
    ...
    a: {
      ...
      for (var e = 0; 10 > e; e++) if (crypto_token) {
        ...
        e = prepare_img_link(a);
        testImage(a);
        if (c) break a;else d.setAttribute("style", 'background-image: url("'.concat(e, '");border-radius:.').concat(b.includes("card-avatar") ? 35 : 15, "rem;"));
        break a;
      } else initCrypto();
    }
  },
