...
var telegram_social_bot = "https://t.me/ZalupaScBot",
  ...
  getImageLightness = function getImageLightness(a, b) {
    ...
    c && (d.onload = function () {
      ...
      f = imageData.data;
      var h, k;
      for (var l = 0, m = f.length; l < m; l += 4) g = f[l], h = f[l + 1], k = f[l + 2], g = Math.floor((g + h + k) / 3), e += g;
  ...
  appendPostsNews = function appendPostsNews() {
    ...
    if (a) a = document.getElementById("news-c-container"), a.innerHTML = '\n        <div class="shadow-vertical-overlay vertical-top-shadow" style="width:100vw!important"></div>\n        <div class="shadow-vertical-overlay vertical-bottom-shadow" style="width:100vw!important"></div>\n        <iframe \n            style="min-height:450px;width:100vw" \n            id="tg-iframe-view"\n            src="https://telegram-worker.zalupa.online/zalupaonline" \n            onload="try{document.getElementById(\'telegram_block_load\').remove()} catch {}">\n        </iframe>' + a.innerHTML, b(), document.getElementById("theme-mode").addEventListener("change", function () {
      ...
      var c = function c(d) {
        var e = document.getElementById("news_swipe_array");
        d = d.reverse();
        var _loop = function _loop(g) {
          ...
          f = document.getElementById("news_text_".concat(g));
          f.style.width = "100%";
          f.classList.add("text-light");
          f.style.fontSize = "calc(1.35vw + .75vh)";
  ...
  create_payment = function create_payment(a, b, c, d) {
    ...
    re_check(function (g) {
      requestCall(function (h) {
        ...
        products: c,
        email: e,
        coupon: 2 !== donatePayMethodSelector() ? f : null,
        token: g,
        server_id: d,
  ...
  loadPlayerAvatar = function loadPlayerAvatar(a) {
    ...
    a: {
      ...
      if (!c) {
        try {
          e = document.getElementById(b), e.style;
        } catch (_unused) {}
        console.debug("Load avatar : ".concat(a));
        document.getElementById("tg-user-avatar-text").innerText = "";
      }
      for (var f = 0; 10 > f; f++) if (!crypto_token && d) initCrypto();else {
        ...
        testImage(a);
        if (c) break a;else e.setAttribute("style", "background-image: url(\"".concat(d, "\");border-radius:.").concat(b.includes("card-avatar") ? 35 : 15, "rem;"));
        break a;
      }
    }
  },
  ...
  checkTelegramAuthData = function checkTelegramAuthData(a) {
    ...
    var c = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
    var d = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : !1;
    var e = getTelegramAuth(!0);
    e ? telegram_glob_session.auth_data !== e || d ? (console.debug("skip pos : ".concat(b)), b ? a(!0) : re_check(function (f) {
        ...
        for (var _i = 0, _Object$keys = Object.keys(launcher_platforms); _i < _Object$keys.length; _i++) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var e = _step2.value;
              e.name.split(".").slice(-1)[0] === launcher_platforms[d] && (c[d] = e.browser_download_url);
            }
          } catch (err) {
            _iterator2.e(err);
          } finally {
    ...
    get_donate_services(function (a) {
      ...
      var b = ["row-cols-sm-2", "row-cols-md-3", "row-cols-lg-4"],
        ...
        d = function d(f, g) {
          f = f.toLowerCase();
          g = g.toLowerCase();
          if (f.includes("\u0442\u043E\u043A\u0435\u043D") && "currency" === g) return 1;
          if (f.includes("\u0441\u043B\u043E\u0442") && "currency" === g) return 3;
          if (f.includes("\u043F\u0440\u043E\u0445\u043E\u0434\u043A\u0430") && "other" === g) return 2;
        };
      if (a.length) {
        ...
        for (var f = 0; f < a.length; f++) {
          var g = {
            ...
            type: a[f].type,
            service_id: a[f].id,
            server_id: a[f].server_id
          };
          products_by_serverid.push(a[f]);
          var h = "",
            k = "p-3";
          var e = "\n                    <p class=\"mb-0\">\n                        ".concat(a[f].price, " \n                        ").concat(getNoun(a[f].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), " \n                        = \n                        ").concat(a[f].number, " \n                        ").concat(getNoun(a[f].number, "\u0435\u0434\u0438\u043D\u0438\u0446\u0430", "\u0435\u0434\u0438\u043D\u0438\u0446\u044B", "\u0435\u0434\u0438\u043D\u0438\u0446"), "\n                    </p>\n                    <p class=\"fs-sm mb-0\">").concat(a[f].description, "</p>\n                ");
          var l = "";
          f && b.length >= f && c.classList.add(b[f - 1]);
          var m = "onClick=\"donate_element_click(".concat(JSON.stringify(g), ")\"");
          coins_sell_mode ? (e = "\u0422\u043E\u0432\u0430\u0440 \u0431\u0435\u0437 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u044F.", a[f].description && (e = a[f].description), a[f].name.toLowerCase().includes("\u0442\u043E\u043A\u0435\u043D") ? (h = "".concat(a[f].price, " ").concat(getNoun(a[f].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), " = <span class=\"text-primary\">").concat(a[f].number, " ").concat(getNoun(a[f].number, "\u0442\u043E\u043A\u0435\u043D", "\u0442\u043E\u043A\u0435\u043D\u0430", "\u0442\u043E\u043A\u0435\u043D\u043E\u0432"), "</span>"), k = "p-0", e = "\n                        <p class=\"mb-0 token-description-dnt\">\n                            \u0418\u0433\u0440\u043E\u0432\u0430\u044F \u0432\u0430\u043B\u044E\u0442\u0430, \u043A\u043E\u0442\u043E\u0440\u0443\u044E \u043C\u043E\u0436\u043D\u043E \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043A\u0430\u043A \u0432 \u0438\u0433\u0440\u0435, \u0442\u0430\u043A \u0438 \u0437\u0430 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0443 \u043F\u0440\u043E\u0435\u043A\u0442\u0430.\n                        </p>") : (a[f].name.toLowerCase().includes("\u0441\u043B\u043E\u0442") ? h = "".concat(a[f].price, " ").concat(getNoun(a[f].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), " = <span class=\"text-primary\">").concat(a[f].number, " ").concat(getNoun(a[f].number, "\u0441\u043B\u043E\u0442", "\u0441\u043B\u043E\u0442\u0430", "\u0441\u043B\u043E\u0442\u043E\u0432"), "</span>") : (a[f].type = "other", h = "\n                        <span class=\"text-primary\">".concat(a[f].name, "</span>,\n                        ").concat(a[f].price, " ").concat(getNoun(a[f].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"))), k = "p-0", e = "\n                        <p class=\"mb-0 token-description-dnt\">\n                            ".concat(e, "\n                        </p>")), m = "", l = "\n                        <button class=\"btn btn-primary shadow-primary btn-shadow-hide btn-lg min-w-zl donate-item-butt-bottom\" \n                            onclick=\"donateModalCall(\n                                ".concat(d(g.name, g.type), ", ").concat(g.service_id, "\n                            )\">\n                            ", "\u041F\u0440\u0438\u043E\u0431\u0440\u0435\u0441\u0442\u0438", "\n                        </button>")) : h = a[f].name;
          a[f].image = prepare_img_link(a[f].image);
          c.innerHTML += "\n                    <div class=\"col\" id=\"donate_item_".concat(a[f].id, "\">\n                        <div class=\"card border-0 bg-transparent\" ").concat(m, ">\n                          <div class=\"position-relative container-item-donate-n\">\n                            <div class=\"parent-image-shadow donate_item_hover\" \n                                id=\"donate_item_hover_").concat(a[f].id, "\">\n                                <div class=\"imageContainer item-levitaion-dec\">\n                                    <div \n                                    class=\"foregroundImg\" \n                                    style=\"background-image: url(").concat(a[f].image, ")\"\n                                    ></div>\n                                    <div \n                                    class=\"backgroundImg\" \n                                    style=\"background-image: url(").concat(a[f].image, ")\"\n                                    ></div>                               \n                                 </div>\n                            </div>\n                            <div class=\"card-img-overlay d-flex flex-column align-items-center \n                                        justify-content-center rounded-3\" \n                                 style=\"margin: auto\">\n                            </div>\n                          </div>\n                          <div class=\"card-body text-center ").concat(k, "\">\n                                <h3 class=\"fs-lg fw-semibold pt-1 mb-2\">").concat(h, "</h3>\n                                ").concat(e, "\n                                ").concat(l, "\n                          </div>\n                        </div>\n                    </div>\n                ");
        }
        checkPrivateServerBuy();
        setTimeout(function () {
          var f = document.getElementById("donate_block_load");
          var g = ["donate_items_list", "donate-header-container", "donate-test-mode-enb", "donate-cart-container"];
          try {
            f.parentNode.removeChild(f);
          } catch (h) {}
          for (f = 0; f < g.length; f++) try {
            document.getElementById(g[f]).style.display = "";
          } catch (h) {
  ...
  displayTokens = function displayTokens() {
    ...
    if (tokens_system_enabled && (document.querySelector(".zalupa-card-container").style.display = "", Number.isInteger(b))) if (a) {
      ...
      var d = document.querySelector(".balance-value-card"),
        e = document.getElementById("tokens-balance-choice-dnt"),
        f = "<span class=\"text-primary\">".concat(b, "</span> ").concat(getNoun(b, "\u0442\u043E\u043A\u0435\u043D", "\u0442\u043E\u043A\u0435\u043D\u0430", "\u0442\u043E\u043A\u0435\u043D\u043E\u0432"));
      e.innerHTML = "\u0423 \u0442\u0435\u0431\u044F ".concat(f);
  ...
  select_card_skin = function select_card_skin(a) {
    ...
    for (var d = 0; d < c.length; d++) {
      var e = b[c[d]];
      if (a >= parseInt(c[d])) return selector_card_skin_displayed !== e && (console.debug(e), selector_card_skin_displayed = e), prepare_img_link("./assets/images/card_skins".concat("/", e, ".png"));
    }
    ...
    requestCall(function (c) {
      ...
      b(function (d) {
        for (var f = 0; f < c.length; f++) {
          var e;
          a: {
            for (e = 0; e < d.length; e++) if (d[e].name === c[f].name) {
              e = d[e];
              break a;
            }
            e = void 0;
          }
          a.innerHTML += "\n                        <div class=\"swiper-slide h-auto px-2\">\n                            <figure class=\"card h-100 position-relative border-0 shadow-sm py-3 p-0 p-xxl-4 my-0\">\n                                <span class=\"btn btn-primary btn-lg shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4 ms-xxl-5 zlp-comment-icon\">\n                                  <i class=\"bx bxs-quote-left\"></i>\n                                  \u0417\u0430\u043B\u0443\u043F\u043D\u044B\u0439 \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439\n                                </span>\n                                <blockquote id=\"comment_block_".concat(f, "\" class=\"card-body mt-2 mb-2\" \n                                            style=\"transition: .8s height\">\n                                    <p id=\"comment_text_").concat(f, "\" class=\"fs-md mb-0\">\n                                            \xAB").concat(c[f].text, "\xBB</p>\n                                    <span id=\"comment_show_").concat(f, "\" onclick=\"comment_show_action(").concat(f, ")\" \n                                          class=\"pt-1 comment-show-button\">\n                                            \u0420\u0430\u0441\u043A\u0440\u044B\u0442\u044C</span>\n                                </blockquote>\n                                <figcaption class=\"card-footer d-flex align-items-center border-0 pt-0 mt-n2 mt-lg-0\">\n                                    <div>\n                                        <h6 class=\"fw-semibold lh-base mb-0\">").concat(c[f].name, "</h6>\n                                        <!-- ").concat(e ? "<span class=\"frame_badge_adaptive\">".concat(e.desc, "</span>") : "", " -->\n                                    </div>\n                                </figcaption>\n                            </figure>\n                        </div>\n                    ");
          e = document.getElementById("comment_text_".concat(f));
          var g = document.getElementById("comment_show_".concat(f));
          g.style.fontWeight = "400";
          e.style.transition = "height .8s cubic-bezier(1, -.3, 0, 1.21) 0s";
          e.setAttribute("fullShowComment", "0");
          112 < e.clientHeight ? (e.style.height = "100px", e.style.overflow = "hidden") : g.style.display = "none";
        }
      });
  ...
  buildPlayersSwiper = function buildPlayersSwiper() {
    ...
    (function (b) {
      ...
      requestCall(function (c) {
        ...
        getPlayersSkins(function (e) {
          for (e = 0; e < c.length; e++) glob_players.push(c[e].name), c[e].head = prepare_img_link(c[e].head), a.innerHTML += "\n                        <div class=\"swiper-slide text-center\">\n                            <span class=\"d-block py-5\">\n                                <div class=\"player_head_container\">\n                                    <div \n                                        class=\"player-head d-block mx-auto\" \n                                        style=\"background-image: url(".concat(c[e].head, ");border-radius:.75em\"\n                                    ></div>\n                                </div>\n                                <div class=\"card-body p-3\">\n                                    <h3 class=\"fs-lg fw-semibold pt-1 mb-2\">\n                                        ").concat(c[e].name, "\n                                    </h3>\n                                    <!-- <div class=\"player_badge_container\" style=\"", "display:none", "\">\n                                        ", "\n                                    </div> -->\n                                    <p class=\"fs-sm mb-0\" style=\"text-align:center\">").concat(c[e].desc, "</p>\n                                </div>\n                            </span>\n                        </div>\n                    ");
          try {
  ...
  donate_element_click = function donate_element_click(a) {
    ...
    var m = function m() {
      ...
      if (!b.includes(a.type)) {
        var _n = parseInt(e.value) * a.price;
  ...
  donateResetPaymentState = function donateResetPaymentState() {
    ...
    var e = ["donate_sum", "donate_customer_c", "donate_email_c", "coupon-input-c", "donate-pay-method"];
    var f = "_c";
    ...
    if (c) {
      ...
      for (d = 0; d < e.length; d++) {
        var h = document.getElementById(e[d]);
        if (!e[d].includes("coupon") || c) e[d].includes("method") ? h.value = 1 : h.value = "";
      }
  ...
  donate_cart = function donate_cart(a, b) {
    ...
    Number.isInteger(a) && Number.isInteger(b) && (1 > Math.sign(b) ? notify("\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u043D\u0435 \u043C\u043E\u0436\u0435\u0442 \u0431\u044B\u0442\u044C \u0440\u0430\u0432\u043D\u043E \u043D\u0443\u043B\u044E \u0438\u043B\u0438 \u043C\u0435\u043D\u044C\u0448\u0435") : 3E4 < f + b ? notify("\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u043E\u0435 \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E - <span style=\"color: #a4a6ff\">30000</span>") : (d || Cookies.set(cart_cookie, JSON.stringify({})), d = JSON.parse(Cookies.get(cart_cookie)), e = donate_get_service_by_id(a), c ? (delete d[a], notify("\u0422\u043E\u0432\u0430\u0440 ".concat('<span style="color: #a4a6ff">', " ", e.name, "</span> \u0443\u0431\u0440\u0430\u043D \u0438\u0437 \u043A\u043E\u0440\u0437\u0438\u043D\u044B"))) : d[a] ? (d[a] += b, notify("\u0412 \u043A\u043E\u0440\u0437\u0438\u043D\u0443 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u043E ".concat('<span style="color: #a4a6ff">', " ", b, " \n                    </span>\n                    ").concat(getNoun(b, "\u0435\u0434\u0438\u043D\u0438\u0446\u0430", "\u0435\u0434\u0438\u043D\u0438\u0446\u044B", "\u0435\u0434\u0438\u043D\u0438\u0446"), " \n                    \u0442\u043E\u0432\u0430\u0440\u0430 ", '<span style="color: #a4a6ff">', " ").concat(e.name, " \n                    </span>"))) : (d[a] = b, notify("\u0422\u043E\u0432\u0430\u0440 ".concat('<span style="color: #a4a6ff">', " ", e.name, "</span> \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443"))), Cookies.set(cart_cookie, JSON.stringify(d)), modal_close_(), initDonate(), updateCartCount(), donateResetPaymentState()));
  },
  ...
  generatePaymentLink = function generatePaymentLink() {
    ...
    var e = document.getElementById("donate_customer" + c).value.trim();
  ...
  payment_action_bt = function payment_action_bt() {
    ...
    enable_modal_result_sc();
    var e = ["donate_sum", "donate_customer_c", "donate_email_c", "coupon-input-c"];
    for (var f = 0; f < e.length; f++) document.getElementById(e[f]).value = "";
    a.innerHTML = "";
    d.innerText = "";
  ...
  donateCartCall = function donateCartCall() {
    ...
    var f = [document.getElementById("donate_customer"), document.getElementById("donate_email"), document.getElementById("coupon-input")];
    switch_modal_containers("donate_finish");
    modal_open_();
    e.innerHTML = "";
    var g = 0;
    for (var h = 0; h < f.length; h++) f[h].addEventListener("input", function (k) {
      donateResetPaymentState();
    });
  ...
  donateModalCall = function donateModalCall(a, b) {
    ...
    var e = document.getElementById("donate_customer_c"),
  ...
  openTelegramAuthModal = function openTelegramAuthModal() {
    ...
    checkTelegramAuthData(function (b) {
      if (!b) {
        ...
        e.setAttribute("class", "text-start px-3 pt-1 pt-lg-2");
