  ...
  loadPlayerAvatar = function loadPlayerAvatar(a) {
    ...
    a: {
      ...
      for (var e = 0; 10 > e; e++) if (crypto_token) {
        e = "".concat(backend_host, "/profile/avatar/?texture_hash=").concat(a, "&crypto_token=").concat(encodeURIComponent(crypto_token), "&tg_auth=").concat(encodeURIComponent(getTelegramAuth(!0)));
        var g = prepare_img_link(e);
        testImage(e);
        if (c) break a;else d.setAttribute("style", 'background-image: url("'.concat(g, '");border-radius:.').concat(b.includes("card-avatar") ? 35 : 15, "rem;"));
        break a;
      } else initCrypto();
    }
  },
