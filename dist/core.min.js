...
var site_domains = {
  ...
  loadPlayerAvatar = function loadPlayerAvatar(a) {
    ...
    a: {
      ...
      for (var f = 0; 10 > f; f++) if (!crypto_token && d) initCrypto();else {
        ...
        f = prepare_img_link(d);
        testImage(d);
        if (c) break a;else e.setAttribute("style", 'background-image: url("'.concat(f, '");border-radius:.').concat(b.includes("card-avatar") ? 35 : 15, "rem;"));
        break a;
      }
    }
  },
    ...
    requestCall(function (b) {
      if (b && b.id && "main" === b.target_commitish && "hevav" === b.author.login && !b.draft && b.assets.length) {
        for (var c = {}, d = 0, e = Object.keys(launcher_platforms); d < e.length; d++) {
          var f = e[d],
            g = _createForOfIteratorHelper(b.assets),
            h;
          try {
            for (g.s(); !(h = g.n()).done;) {
              var k = h.value;
              k.name.split(".").slice(-1)[0] === launcher_platforms[f] && (c[f] = k.browser_download_url);
            }
          } catch (l) {
            g.e(l);
          } finally {
    ...
    get_donate_services(function (a) {
      ...
      if (a.length) {
        ...
        for (var e = 0; e < a.length; e++) {
          ...
          var m = 'onClick="donate_element_click('.concat(JSON.stringify(f), ')"');
          coins_sell_mode ? (k = "\u0422\u043E\u0432\u0430\u0440 \u0431\u0435\u0437 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u044F.", a[e].description && (k = a[e].description), a[e].name.toLowerCase().includes("\u0442\u043E\u043A\u0435\u043D") ? (g = "".concat(a[e].price, " ").concat(getNoun(a[e].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), ' = <span class="text-primary">').concat(a[e].number, " ").concat(getNoun(a[e].number, "\u0442\u043E\u043A\u0435\u043D", "\u0442\u043E\u043A\u0435\u043D\u0430", "\u0442\u043E\u043A\u0435\u043D\u043E\u0432"), "</span>"), h = "p-0", k = "\n                        <p class=\"mb-0 token-description-dnt\">\n                            \u0418\u0433\u0440\u043E\u0432\u0430\u044F \u0432\u0430\u043B\u044E\u0442\u0430, \u043A\u043E\u0442\u043E\u0440\u0443\u044E \u043C\u043E\u0436\u043D\u043E \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043A\u0430\u043A \u0432 \u0438\u0433\u0440\u0435, \u0442\u0430\u043A \u0438 \u0437\u0430 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0443 \u043F\u0440\u043E\u0435\u043A\u0442\u0430.\n                        </p>") : (a[e].name.toLowerCase().includes("\u0441\u043B\u043E\u0442") ? g = "".concat(a[e].price, " ").concat(getNoun(a[e].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), ' = <span class="text-primary">').concat(a[e].number, " ").concat(getNoun(a[e].number, "\u0441\u043B\u043E\u0442", "\u0441\u043B\u043E\u0442\u0430", "\u0441\u043B\u043E\u0442\u043E\u0432"), "</span>") : (a[e].type = "other", g = '\n                        <span class="text-primary">'.concat(a[e].name, "</span>,\n                        ").concat(a[e].price, " ").concat(getNoun(a[e].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"))), h = "p-0", k = '\n                        <p class="mb-0 token-description-dnt">\n                            '.concat(k, "\n                        </p>")), m = "", l = '\n                        <button class="btn btn-primary shadow-primary btn-shadow-hide btn-lg min-w-zl donate-item-butt-bottom" \n                            onclick="donateModalCall(\n                                '.concat(d(f.name, f.type), ", ").concat(f.service_id, '\n                            )">\n                            ').concat("\u041F\u0440\u0438\u043E\u0431\u0440\u0435\u0441\u0442\u0438", "\n                        </button>")) : g = a[e].name;
  ...
  payment_action_bt = function payment_action_bt() {
    ...
    enable_modal_result_sc();
    for (var e = ["donate_sum", "donate_customer_c", "donate_email_c", "coupon-input-c"], f = 0; f < e.length; f++) document.getElementById(e[f]).value = "";
    a.innerHTML = "";
    d.innerText = "";
  ...
  donateCartCall = function donateCartCall() {
    ...
    modal_open_();
    e.innerHTML = "";
    for (var g = 0, h = 0; h < f.length; h++) f[h].addEventListener("input", function (l) {
      donateResetPaymentState();
    });
  ...
  donateModalCall = function donateModalCall(a, b) {
    ...
    if (1 === a || 3 === a) {
      if (k.setAttribute("disabled", ""), f.style.display = "", g.remove("col-sm-6"), g.add("col-12"), f = document.getElementById("donate-sum-title"), 1 === a) {
    ...
    checkPayment(function (g) {
      if ("undefined" !== typeof g.status) {
        if (g.status && a == parseInt(g.id)) {
          ...
          if (!g.payment_system || g.payment_system.match("undefined")) l = "";
