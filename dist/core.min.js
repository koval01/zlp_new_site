...
var telegram_social_bot = "https://t.me/ZalupaScBot",
  ...
  ytVideoSetter = function ytVideoSetter() {
    ...
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !1;
    var c = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !0;
    var d = function d(g, h, k) {
        g.innerHTML = "\n            <iframe src=\"https://www.youtube.com/embed/".concat(h, "\" title=\"YouTube video player\"\n                frameborder=\"0\" class=\"video-container-yt\" id=\"ytframe_").concat(h, "\"\n                allow=\"accelerometer; ").concat(null != k.autoplay ? "autoplay" : "", "; clipboard-write; encrypted-media; gyroscope; picture-in-picture\"\n                allowfullscreen=\"\" loading=\"lazy\"></iframe>\n        ");
      },
      f = function f(g, h, k, l) {
        g.innerHTML = "\n            <video class=\"video-container\" preload=\"none\" id=\"ytframe_".concat(h, "\" \n                    poster=\"/assets/images/videos/").concat(h, ".webp\" \n                  ").concat(null != l.autoplay ? 'autoplay=""' : "", " ").concat(null != l.muted ? 'muted=""' : "", " ").concat(null != l.loop ? 'loop=""' : "", " ").concat(null != l.controls ? 'controls=""' : "", " style=\"object-fit: contain\">\n                <source src=\"").concat(k, "\" type=\"video/mp4\">\n            </video>\n        ");
      },
      e = function e(g, h, k) {
        c ? f(g, h, "//files.zalupa.online/videos/".concat(h, ".mp4"), k) : b ? d(g, h, k) : get_yt_video_(function (l) {
          l && l.video.x720.url && !a ? f(g, k, l.video.x720.url) : d(g, h, k);
        }, h, a);
      };
    for (var _i3 = 0, _Array$from = Array.from(document.getElementsByClassName("ytVideoSetter")); _i3 < _Array$from.length; _i3++) {
      var g = _Array$from[_i3];
      var h = g.getAttribute("video_id");
      h && h.length && 20 > h.length && (e(g, h, {
  ...
  check_modal_ = function check_modal_() {
    setInterval(function () {
