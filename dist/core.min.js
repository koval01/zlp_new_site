...
var site_domains = {
  ...
  getImageLightness = function getImageLightness(a, b) {
    ...
    c && (d.onload = function () {
      ...
      g = imageData.data;
      f = 0;
      for (var h = g.length; f < h; f += 4) {
        var k = g[f];
        var l = g[f + 1];
        var m = g[f + 2];
        k = Math.floor((k + l + m) / 3);
        e += k;
      }
  ...
  appendPostsNews = function appendPostsNews() {
    ...
    if (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 1) {
      ...
      var c = function c(d) {
        ...
        d = d.reverse();
        for (var g = function g(h) {
            var k = d[h].text,
              l = k.split(" "),
              m = new Date(d[h].datetime_utc);
            d[h].cover || (d[h].cover = "assets/images/spawn.webp");
            e.innerHTML += '\n                    <div class="swiper-slide h-auto px-2" style="max-height: 40vh !important;display: '.concat(5 <= l.length ? "block" : "none", '">\n                        <figure class="card h-100 position-relative border-0 news-figure" id="news_figure_').concat(h, '">\n                            <div class="background-news" id="background-news-').concat(h, '">\n                                <div class="background-news-overlay" id="news-overlay-').concat(h, '">\n                                    <div class="background-news-overlay-dark-mode">\n                                        <div \n                                        style="z-index:6;top:35.1%;height:65%"\n                                        class="shadow-vertical-overlay shadow-vertical-overlay-news vertical-bottom-shadow"\n                                        ></div>\n                                        <blockquote class="card-body mt-2 mb-3 news-text-container">\n                                            <p class="fs-md mb-0 news-text h6" id="news_text_').concat(h, '" style="font-family:sans-serif">\n                                                    ').concat(k, '</p>\n                                            <div class="news-bottom-container" style="z-index:8">\n                                                <a class="btn btn-primary shadow-primary btn-lg news-button-view"\n                                                   href="').concat(d[h].link, "\" target=\"_blank\">\n                                                        \u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n                                            </div>\n                                        </blockquote>\n                                    </div>\n                                </div> \n                            </div>\n                        </figure>\n                        <span class=\"news-date-text\">\n                            ").concat(m.toLocaleDateString(), " \n                            ").concat(m.toLocaleTimeString("ru-RU", {
              hour: "2-digit",
              minute: "2-digit"
            }), "\n                        </span>\n                    </div>\n                ");
            document.getElementById("background-news-".concat(h)).style.backgroundImage = "url(".concat(d[h].cover, ")");
            k = document.getElementById("news_text_".concat(h));
            k.style.width = "100%";
            k.classList.add("text-light");
            k.style.fontSize = "calc(1.35vw + .75vh)";
            getImageLightness(d[h].cover, function (n) {
              n = "#000000".concat(((parseFloat(n) / 255 * 100).toFixed() + 64).toString(16).slice(0, 2));
              document.getElementById("news-overlay-".concat(h)).style.background = n;
            });
  ...
  loadPlayerAvatar = function loadPlayerAvatar(a) {
    ...
    a: {
      ...
      for (var g = 0; 10 > g; g++) if (!crypto_token && d) initCrypto();else {
        d = d ? "".concat(backend_host, "/profile/avatar/?texture_hash=").concat(a, "&crypto_token=").concat(encodeURIComponent(crypto_token), "&tg_auth=").concat(encodeURIComponent(getTelegramAuth(!0))) : "//communication.zalupa.online/tiles/faces/32x32/".concat(a, ".png");
        g = prepare_img_link(d);
        testImage(d);
        if (c) break a;else e.setAttribute("style", 'background-image: url("'.concat(g, '");border-radius:.').concat(b.includes("card-avatar") ? 35 : 15, "rem;"));
        break a;
      }
    }
  },
  ...
  cloudflareTraceJSON = function cloudflareTraceJSON(a) {
    ...
    var c;
    try {
      for (b.s(); !(c = b.n()).done;) p = c.value.split("="), a[p[0]] = p[1];
    } catch (d) {
      b.e(d);
    } finally {
      b.f();
  ...
  ytVideoSetter = function ytVideoSetter() {
    for (var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : !1, b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1, c = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : !0, d = function d(m, n, q) {
        m.innerHTML = '\n            <iframe src="https://www.youtube.com/embed/'.concat(n, '" title="YouTube video player"\n                frameborder="0" class="video-container-yt" id="ytframe_').concat(n, '"\n                allow="accelerometer; ').concat(null != q.autoplay ? "autoplay" : "", '; clipboard-write; encrypted-media; gyroscope; picture-in-picture"\n                allowfullscreen="" loading="lazy"></iframe>\n        ');
      }, e = function e(m, n, q, r) {
        m.innerHTML = '\n            <video class="video-container" preload="none" id="ytframe_'.concat(n, '" \n                    poster="/assets/images/videos/').concat(n, '.webp" \n                  ').concat(null != r.autoplay ? 'autoplay=""' : "", " ").concat(null != r.muted ? 'muted=""' : "", " ").concat(null != r.loop ? 'loop=""' : "", " ").concat(null != r.controls ? 'controls=""' : "", ' style="object-fit: contain">\n                <source src="').concat(q, '" type="video/mp4">\n            </video>\n        ');
      }, g = function g(m, n, q) {
        c ? e(m, n, "//files.zalupa.online/videos/".concat(n, ".mp4"), q) : b ? d(m, n, q) : get_yt_video_(function (r) {
          r && r.video.x720.url && !a ? e(m, q, r.video.x720.url) : d(m, n, q);
        }, n, a);
      }, f = 0, h = Array.from(document.getElementsByClassName("ytVideoSetter")); f < h.length; f++) {
      var k = h[f],
        l = k.getAttribute("video_id");
      l && l.length && 20 > l.length && (g(k, l, {
        autoplay: k.getAttribute("autoplay"),
        muted: k.getAttribute("muted"),
        loop: k.getAttribute("loop"),
        controls: k.getAttribute("controls")
      }), k.getAttribute("bottomzero") && (document.getElementById("ytframe_".concat(l)).style.marginBottom = "0"));
    }
  },
  ...
  select_card_skin = function select_card_skin(a) {
    ...
    for (var d = 0; d < c.length; d++) {
      var e = b[c[d]];
      if (a >= parseInt(c[d])) return selector_card_skin_displayed !== e && (console.debug(e), selector_card_skin_displayed = e), prepare_img_link("".concat("./assets/images/card_skins", "/").concat(e, ".png"));
    }
    return prepare_img_link("".concat("./assets/images/card_skins", "/clay.png"));
  },
    ...
    requestCall(function (c) {
      ...
      b(function (d) {
        for (var e = 0; e < c.length; e++) {
          a: for (var g = 0; g < d.length; g++) if (d[g].name === c[e].name) break a;
      ...
      requestCall(function (c) {
        ...
        getPlayersSkins(function (f) {
          for (f = 0; f < c.length; f++) {
            var h = f;
            glob_players.push(c[h].name);
            c[h].head = prepare_img_link(c[h].head);
            a.innerHTML += '\n                        <div class="swiper-slide text-center">\n                            <span class="d-block py-5">\n                                <div class="player_head_container">\n                                    <div \n                                        class="player-head d-block mx-auto" \n                                        style="background-image: url('.concat(c[h].head, ');border-radius:.75em"\n                                    ></div>\n                                </div>\n                                <div class="card-body p-3">\n                                    <h3 class="fs-lg fw-semibold pt-1 mb-2">\n                                        ').concat(c[h].name, '\n                                    </h3>\n                                    <p class="fs-sm mb-0" style="text-align:center">').concat(c[h].desc, "</p>\n                                </div>\n                            </span>\n                        </div>\n                    ");
          }
          try {
  ...
  donateModalCall = function donateModalCall(a, b) {
    ...
    var d = document.getElementById("donate_sum"),
      ...
      l = [document.getElementById("donate_sum"), document.getElementById("donate_customer_c"), document.getElementById("donate_email_c"), document.getElementById("coupon-input-c")],
    ...
    if (1 === a || 3 === a) {
      if (k.setAttribute("disabled", ""), g.style.display = "", f.remove("col-sm-6"), f.add("col-12"), g = document.getElementById("donate-sum-title"), 1 === a) {
        ...
        var q = "\u0422\u043E\u043A\u0435\u043D\u044B";
        g.innerText = "\u0421\u0443\u043C\u043C\u0430";
        d.addEventListener("input", function (r) {
          donateCoinsPay();
        });
      } else 3 === a && (n = "\n                \u0414\u043E\u0431\u0430\u0432\u043B\u044F\u0435\u0442 +1 \u0441\u043B\u043E\u0442 \u0432 \u043A\u043B\u0430\u043D. \u0421\u0438\u0441\u0442\u0435\u043C\u0430 \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u044F\u0435\u0442 \u0432\u0430\u0448 \u043A\u043B\u0430\u043D \u043F\u043E \u043D\u0438\u043A\u043D\u0435\u0439\u043C\u0443, \n                \u043F\u043E\u044D\u0442\u043E\u043C\u0443 \u0431\u0443\u0434\u044C\u0442\u0435 \u0432\u043D\u0438\u043C\u0430\u0442\u0435\u043B\u044C\u043D\u044B \u043F\u0435\u0440\u0435\u0434 \u043E\u043F\u043B\u0430\u0442\u043E\u0439. \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0432 \u043A\u0430\u043A\u043E\u043C \u043A\u043B\u0430\u043D\u0435 \u0432\u044B \u0441\u043E\u0441\u0442\u043E\u0438\u0442\u0435.\n            ", q = "\u0421\u043B\u043E\u0442\u044B", g.innerText = "\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E", e.addEventListener("input", function (r) {
        donateCoinsPay(a);
      }));
    } else 2 === a && (k.removeAttribute("disabled"), g.style.display = "none", f.remove("col-12"), f.add("col-sm-6"), (desc_get = get_data_service(current_c_item).description) || (desc_get = ""), n = "\n            \u0424\u043E\u0440\u043C\u0430 \u043E\u043F\u043B\u0430\u0442\u044B \u043F\u043E\u0436\u0435\u0440\u0442\u0432\u043E\u0432\u0430\u043D\u0438\u044F \u0434\u043B\u044F \u0438\u0433\u0440\u043E\u0432\u043E\u0433\u043E \u043F\u0440\u043E\u0435\u043A\u0442\u0430 Zalupa.Online\n            <br/>\n            <span class=\"text-primary\">\n                ".concat(desc_get, "\n            </span>\n        "), q = current_c_item_name, e.addEventListener("input", function (r) {
      donateCoinsPay(a);
    }));
    h.innerHTML = n.replaceAll("\n", "");
    for (d = 0; d < l.length; d++) l[d].addEventListener("input", function (r) {
    ...
    (function (r) {
      ...
      m.innerText = "".concat(m.innerText, " (").concat(r, ")");
    })(q);
  },
