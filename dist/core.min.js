...
var telegram_social_bot = "https://t.me/ZalupaScBot",
  ...
  initHost = function initHost() {
    var a = Object.keys(site_domains);
    for (var b = 0; b < a.length; b++) site_domains[a[b]] === window.location.hostname && (work_domain_v = site_domains[a[b]]);
  },
  ...
  formatDate = function formatDate(a) {
    ...
    a = ["0" + a.getDate(), "0" + (a.getMonth() + 1), "" + a.getFullYear(), "0" + a.getHours(), "0" + a.getMinutes()].map(function (d) {
      return d.slice(-2);
    });
  ...
  downloadLauncher = function downloadLauncher() {
    getGitLauncherReleases(function (a) {
      ...
      isChrome() || notify("\u0421\u0435\u0439\u0447\u0430\u0441 \u0442\u0435\u0431\u0435 \u0441\u043A\u0430\u0447\u0430\u0435\u043C \u0444\u0430\u0439\u043B <span class=\"text-gradient-primary\">".concat(a.split("/").slice(-1)[0], "</span>"));
    });
  },
  ...
  shuffle = function shuffle(a) {
    ...
    for (; 0 !== b;) {
      var _ref;
      c = Math.floor(Math.random() * b), b--, (_ref = [a[c], a[b]], a[b] = _ref[0], a[c] = _ref[1]);
    }
    return a;
  },
  alternateSort = function alternateSort(a) {
    ...
    for (var d = 0; d < a.length; d++) {
      b = d;
      var c = a[d];
      for (var f = d + 1; f < a.length; f++) a[f] < c && (c = a[f], b = f);
  ...
  getImageLightness = function getImageLightness(a, b) {
    ...
    c && (d.onload = function () {
      ...
      e.width = _this.width;
      e.height = _this.height;
      var g = e.getContext("2d");
      try {
        g.drawImage(_this, 0, 0), g.getImageData(0, 0, e.width, e.height);
      } catch (l) {
        b(null);
        return;
      }
      e = imageData.data;
      var h, k;
      for (var l = 0, m = e.length; l < m; l += 4) g = e[l], h = e[l + 1], k = e[l + 2], g = Math.floor((g + h + k) / 3), f += g;
      b(Math.floor(f / (_this.width * _this.height)));
      d.remove();
    });
  },
  ...
  getNoun = function getNoun(a) {
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "\u0438\u0433\u0440\u043E\u043A";
    var c = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "\u0438\u0433\u0440\u043E\u043A\u0430";
    var d = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "\u0438\u0433\u0440\u043E\u043A\u043E\u0432";
    a = Math.abs(a);
    a %= 100;
  ...
  appendPostsNews = function appendPostsNews() {
    ...
    var b = function b() {
      setTimeout(function () {
        var c = document.getElementById("telegram_block_load"),
          d = document.getElementById("news_zlp_buttons");
        try {
          c.parentNode.removeChild(c), d.style.display = "";
        } catch (f) {}
      }, 150);
    };
    if (a) a = document.getElementById("news-c-container"), a.innerHTML = '\n        <div class="shadow-vertical-overlay vertical-top-shadow" style="width:100vw!important"></div>\n        <div class="shadow-vertical-overlay vertical-bottom-shadow" style="width:100vw!important"></div>\n        <iframe \n            style="min-height:450px;width:100vw" \n            id="tg-iframe-view"\n            src="https://telegram-worker.zalupa.online/zalupaonline" \n            onload="try{document.getElementById(\'telegram_block_load\').remove()} catch {}">\n        </iframe>' + a.innerHTML, b(), document.getElementById("theme-mode").addEventListener("change", function () {
      var c = document.getElementById("tg-iframe-view"),
        d = new URL(c.src);
      d.hash = this.checked ? "#dark" : "#light";
      c.src = d.href;
    });else {
      var c = function c(d) {
        var f = document.getElementById("news_swipe_array");
        d = d.reverse();
        var _loop = function _loop(g) {
          e = d[g].text;
          var h = e.split(" "),
            k = new Date(d[g].datetime_utc);
          d[g].cover || (d[g].cover = "assets/images/spawn.webp");
          f.innerHTML += "\n                    <div class=\"swiper-slide h-auto px-2\" style=\"max-height: 40vh !important;display: ".concat(5 <= h.length ? "block" : "none", "\">\n                        <figure class=\"card h-100 position-relative border-0 news-figure\" id=\"news_figure_").concat(g, "\">\n                            <div class=\"background-news\" id=\"background-news-").concat(g, "\">\n                                <div class=\"background-news-overlay\" id=\"news-overlay-").concat(g, "\">\n                                    <div class=\"background-news-overlay-dark-mode\">\n                                        <div \n                                        style=\"z-index:6;top:35.1%;height:65%\"\n                                        class=\"shadow-vertical-overlay shadow-vertical-overlay-news vertical-bottom-shadow\"\n                                        ></div>\n                                        <blockquote class=\"card-body mt-2 mb-3 news-text-container\">\n                                            <p class=\"fs-md mb-0 news-text h6\" id=\"news_text_").concat(g, "\" style=\"font-family:sans-serif\">\n                                                    ").concat(e, "</p>\n                                            <div class=\"news-bottom-container\" style=\"z-index:8\">\n                                                <a class=\"btn btn-primary shadow-primary btn-lg news-button-view\"\n                                                   href=\"").concat(d[g].link, "\" target=\"_blank\">\n                                                        \u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n                                            </div>\n                                        </blockquote>\n                                    </div>\n                                </div> \n                            </div>\n                        </figure>\n                        <span class=\"news-date-text\">\n                            ").concat(k.toLocaleDateString(), " \n                            ").concat(k.toLocaleTimeString("ru-RU", {
            hour: "2-digit",
            minute: "2-digit"
          }), "\n                        </span>\n                    </div>\n                ");
          document.getElementById("background-news-".concat(g)).style.backgroundImage = "url(".concat(d[g].cover, ")");
          e = document.getElementById("news_text_".concat(g));
          e.style.width = "100%";
          e.classList.add("text-light");
          e.style.fontSize = "calc(1.35vw + .75vh)";
          getImageLightness(d[g].cover, function (l) {
            l = "#000000".concat(((parseFloat(l) / 255 * 100).toFixed() + 64).toString(16).slice(0, 2));
            document.getElementById("news-overlay-".concat(g)).style.background = l;
          });
        };
        ...
        d && (new Swiper("#news_swipe_container", {
          spaceBetween: 12,
          loop: !0,
          observer: !0,
          observeParents: !0,
  ...
  donateSwitchContainer = function donateSwitchContainer(a) {
    ...
    if (!donate_displayed || a) {
      var e = document.getElementById("donateButtonLandingTop");
      ...
      checkTelegramAuthData(function (g) {
        ...
        g ? (document.body.style.overflowY = "hidden", window.scrollTo({
          top: 0,
          behavior: "smooth"
        }), b.style.minHeight = "", f(""), donate_displayed = !0, location.hash = "#donate", d.paddingTop = "50px") : openTelegramAuthModal(!0);
      });
  ...
  gameServerUpdater = function gameServerUpdater() {
    ...
    setInterval(monitoring_game_server_update, 5E3);
  },
  ...
  create_payment = function create_payment(a, b, c, d) {
    var f = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "";
    ...
    re_check(function (g) {
      requestCall(function (h) {
        ...
        products: c,
        email: f,
        coupon: 2 !== donatePayMethodSelector() ? e : null,
        token: g,
        server_id: d,
  ...
  loadPlayerAvatar = function loadPlayerAvatar(a) {
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "telegram-auth-avatar";
    var c = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
    ...
    a: {
      ...
      if (!c) {
        try {
          f = document.getElementById(b), f.style;
        } catch (_unused) {}
        console.debug("Load avatar : ".concat(a));
        document.getElementById("tg-user-avatar-text").innerText = "";
      }
      for (var e = 0; 10 > e; e++) if (!crypto_token && d) initCrypto();else {
        a = d ? "".concat(backend_host, "/profile/avatar/?texture_hash=").concat(a, "&crypto_token=").concat(encodeURIComponent(crypto_token), "&tg_auth=").concat(encodeURIComponent(getTelegramAuth(!0))) : "//communication.zalupa.online/tiles/faces/32x32/".concat(a, ".png");
        d = prepare_img_link(a);
        testImage(a);
        if (c) break a;else f.setAttribute("style", "background-image: url(\"".concat(d, "\");border-radius:.").concat(b.includes("card-avatar") ? 35 : 15, "rem;"));
        break a;
      }
    }
  },
  ...
  checkTelegramAuthData = function checkTelegramAuthData(a) {
    ...
    var c = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
    var d = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : !1;
    var f = getTelegramAuth(!0);
    f ? telegram_glob_session.auth_data !== f || d ? (console.debug("skip pos : ".concat(b)), b ? a(!0) : re_check(function (e) {
      requestCall(function (g) {
        if (g) {
          if (console.debug(g), g.success) {
            var h = document.getElementById("telegram-auth-avatar");
            glob_auth_player_data = g.player_data;
            console.debug(g);
            if (g.player_data) {
              var k = g.player_data,
                l = k.NICKNAME,
                m = function m() {
                  if (!h.style.backgroundImage || 1 > h.style.backgroundImage.length) loadPlayerAvatar(l), loadPlayerAvatar(l, "card-avatar-object"), avatar_loaded = !0;
                };
              m();
  ...
  cloudflareTraceJSON = function cloudflareTraceJSON(a) {
    a = a.split("\n");
    var b = {};
  ...
  cloudflareTrace = function cloudflareTrace(a) {
    requestCall(function (b) {
      b ? a(cloudflareTraceJSON(b)) : a(null);
    }, "https://cloudflare.com/cdn-cgi/trace", "GET", !1);
  },
  getGitLauncherReleases = function getGitLauncherReleases(a) {
    requestCall(function (b) {
      if (b && b.id && "main" === b.target_commitish && "hevav" === b.author.login && !b.draft && b.assets.length) {
        ...
        for (var _i = 0, _Object$keys = Object.keys(launcher_platforms); _i < _Object$keys.length; _i++) {
          ...
          var _iterator2 = _createForOfIteratorHelper(b.assets),
            _step2;
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var f = _step2.value;
              f.name.split(".").slice(-1)[0] === launcher_platforms[d] && (c[d] = f.browser_download_url);
            }
          } catch (err) {
            _iterator2.e(err);
          } finally {
    ...
    }, "https://api.github.com/repos/".concat(gitOwner, "/").concat(gitLauncherRepo, "/releases/latest"), "GET", !0);
  },
  setLauncherLinks = function setLauncherLinks() {
    var a = document.getElementById("zalupa-launcher-links");
    getGitLauncherReleases(function (b) {
      var c = Object.keys(b);
      for (var _i2 = 0, _c = c; _i2 < _c.length; _i2++) {
        var d = _c[_i2];
        a.innerHTML += "\n        <a href=\"".concat(b[d], "\" style=\"text-transform:capitalize\"\n           class=\"btn btn-primary shadow-primary mt-3 m-1\" download=\"\">\n        ").concat(d.toLowerCase(), "</a>\n    ");
      }
    });
  },
  ...
  sendFeedbackAction = function sendFeedbackAction() {
    ...
    if (20 > b.length) notify("\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u043E\u0447\u0435\u043D\u044C \u043A\u043E\u0440\u043E\u0442\u043A\u043E\u0435!");else {
      ...
      checkFeedbackStatus(function (d) {
        d ? sendFeedback(function (f) {
          f ? notify("\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E \u0430\u0434\u043C\u0438\u043D\u0430\u043C.") : notify("\u041E\u0448\u0438\u0431\u043A\u0430 \u043D\u0430 \u0441\u0442\u043E\u0440\u043E\u043D\u0435 \u0441\u0435\u0440\u0432\u0435\u0440\u0430, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435.");
          c(!1);
    ...
    get_donate_services(function (a) {
      ...
      var b = ["row-cols-sm-2", "row-cols-md-3", "row-cols-lg-4"],
        ...
        d = function d(e, g) {
          e = e.toLowerCase();
          g = g.toLowerCase();
          if (e.includes("\u0442\u043E\u043A\u0435\u043D") && "currency" === g) return 1;
          if (e.includes("\u0441\u043B\u043E\u0442") && "currency" === g) return 3;
          if (e.includes("\u043F\u0440\u043E\u0445\u043E\u0434\u043A\u0430") && "other" === g) return 2;
        };
      if (a.length) {
        ...
        for (var e = 0; e < a.length; e++) {
          ...
          var m = "onClick=\"donate_element_click(".concat(JSON.stringify(g), ")\"");
          coins_sell_mode ? (f = "\u0422\u043E\u0432\u0430\u0440 \u0431\u0435\u0437 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u044F.", a[e].description && (f = a[e].description), a[e].name.toLowerCase().includes("\u0442\u043E\u043A\u0435\u043D") ? (h = "".concat(a[e].price, " ").concat(getNoun(a[e].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), " = <span class=\"text-primary\">").concat(a[e].number, " ").concat(getNoun(a[e].number, "\u0442\u043E\u043A\u0435\u043D", "\u0442\u043E\u043A\u0435\u043D\u0430", "\u0442\u043E\u043A\u0435\u043D\u043E\u0432"), "</span>"), k = "p-0", f = "\n                        <p class=\"mb-0 token-description-dnt\">\n                            \u0418\u0433\u0440\u043E\u0432\u0430\u044F \u0432\u0430\u043B\u044E\u0442\u0430, \u043A\u043E\u0442\u043E\u0440\u0443\u044E \u043C\u043E\u0436\u043D\u043E \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043A\u0430\u043A \u0432 \u0438\u0433\u0440\u0435, \u0442\u0430\u043A \u0438 \u0437\u0430 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0443 \u043F\u0440\u043E\u0435\u043A\u0442\u0430.\n                        </p>") : (a[e].name.toLowerCase().includes("\u0441\u043B\u043E\u0442") ? h = "".concat(a[e].price, " ").concat(getNoun(a[e].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), " = <span class=\"text-primary\">").concat(a[e].number, " ").concat(getNoun(a[e].number, "\u0441\u043B\u043E\u0442", "\u0441\u043B\u043E\u0442\u0430", "\u0441\u043B\u043E\u0442\u043E\u0432"), "</span>") : (a[e].type = "other", h = "\n                        <span class=\"text-primary\">".concat(a[e].name, "</span>,\n                        ").concat(a[e].price, " ").concat(getNoun(a[e].price, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"))), k = "p-0", f = "\n                        <p class=\"mb-0 token-description-dnt\">\n                            ".concat(f, "\n                        </p>")), m = "", l = "\n                        <button class=\"btn btn-primary shadow-primary btn-shadow-hide btn-lg min-w-zl donate-item-butt-bottom\" \n                            onclick=\"donateModalCall(\n                                ".concat(d(g.name, g.type), ", ").concat(g.service_id, "\n                            )\">\n                            ", "\u041F\u0440\u0438\u043E\u0431\u0440\u0435\u0441\u0442\u0438", "\n                        </button>")) : h = a[e].name;
          a[e].image = prepare_img_link(a[e].image);
          c.innerHTML += "\n                    <div class=\"col\" id=\"donate_item_".concat(a[e].id, "\">\n                        <div class=\"card border-0 bg-transparent\" ").concat(m, ">\n                          <div class=\"position-relative container-item-donate-n\">\n                            <div class=\"parent-image-shadow donate_item_hover\" \n                                id=\"donate_item_hover_").concat(a[e].id, "\">\n                                <div class=\"imageContainer item-levitaion-dec\">\n                                    <div \n                                    class=\"foregroundImg\" \n                                    style=\"background-image: url(").concat(a[e].image, ")\"\n                                    ></div>\n                                    <div \n                                    class=\"backgroundImg\" \n                                    style=\"background-image: url(").concat(a[e].image, ")\"\n                                    ></div>                               \n                                 </div>\n                            </div>\n                            <div class=\"card-img-overlay d-flex flex-column align-items-center \n                                        justify-content-center rounded-3\" \n                                 style=\"margin: auto\">\n                            </div>\n                          </div>\n                          <div class=\"card-body text-center ").concat(k, "\">\n                                <h3 class=\"fs-lg fw-semibold pt-1 mb-2\">").concat(h, "</h3>\n                                ").concat(f, "\n                                ").concat(l, "\n                          </div>\n                        </div>\n                    </div>\n                ");
        }
        checkPrivateServerBuy();
        setTimeout(function () {
          var e = document.getElementById("donate_block_load");
          var g = ["donate_items_list", "donate-header-container", "donate-test-mode-enb", "donate-cart-container"];
          try {
            e.parentNode.removeChild(e);
          } catch (h) {}
          for (e = 0; e < g.length; e++) try {
            document.getElementById(g[e]).style.display = "";
          } catch (h) {
            console.log("Donate block loader error. Details: ".concat(h));
          }
        }, 100);
  ...
  switchEventsPages = function switchEventsPages(a) {
    var b = document.getElementById("news-c-container"),
      ...
      f = document.getElementById("events-c-button");
  ...
  ytVideoSetter = function ytVideoSetter() {
    ...
    var c = function c(f, e, g) {
        f.innerHTML = "\n            <iframe src=\"https://www.youtube.com/embed/".concat(e, "\" title=\"YouTube video player\"\n                frameborder=\"0\" class=\"video-container-yt\" id=\"ytframe_").concat(e, "\"\n                allow=\"accelerometer; ").concat(null != g.autoplay ? "autoplay" : "", "; clipboard-write; encrypted-media; gyroscope; picture-in-picture\"\n                allowfullscreen=\"\" loading=\"lazy\"></iframe>\n        ");
      },
      d = function d(f, e, g) {
        b ? c(f, e, g) : get_yt_video_(function (h) {
          h && h.video.x720.url && !a ? f.innerHTML = "\n                    <video class=\"video-container\" ".concat(null != g.autoplay ? 'autoplay=""' : "", " ").concat(null != g.muted ? 'muted=""' : "", " ").concat(null != g.loop ? 'loop=""' : "", " ").concat(null != g.controls ? 'controls=""' : "", " style=\"object-fit: contain\">\n                        <source src=\"").concat(h.video.x720.url, "\" type=\"video/mp4\">\n                    </video>\n                ") : c(f, e, g);
        }, e, a);
      };
    for (var _i3 = 0, _Array$from = Array.from(document.getElementsByClassName("ytVideoSetter")); _i3 < _Array$from.length; _i3++) {
      var f = _Array$from[_i3];
      var e = f.getAttribute("video_id");
      e && e.length && 20 > e.length && (d(f, e, {
        autoplay: f.getAttribute("autoplay"),
        muted: f.getAttribute("muted"),
        loop: f.getAttribute("loop"),
        controls: f.getAttribute("controls")
      }), f.getAttribute("bottomzero") && (document.getElementById("ytframe_".concat(e)).style.marginBottom = "0"));
    }
  },
  ...
  switch_modal_containers = function switch_modal_containers() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "service";
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var c = document.getElementsByClassName("close_b")[0];
    var d = document.getElementById("modal-info-container-c"),
      f = document.getElementById("modal-donate-container-c"),
      e = document.getElementById("modal-donate-finish-container-b");
    var g = document.getElementById("modal-donate-success-container"),
    ...
    for (f = 0; f < d.length; f++) e = "none", a === d[f].name && (e = "block", k.innerText = d[f].title), d[f].selector.style.display = e;
  ...
  donatePayMethodSelector = function donatePayMethodSelector() {
    var a = parseInt(document.getElementById("donate-pay-method").value),
      b = document.getElementById("tokens-balance-choice-dnt-container");
    2 == a ? (b.style.marginTop = "1em", b.style.opacity = 1, failed_coupon = checked_coupon = document.getElementById("donate-coins-payment").innerHTML = "") : (b.style.marginTop = "-1.8em", b.style.opacity = 0);
    return a;
  },
  displayTokens = function displayTokens() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
    var b = glob_auth_player_data.BALANCE;
    if (tokens_system_enabled && (document.querySelector(".zalupa-card-container").style.display = "", Number.isInteger(b))) if (a) {
      a = document.getElementById("numberZalupaCard");
      document.querySelector(".ZalupaCardInput") || (a.innerHTML += "\n                    <input class=\"ZalupaCardInput\" style=\"display:none\" value=\"".concat(glob_auth_player_data.UUID, "\">\n                "));
      a = document.querySelector(".number-card-zalupa");
      var c = document.querySelector(".card-holder-zalupa");
      var d = document.querySelector(".balance-value-card"),
        f = document.getElementById("tokens-balance-choice-dnt"),
        e = "<span class=\"text-primary\">".concat(b, "</span> ").concat(getNoun(b, "\u0442\u043E\u043A\u0435\u043D", "\u0442\u043E\u043A\u0435\u043D\u0430", "\u0442\u043E\u043A\u0435\u043D\u043E\u0432"));
      f.innerHTML = "\u0423 \u0442\u0435\u0431\u044F ".concat(e);
      ...
      document.querySelector("input.ZalupaCardInput").value = glob_auth_player_data.UUID;
  ...
  select_card_skin = function select_card_skin(a) {
    ...
    for (var d = 0; d < c.length; d++) {
      var f = b[c[d]];
      if (a >= parseInt(c[d])) return selector_card_skin_displayed !== f && (console.debug(f), selector_card_skin_displayed = f), prepare_img_link("./assets/images/card_skins".concat("/", f, ".png"));
    }
    return prepare_img_link("./assets/images/card_skins/clay.png");
  },
  sendTokensModalOpen = function sendTokensModalOpen() {
    notify("\u042D \u0431\u0440\u0430\u0442, \u043D\u0435 \u0437\u0430\u0432\u0435\u0437\u043B\u0438 \u043F\u043E\u043A\u0430. \u041A\u043D\u043E\u043F\u043E\u0447\u043A\u0443 \u043D\u0435 \u0442\u0440\u043E\u0436");
  },
  comment_show_action = function comment_show_action(a) {
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !1;
    var c = document.getElementById("comment_text_".concat(a)),
      d = document.getElementById("comment_show_".concat(a));
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          if ("\u041F\u0440\u043E\u0445\u043E\u0434\u043A\u0430" === b.name && glob_auth_player_data.PRIVATE_SERVER) {
            var c = document.querySelector("#donate_item_".concat(b.id, ">div>div.card-body>button"));
            c.innerText = "\u041A\u0443\u043F\u043B\u0435\u043D\u043E";
    ...
    requestCall(function (c) {
      ...
      b(function (d) {
        for (var e = 0; e < c.length; e++) {
          a: for (var f = 0; f < d.length; f++) if (d[f].name === c[e].name) break a;
  ...
  buildPlayersSwiper = function buildPlayersSwiper() {
    ...
    try {
      loadPlayerAvatar(generateRandomHex(32), "", !0);
    } catch (_unused2) {}
    (function (b) {
      requestCall(function (c) {
        b(c);
      ...
      requestCall(function (c) {
        ...
        getPlayersSkins(function (f) {
          for (f = 0; f < c.length; f++) glob_players.push(c[f].name), c[f].head = prepare_img_link(c[f].head), a.innerHTML += "\n                        <div class=\"swiper-slide text-center\">\n                            <span class=\"d-block py-5\">\n                                <div class=\"player_head_container\">\n                                    <div \n                                        class=\"player-head d-block mx-auto\" \n                                        style=\"background-image: url(".concat(c[f].head, ");border-radius:.75em\"\n                                    ></div>\n                                </div>\n                                <div class=\"card-body p-3\">\n                                    <h3 class=\"fs-lg fw-semibold pt-1 mb-2\">\n                                        ").concat(c[f].name, "\n                                    </h3>\n                                    <p class=\"fs-sm mb-0\" style=\"text-align:center\">").concat(c[f].desc, "</p>\n                                </div>\n                            </span>\n                        </div>\n                    ");
          try {
  ...
  donate_bg_preload = function donate_bg_preload() {
    var a = ["emoji-background-donate-light", "emoji-background-donate"];
    for (var b = 0; b <= a; b++) getImageLightness("assets/images/".concat(b, ".png"), void 0, !1);
  },
  setSticker = function setSticker() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    var c = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    a = "assets/images/stickers/sticker".concat(randDiaps(a), ".webp");
    if (c) a = c;else if (lock_sticker_switch) return;
    c = prepare_img_link(a);
    document.getElementById("super-klassniy-sticker-".concat(b)).style.backgroundImage = "url(".concat(c, ")");
  },
  setRandomStickerLand = function setRandomStickerLand() {
    var a = document.getElementById("super-klassniy-sticker-0");
    for (var b = 0; 32 >= b; b++) getImageLightness("assets/images/stickers/sticker".concat(b, ".webp"), void 0, !1);
    setInterval(function () {
  ...
  donate_element_click = function donate_element_click(a) {
    ...
    var b = ["group"],
      ...
      f = document.getElementById("items_count_donate"),
      e = document.getElementById("donate_count_text_hint"),
      g = document.getElementById("donate_button_add_to_cart"),
      h = get_cookie_cart(),
      k = function k() {
        g.setAttribute("onClick", "donate_cart(".concat(a.service_id, ", ").concat(f.value, ")"));
      };
    f.value = 1;
    k();
    var l = h.hasOwnProperty(a.service_id.toString());
    if ((b.includes(a.type) || "group" === a.type) && groupAlreadyInCart(h)) {
      switch_modal_containers("info");
      var n = "";
      n = "group" === a.type ? "\u0412\u044B \u0443\u0436\u0435 \u0432\u044B\u0431\u0440\u0430\u043B\u0438 \u043F\u0440\u0438\u0432\u0438\u043B\u0435\u0433\u0438\u044E. \u0423\u0434\u0430\u043B\u0438\u0442\u0435 \u0435\u0451 \u0438\u0437 \u043A\u043E\u0440\u0437\u0438\u043D\u044B, \u0435\u0441\u043B\u0438 \u0445\u043E\u0442\u0438\u0442\u0435 \u0432\u044B\u0431\u0440\u0430\u0442\u044C \u0434\u0440\u0443\u0433\u0443\u044E." : l ? "\u041E\u0448\u0438\u0431\u043A\u0430, \u0432\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440 \n                <span class=\"text-primary fw-semibold\">".concat(a.name, "</span> \n                \u0442\u043E\u043B\u044C\u043A\u043E \u043E\u0434\u0438\u043D \u0440\u0430\u0437.") : "\u041C\u044B \u043D\u0435 \u0437\u043D\u0430\u0435\u043C \u043F\u043E\u0447\u0435\u043C\u0443, \u043D\u043E \u044D\u0442\u0430 \u043E\u0448\u0438\u0431\u043A\u0430 \u0432\u044B\u0437\u0432\u0430\u043D\u0430 \u043F\u043E \u043D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u043C \u043F\u0440\u0438\u0447\u0438\u043D\u0430\u043C.";
      document.getElementById("donate_info_block_text").innerHTML = n;
    }
    l = "block";
    b.includes(a.type) && (l = "none");
    f.style.display = l;
    e.style.display = l;
    var m = function m() {
      f.value = f.value.replace(/\D+/g, "");
      if (!b.includes(a.type)) {
        var _n = parseInt(f.value) * a.price;
        var r = h[a.service_id];
        var q = "";
        if (isNaN(_n) || 1 > Math.sign(_n)) _n = 0;
        r && (q = "\n                    \u0423\u0436\u0435 \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0435 - \n                        <span class=\"text-primary fw-semibold\">\n                            ".concat(r, "\n                        </span>\n                "));
        c.innerHTML = "".concat(d, "\n                    <br/>\n                    \u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C - \n                        <span class=\"text-primary fw-semibold\">\n                            ").concat(_n, " \n                            ").concat(getNoun(_n, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), "\n                        </span>\n                    <br/>\n                    ").concat(q, "\n                ");
        k();
      }
    };
    c.innerHTML = d;
    m();
    f.addEventListener("input", function (n) {
      m();
    });
    modal_open_();
  },
  ...
  donateResetPaymentState = function donateResetPaymentState() {
    ...
    var f = ["donate_sum", "donate_customer_c", "donate_email_c", "coupon-input-c", "donate-pay-method"];
    var e = "_c";
    var g = document.getElementById("donate_sum").value.trim();
    coins_sell_mode || (e = "", g = 0);
    e = document.getElementById("payment-button-donate" + e);
    if (c) {
      d.innerHTML = "";
      for (d = 0; d < f.length; d++) {
        var h = document.getElementById(f[d]);
        if (!f[d].includes("coupon") || c) f[d].includes("method") ? h.value = 1 : h.value = "";
      }
      failed_coupon = checked_coupon = "";
    }
    e.setAttribute("onClick", "generatePaymentLink(".concat(a, ", ").concat(2 === a ? 1 : g, ")"));
    e.removeAttribute("disabled");
    e.innerText = b ? "\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C" : "\u0414\u0430\u043B\u044C\u0448\u0435";
  },
  donate_cart = function donate_cart(a, b) {
    var c = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
    var d = Cookies.get(cart_cookie),
      f = get_cookie_cart();
    var e = 0;
    try {
      var g = f[a];
      Number.isInteger(g) && (e = +g);
    } catch (g) {}
    Number.isInteger(a) && Number.isInteger(b) && (1 > Math.sign(b) ? notify("\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u043D\u0435 \u043C\u043E\u0436\u0435\u0442 \u0431\u044B\u0442\u044C \u0440\u0430\u0432\u043D\u043E \u043D\u0443\u043B\u044E \u0438\u043B\u0438 \u043C\u0435\u043D\u044C\u0448\u0435") : 3E4 < e + b ? notify("\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u043E\u0435 \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E - <span style=\"color: #a4a6ff\">30000</span>") : (d || Cookies.set(cart_cookie, JSON.stringify({})), d = JSON.parse(Cookies.get(cart_cookie)), f = donate_get_service_by_id(a), c ? (delete d[a], notify("\u0422\u043E\u0432\u0430\u0440 ".concat('<span style="color: #a4a6ff">', " ", f.name, "</span> \u0443\u0431\u0440\u0430\u043D \u0438\u0437 \u043A\u043E\u0440\u0437\u0438\u043D\u044B"))) : d[a] ? (d[a] += b, notify("\u0412 \u043A\u043E\u0440\u0437\u0438\u043D\u0443 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u043E ".concat('<span style="color: #a4a6ff">', " ", b, " \n                    </span>\n                    ").concat(getNoun(b, "\u0435\u0434\u0438\u043D\u0438\u0446\u0430", "\u0435\u0434\u0438\u043D\u0438\u0446\u044B", "\u0435\u0434\u0438\u043D\u0438\u0446"), " \n                    \u0442\u043E\u0432\u0430\u0440\u0430 ", '<span style="color: #a4a6ff">', " ").concat(f.name, " \n                    </span>"))) : (d[a] = b, notify("\u0422\u043E\u0432\u0430\u0440 ".concat('<span style="color: #a4a6ff">', " ", f.name, "</span> \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443"))), Cookies.set(cart_cookie, JSON.stringify(d)), modal_close_(), initDonate(), updateCartCount(), donateResetPaymentState()));
  },
  donate_cart_button = function donate_cart_button() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var b = document.querySelectorAll(".donate-cart-button-cn");
    if (!coins_sell_mode) {
      var _loop2 = function _loop2(c) {
        var d = b[c].style;
        countProperties(a) ? (d.display = "flex", setTimeout(function () {
          d.opacity = 1;
          d.marginTop = "15px";
          b[c].removeAttribute("disabled");
        }, 50)) : (b[c].setAttribute("disabled", ""), d.opacity = 0, d.marginTop = "-50px", setTimeout(function () {
          d.display = "none";
        }, 350));
      };
  ...
  getTelegramAuth = function getTelegramAuth() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !1;
    var b = Cookies.get(telegram_cookie_token);
    if (b) {
      if (a) return b;
      if (b) return JSON.parse(b64_to_utf8(b));
    }
  },
  couponCheck = function couponCheck(a) {
    a = "";
    coins_sell_mode && (a = "-c");
    ...
    if (d.length) {
      if (20 < d.length) notify("\u041A\u0443\u043F\u043E\u043D \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u0434\u043B\u0438\u043D\u043D\u044B\u0439");else if (/^[A-z\d_]+$/.test(d)) {
        if (checked_coupon === d) notify("\u042D\u0442\u043E\u0442 \u043A\u0443\u043F\u043E\u043D \u0443\u0436\u0435 \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0435\u0442\u0441\u044F");else if (failed_coupon === d) f();else {
          var g = function g() {
            var h = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !1;
            h ? (b.setAttribute("disabled", ""), c.setAttribute("disabled", ""), c.innerText = "\u041F\u0440\u043E\u0432\u0435\u0440\u044F\u0435\u043C") : (b.removeAttribute("disabled"), c.removeAttribute("disabled"), c.innerText = "\u041F\u0440\u043E\u0432\u0435\u0440\u0438\u0442\u044C");
          };
          g(!0);
          2 !== donatePayMethodSelector() ? check_coupon(function (h) {
            if (h) {
              var k = function k() {
                checked_coupon = d;
            ...
            } else failed_coupon = d, f();
            g();
          }, d) : (notify("\u041A\u0443\u043F\u043E\u043D \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u0435\u043D \u0434\u043B\u044F Zalupa Pay"), g());
        }
  ...
  donate_enable_coupon = function donate_enable_coupon() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
    var b = document.getElementById("coupon-input"),
  ...
  generatePaymentLink = function generatePaymentLink() {
    ...
    var f = document.getElementById("donate_customer" + c).value.trim();
    c = document.getElementById("donate_email" + c).value.trim();
    var e = "";
    f = glob_auth_player_data.NICKNAME;
    try {
    ...
    f.length ? 40 < f.length ? notify("\u0412\u0430\u0448 \u043D\u0438\u043A\u043D\u0435\u0439\u043C \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u0434\u043B\u0438\u043D\u043D\u044B\u0439") : 3 > f.length ? notify("\u0412\u0430\u0448 \u043D\u0438\u043A\u043D\u0435\u0439\u043C \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u043A\u043E\u0440\u043E\u0442\u043A\u0438\u0439") : /^[A-z\d_]+$/.test(f) ? c.length ? validateEmail(c) ? (e || (e = ""), products = coins_sell_mode ? JSON.parse("{\"".concat(current_c_item, "\": ").concat(b, "}")) : get_cookie_cart(), d.setAttribute("disabled", ""), d.innerText = "\u041F\u0440\u043E\u0432\u0435\u0440\u044F\u0435\u043C \u0434\u0430\u043D\u043D\u044B\u0435...", b = get_data_service(current_c_item), create_payment(function (g) {
      g ? (d.removeAttribute("disabled"), d.innerText = "\u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C", g.zalupa_pay ? zalupa_pay_finish_modal() : (payment_url_global = g.url, d.setAttribute("onClick", "payment_action_bt()"))) : (notify("\u041E\u0448\u0438\u0431\u043A\u0430, \u043D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0441\u0444\u043E\u0440\u043C\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0447\u0435\u043A \u0434\u043B\u044F \u043E\u043F\u043B\u0430\u0442\u044B"), donateResetPaymentState(a, repeat = !0));
    }, f, products, b.server_id, c, e)) : notify("\u041E\u0448\u0438\u0431\u043A\u0430, \u0430\u0434\u0440\u0435\u0441 \u043F\u043E\u0447\u0442\u044B \u043D\u0435\u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0439") : notify("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430 \u0432\u0430\u0448 email") : notify("\u041D\u0438\u043A\u043D\u0435\u0439\u043C \u043D\u0435 \u0441\u043E\u043E\u0442\u0432\u0435\u0441\u0442\u0432\u0443\u0435\u0442 \u0444\u043E\u0440\u043C\u0430\u0442\u0443") : notify("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430 \u0432\u0430\u0448 \u043D\u0438\u043A\u043D\u0435\u0439\u043C");
  },
  zalupa_pay_finish_modal = function zalupa_pay_finish_modal() {
    document.getElementById("only-ok-payment").innerHTML = "\n    <div style=\"\n        background: rgb(28 28 28 / 15%);\n        padding: 1.15em;\n        border-radius: 0.72em;\n        backdrop-filter: blur(1.35em);\n        -webkit-backdrop-filter: blur(1.35em);\n    \">\n            <p style=\"\n                font-weight: 800;\n                margin-bottom: 0;\n            \">\u0421\u043F\u0430\u0441\u0438\u0431\u043E \u0447\u0442\u043E \u0432\u043E\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u043B\u0438\u0441\u044C ZalupaPay!</p>                \n    </div>\n    ";
  ...
  enable_modal_result_sc = function enable_modal_result_sc() {
  ...
  payment_action_bt = function payment_action_bt() {
    ...
    enable_modal_result_sc();
    var f = ["donate_sum", "donate_customer_c", "donate_email_c", "coupon-input-c"];
    for (var e = 0; e < f.length; e++) document.getElementById(f[e]).value = "";
    a.innerHTML = "";
    d.innerText = "";
  ...
  donate_check_services_cart = function donate_check_services_cart() {
    var a = Object.keys(get_cookie_cart());
    var b = donate_services_array;
    var c = [];
  ...
  donateCartCall = function donateCartCall() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !0;
    var c = get_cookie_cart(),
      d = Object.keys(c),
      f = document.getElementById("donate-cart-list");
    var e = [document.getElementById("donate_customer"), document.getElementById("donate_email"), document.getElementById("coupon-input")];
    switch_modal_containers("donate_finish");
    modal_open_();
    f.innerHTML = "";
    var g = 0;
    for (var h = 0; h < e.length; h++) e[h].addEventListener("input", function (k) {
      donateResetPaymentState();
    });
    for (e = 0; e < d.length; e++) {
      h = donate_get_service_by_id(d[e]);
    ...
    f.innerHTML += "<li class=\"list-group-item d-flex justify-content-between\">\n                <span>\u0421\u0443\u043C\u043C\u0430</span>\n                <strong>".concat(g, " ").concat(getNoun(g, "\u0440\u0443\u0431\u043B\u044C", "\u0440\u0443\u0431\u043B\u044F", "\u0440\u0443\u0431\u043B\u0435\u0439"), "</strong>\n            </li>");
  ...
  donateCoinsPay = function donateCoinsPay() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
    var b = document.getElementById("payment-button-donate_c");
    var c = document.getElementById("donate_sum");
  ...
  donateModalCall = function donateModalCall(a, b) {
    ...
    var f = document.getElementById("donate_customer_c"),
    ...
    var l;
    var m = [document.getElementById("donate_sum"), document.getElementById("donate_customer_c"), document.getElementById("donate_email_c"), document.getElementById("coupon-input-c")],
    ...
    1 === a || 3 === a ? (k.setAttribute("disabled", ""), e.style.display = "", g.remove("col-sm-6"), g.add("col-12"), b = document.getElementById("donate-sum-title"), 1 === a ? (l = "\n                \u0412\u043E\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0432\u0448\u0438\u0441\u044C \u044D\u0442\u043E\u0439 \u0444\u043E\u0440\u043C\u043E\u0439, \u0432\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u043F\u0440\u043E\u0435\u043A\u0442 \u0444\u0438\u043D\u0430\u043D\u0441\u043E\u0432\u043E.\n                \u0417\u0430 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0443 \u0432\u044B \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u0435 \u0432\u043E\u0437\u043D\u0430\u0433\u0440\u0430\u0436\u0434\u0435\u043D\u0438\u0435 \u2013 \u0437\u0430 \u043A\u0430\u0436\u0434\u044B\u0439 \u0440\u0443\u0431\u043B\u044C \u043F\u043E \u043E\u0434\u043D\u043E\u043C\u0443 \u0438\u0433\u0440\u043E\u0432\u043E\u043C\u0443 \u0442\u043E\u043A\u0435\u043D\u0443.\n            ", r = "\u0422\u043E\u043A\u0435\u043D\u044B", b.innerText = "\u0421\u0443\u043C\u043C\u0430", d.addEventListener("input", function (q) {
      donateCoinsPay();
    })) : 3 === a && (l = "\n                \u0414\u043E\u0431\u0430\u0432\u043B\u044F\u0435\u0442 +1 \u0441\u043B\u043E\u0442 \u0432 \u043A\u043B\u0430\u043D. \u0421\u0438\u0441\u0442\u0435\u043C\u0430 \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u044F\u0435\u0442 \u0432\u0430\u0448 \u043A\u043B\u0430\u043D \u043F\u043E \u043D\u0438\u043A\u043D\u0435\u0439\u043C\u0443, \n                \u043F\u043E\u044D\u0442\u043E\u043C\u0443 \u0431\u0443\u0434\u044C\u0442\u0435 \u0432\u043D\u0438\u043C\u0430\u0442\u0435\u043B\u044C\u043D\u044B \u043F\u0435\u0440\u0435\u0434 \u043E\u043F\u043B\u0430\u0442\u043E\u0439. \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0432 \u043A\u0430\u043A\u043E\u043C \u043A\u043B\u0430\u043D\u0435 \u0432\u044B \u0441\u043E\u0441\u0442\u043E\u0438\u0442\u0435.\n            ", r = "\u0421\u043B\u043E\u0442\u044B", b.innerText = "\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E", f.addEventListener("input", function (q) {
      donateCoinsPay(a);
    }))) : 2 === a && (k.removeAttribute("disabled"), e.style.display = "none", g.remove("col-12"), g.add("col-sm-6"), (desc_get = get_data_service(current_c_item).description) || (desc_get = ""), l = "\n            \u0424\u043E\u0440\u043C\u0430 \u043E\u043F\u043B\u0430\u0442\u044B \u043F\u043E\u0436\u0435\u0440\u0442\u0432\u043E\u0432\u0430\u043D\u0438\u044F \u0434\u043B\u044F \u0438\u0433\u0440\u043E\u0432\u043E\u0433\u043E \u043F\u0440\u043E\u0435\u043A\u0442\u0430 Zalupa.Online\n            <br/>\n            <span class=\"text-primary\">\n                ".concat(desc_get, "\n            </span>\n        "), r = current_c_item_name, f.addEventListener("input", function (q) {
      donateCoinsPay(a);
    }));
    h.innerHTML = l.replaceAll("\n", "");
    for (d = 0; d < m.length; d++) m[d].addEventListener("input", function (q) {
    ...
    (function (q) {
      n.innerText = n.innerText.replace(/\([\s\S]*?\)/).trim();
      n.innerText = "".concat(n.innerText, " (").concat(q, ")");
    })(r);
  },
  linksSet = function linksSet(a) {
    var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !1;
    a = document.getElementById(a);
    var c = "margin-left: 0 !important";
    for (var d = 0; d < links_lt.length; d++) {
      if (!b || d) c = "";
      a.innerHTML += "<a href=\"".concat(links_lt[d].link, "\" \n                target=\"_blank\" style=\"").concat(c, "\"\n                class=\"btn btn-icon btn-secondary btn-").concat(links_lt[d].name, " mx-2\">\n                    <i class=\"bx bxl-").concat(links_lt[d].name, "\"></i>\n            </a>");
    }
  },
  ...
  observerSystemTheme = function observerSystemTheme() {
    ...
    var _loop3 = function _loop3(c) {
      window.matchMedia("(prefers-color-scheme: ".concat(a[c], ")")).addEventListener("change", function (d) {
  ...
  callSucessPayModal = function callSucessPayModal() {
    var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    var b;
    var c = document.getElementById("donate-cart-list-success"),
      d = document.getElementById("success-pay-text-js"),
      f = document.getElementById("only-ok-payment"),
    ...
    checkPayment(function (g) {
      if ("undefined" !== typeof g.status) {
        if (g.status && a == parseInt(g.id)) {
          ...
          var l = g.product.name.toLowerCase().includes("\u0442\u043E\u043A\u0435\u043D") ? 1 : 2;
          ...
          if (!g.enrolled || 1 > g.enrolled) m = "";
          if (!g.email.length || g.email.match("undefined")) g.email = "\u041D\u0443 \u0443\u043A\u0430\u0437\u0430\u043D\u043E";
          if (!g.payment_system || g.payment_system.match("undefined")) k = "";
  ...
  adaptiveDisplayLand = function adaptiveDisplayLand() {
    var a = function a() {
      var b = document.querySelector("header").offsetHeight,
        ...
        f = document.querySelector("div.vova-bg-landing-mask");
      ...
      f.style.height = "".concat(first_init_head_adapt_vova - b, "px");
  ...
  openAdminContact = function openAdminContact() {
    checkTelegramAuthData(function (a) {
      if (a || feedback_tg_auth_skip) {
        ...
        b.maxLength = 3E3;
        var d = function d() {
          c.innerText = "".concat(b.value.length, "/", 3E3);
        };
        d();
        addEventListener("keydown", function (f) {
          return d();
        });
        addEventListener("keyup", function (f) {
          return d();
        });
  ...
  openTelegramAuthModal = function openTelegramAuthModal() {
    ...
    checkTelegramAuthData(function (b) {
      if (!b) {
        ...
        b.setAttribute("data-telegram-login", telegram_bot_username);
        ...
        var c = document.getElementById("info-content-modal"),
        ...
        f.setAttribute("class", "text-start px-3 pt-1 pt-lg-2");
  ...
  tonyComeBack = function tonyComeBack() {
    var a = document.getElementById("AppleTony_comeback_days"),
      b = function b(f) {
        a.innerText = "".concat(f, " ").concat(getNoun(f, "\u0434\u0435\u043D\u044C", "\u0434\u043D\u044F", "\u0434\u043D\u0435\u0439"));
      };
    var c = new Date();
