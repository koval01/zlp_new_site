...
var get_game_server_data = function get_game_server_data(callback) {
  ...
  console.debug("crypto_token.length: ".concat(crypto_token.length));
  if (crypto_token) {
    requestCall(function (r) {
      setTimeout(function () {
...
var ytVideoSetter = function ytVideoSetter() {
  ...
  var only_iframe = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var local_load = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  ...
  var get_link = function get_link(el, video_id, url, params) {
    el.innerHTML = "\n            <video class=\"video-container\" preload=\"none\" id=\"ytframe_".concat(video_id, "\" \n                    poster=\"/assets/images/videos/").concat(video_id, ".webp\" \n                  ").concat(params.autoplay != null ? 'autoplay=""' : "", " ").concat(params.muted != null ? 'muted=""' : "", " ").concat(params.loop != null ? 'loop=""' : "", " ").concat(params.controls != null ? 'controls=""' : "", " style=\"object-fit: contain\">\n                <source src=\"").concat(url, "\" type=\"video/mp4\">\n            </video>\n        ");
  };
  var set_video = function set_video(el, video_id, params) {
    if (local_load) {
      get_link(el, video_id, "//files.zalupa.online/videos/".concat(video_id, ".mp4"), params);
    } else {
      if (only_iframe) {
...
var check_modal_ = function check_modal_() {
  var close_r = function close_r() {
    if (!modal_displayed) {
      modal_close_();
    }
  };
