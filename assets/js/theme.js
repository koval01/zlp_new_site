    ...
    ((a = c.classList),
        ...
        a.contains("position-absolute")
            ? window.addEventListener("scroll", function (a) {
                500 < a.currentTarget.pageYOffset
                    ? c.classList.add("navbar-stuck")
                    : c.classList.remove("navbar-stuck");
            })
            : window.addEventListener("scroll", function (a) {
                500 < a.currentTarget.pageYOffset
                    ? ((document.body.style.paddingTop = d + "px"),
                        c.classList.add("navbar-stuck"))
