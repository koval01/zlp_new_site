!function () {
    ...
    null !== (a = document.querySelector('[data-bs-toggle="mode"]')) && (b = a.querySelector(".form-check-input"), "dark" === mode ? (root.classList.add("dark-mode"), b.checked = !0) : (root.classList.remove("dark-mode"), b.checked = !1), a.addEventListener("click", function (a) {
        ...
        speed: 800, speedAsDuration: !0, offset: function (b, a) {
        ...
        for (var b = document.querySelectorAll(".password-toggle"), a = 0; a < b.length; a++) !function (a) {
            var c = b[a].querySelector(".form-control");
            b[a].querySelector(".password-toggle-btn").addEventListener("click", function (a) {
        ...
        (c = null != b.dataset.swiperOptions ? JSON.parse(b.dataset.swiperOptions) : c).pager && (a = {
            pagination: {
        ...
        var c, a = _objectSpread(_objectSpread({}, c), a), a = new Swiper(b, a);
        c.tabs && a.on("activeIndexChange", function (a) {
        ...
        if (!(a.length <= 0)) for (var b = 0; b < a.length; b++) a[b].querySelector('[data-bs-toggle="price"]').addEventListener("change", function (d) {
            for (var e = d.currentTarget.querySelector('input[type="checkbox"]'), a = d.currentTarget.closest(".price-switch-wrapper").querySelectorAll("[data-monthly-price]"), f = d.currentTarget.closest(".price-switch-wrapper").querySelectorAll("[data-annual-price]"), b = 0; b < a.length; b++) 1 == e.checked ? a[b].classList.add("d-none") : a[b].classList.remove("d-none");
            for (var c = 0; c < a.length; c++) 1 == e.checked ? f[c].classList.remove("d-none") : f[c].classList.add("d-none")
        })
    }(), function () {
        var d, b = document.querySelectorAll(".masonry-grid");
        if (null !== b) for (var a = 0; a < b.length; a++) {
            var c = function (a) {
                d = new Shuffle(b[a], {
                ...
                for (var f = e.querySelectorAll(".masonry-filters [data-group]"), c = 0; c < f.length; c++) f[c].addEventListener("click", function (b) {
                    var a = e.querySelector(".masonry-filters .active"), c = this.dataset.group;
