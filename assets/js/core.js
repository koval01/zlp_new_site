        ...
        for (let i = 0; i < posts
            ...
            let font_size = ((
                text_len - -
                    8) * 0.4) / 100;
            selector_text.style
                .fontSize = `calc(${parseFloat(
                1.8 - font_size
            )}vw + ${parseFloat(1.8 - font_size)}vh + ${parseFloat(
                1.6 - font_size
            )}vmin)`;
                    ...
                    array_
                        ...
                        <div class="swiper-slide h-auto px-2">
                            ...
                            comment[i].name
                                        ...
                                        ${
                            player
                                ? `<span class="frame_badge_adaptive">${player.desc}</span>`
                                : ""
                        }
                                    </div>
                                </figcaption>
                    ...
                    <div class="swiper-slide text-center">
                        <span class="d-block py-3">
                            ...
                            player[i].badges.includes("verified")
                                ...
                                <div class="player_badge_container" style="${
                            !player_badges_.length ? "display:none" : ""
                        }">
                                    ${player_badges_}
                                </div>
...
function donate_element_click(
    ...
    let text_template = `Товар <span class="text-primary fw-semibold">${
        product_data.name
    }</span>,
...
function donateResetPaymentState(type =
    ...
    button.setAttribute("onClick",
        `generatePaymentLink(sum=${vl}, type=${type})`
    );
...
function donateCartCall(coupon = null,
    ...
    let selectors_payment = [
        document.getElementById(
            "donate_customer"), document.getElementById(
            "donate_email"), document.getElementById(
            "coupon-input"),
    ];
    switch_modal_containers(
        "donate_finish");
...
function donateCoinsPay(type = 1) {
    ...
    button.setAttribute("onClick",
        `generatePaymentLink(sum=${sum}, type=${type})`
    );
}
...
function donateModalCall(type_item,
    ...
    let selectors_payment = [
        document.getElementById(
            "donate_sum"), document.getElementById(
            "donate_customer_c"), document.getElementById(
            "donate_email_c"), document.getElementById(
            "coupon-input-c"),
    ];
    let title = document.querySelector(
        ".modal-title");
