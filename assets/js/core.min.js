...
function initHost(){let a=Object.keys(site_domains);for(let b=0;b<a.length;b++)site_domains[a[b]]===window.location.hostname&&(work_domain_v=site_domains[a[b]])}function linkHash(){return window.location.hash.substring(1)}function utf8_to_b64(a){return window.btoa(unescape(encodeURIComponent(a)))}function b64_to_utf8(a){return decodeURIComponent(escape(window.atob(a)))}function getAvatarColorIDforTG(a){for(var b=0,c=1;0<a;)b+=a%7*c,c*=10,a=Math.floor(a/7);return parseInt(b.toString().slice(-1))}
...
function getImageLightness(a,b){let c=document.createElement("img");c.src=a;c.crossOrigin="Anonymous";c.style.display="none";document.body.appendChild(c);let d=0;c.onload=function(){var f=document.createElement("canvas");f.width=this.width;f.height=this.height;var e=f.getContext("2d");e.drawImage(this,0,0);f=e.getImageData(0,0,f.width,f.height).data;let g,k;for(let h=0,l=f.length;h<l;h+=4)e=f[h],g=f[h+1],k=f[h+2],e=Math.floor((e+g+k)/3),d+=e;b(Math.floor(d/(this.width*this.height)));c.remove()}}
...
function appendPostsNews(){let a=function(b){var c=document.getElementById("news_swipe_array");b=b.reverse();for(let e=0;e<b.length;e++){var d=b[e].text,f=new Date(b[e].datetime_utc);b[e].cover||(b[e].cover="assets/images/spawn.webp");c.innerHTML+=`
            ...
            `;document.getElementById(`background-news-${e}`).style.backgroundImage=`url(${b[e].cover})`;d=document.getElementById(`news_text_${e}`);d.style.width="100%";d.classList.add("text-light");f=d.innerText.length;d.innerText.split(" ");f=.4*(f- -8)/100;let g=(h,l,n=.32,m=.26,p=.9)=>{h=h<n?l/m*n:h;return p?h<p?h:p:h};d.style.fontSize=`calc(${g(parseFloat(1.8-f),f)}vw + ${g(parseFloat(1.8-f),f)}vh + ${g(parseFloat(1.9-f),f)}vmin)`;d.style.padding=`${g(parseFloat(1.3-f),f,.22,1.05)}rem`;let k=
()=>{let h=document.getElementById(`news_text_${e}`),l=parseFloat(window.getComputedStyle(h,null).getPropertyValue("font-size").replace("px",""));h.style.maxHeight="25vh";16<l?(h.style.position="absolute",h.style.textAlign="center",h.style.alignItems="center",h.style.height="",h.style.display="inline-block",h.style.paddingBottom="5rem",h.style.paddingRight="3rem"):(h.style.position="",h.style.textAlign="",h.style.alignItems="",h.style.height="",h.style.display="",h.style.paddingBottom="",h.style.paddingRight=
"")};addEventListener("resize",h=>k());setInterval(k,100);getImageLightness(b[e].cover,function(h){h=`#000000${((parseFloat(h)/255*100).toFixed()+64).toString(16).slice(0,2)}`;document.getElementById(`news-overlay-${e}`).style.background=h})}c=function(){setTimeout(function(){let e=document.getElementById("telegram_block_load"),g=document.getElementById("news_zlp_buttons");try{e.parentNode.removeChild(e),g.style.display=""}catch(k){}},150)};b&&(new Swiper("#news_swipe_container",{spaceBetween:12,
loop:!0,observer:!0,observeParents:!0,preventClicks:!1,preventClicksPropagation:!1,autoplay:{delay:1E4},pagination:{el:"#news_swiper_pagination",clickable:!0},navigation:{prevEl:"#prev_news",nextEl:"#next_news"}}),c())};get_news_(function(b){a(b)},1)}
...
function initEventsList(){let a=document.getElementById("events-row-container");document.getElementById("events_block_load");let b=document.getElementById("events-c-button"),c=["row-cols-md-2","row-cols-lg-2","row-cols-xl-3"];get_events_(function(d){if(d&&d.length){events_block_load.remove();d.sort(function(g,k){g=new Date(g.date_start);k=new Date(k.date_start);return g<k?-1:g>k?1:0});let e=function(g){let k=6E4*-g.getTimezoneOffset();return new Date(g.getTime()-k)};for(let g=0;g<d.length;g++){b.removeAttribute("disabled");
3>g>0&&a.classList.add(c[g]);var f=e(new Date(d[g].date_start));let k=e(new Date(d[g].date_end)),h=new Date((new Date).toLocaleString("en-US",{timeZone:"Europe/Moscow"})),l="";f>h?l="\u0421\u043a\u043e\u0440\u043e":h>k&&(l="\u0417\u0430\u0432\u0435\u0440\u0448\u0435\u043d\u043e");f=`
                    <div class="col">
                ...
                `;a.innerHTML+=f}}})}function get_donate_services(a){re_check(function(b){requestCall(function(c){a(c.services)},`${backend_host}/donate/services`,"POST",!0,{token:b})})}function create_payment(a,b,c,d,f="",e=""){re_check(function(g){requestCall(function(k){a(k.payment)},`${backend_host}/donate/payment/create`,"POST",!0,{customer:b,products:c,email:f,coupon:e,token:g,server_id:d,success_url:`https://${work_domain_v}`})})}
...
count:a[e].number,description:a[e].description,type:a[e].type,service_id:a[e].id,server_id:a[e].server_id};products_by_serverid.push(a[e]);let k="",h="p-3",l=`
                    <p class="mb-0">
                        ${a[e].price} 
                ...
                `;var f="";e&&b.length>=e&&c.classList.add(b[e-1]);let n=`onClick="donate_element_click(${JSON.stringify(g)})"`;coins_sell_mode?(f="",a[e].name.toLowerCase().includes("\u0442\u043e\u043a\u0435\u043d")?(k=`${a[e].price} ${getNoun(a[e].price,"\u0440\u0443\u0431\u043b\u044c","\u0440\u0443\u0431\u043b\u044f","\u0440\u0443\u0431\u043b\u0435\u0439")} = ${a[e].number} ${getNoun(a[e].number,"\u0442\u043e\u043a\u0435\u043d","\u0442\u043e\u043a\u0435\u043d\u0430","\u0442\u043e\u043a\u0435\u043d\u043e\u0432")}`,
h="p-0",l='\n                        <p class="mb-0 token-description-dnt">\n                            \u0418\u0433\u0440\u043e\u0432\u0430\u044f \u0432\u0430\u043b\u044e\u0442\u0430, \u043a\u043e\u0442\u043e\u0440\u0443\u044e \u043c\u043e\u0436\u043d\u043e \u043f\u043e\u043b\u0443\u0447\u0438\u0442\u044c \u043a\u0430\u043a \u0432 \u0438\u0433\u0440\u0435, \u0442\u0430\u043a \u0438 \u0437\u0430 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0443 \u043f\u0440\u043e\u0435\u043a\u0442\u0430.\n                        </p>',
f="\u041f\u0440\u0438\u043e\u0431\u0440\u0435\u0441\u0442\u0438 \u0442\u043e\u043a\u0435\u043d\u044b",n=""):a[e].name.toLowerCase().includes("\u043f\u0440\u043e\u0445\u043e\u0434\u043a\u0430")&&(k=`
                        <span class="text-primary">${a[e].name}</span>,
                        ${a[e].price} ${getNoun(a[e].price,"\u0440\u0443\u0431\u043b\u044c","\u0440\u0443\u0431\u043b\u044f","\u0440\u0443\u0431\u043b\u0435\u0439")}`,h="p-0",l='\n                        <p class="mb-0 token-description-dnt">\n                            \u0417\u0430 \u0444\u0438\u043d\u0430\u043d\u0441\u043e\u0432\u0443\u044e \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0443 \u043f\u0440\u043e\u0435\u043a\u0442\u0430 \u0442\u044b \u043f\u043e\u043b\u0443\u0447\u0438\u0448\u044c \u043f\u0440\u043e\u043f\u0443\u0441\u043a \u043d\u0430 \u043f\u0440\u0438\u0432\u0430\u0442\u043d\u044b\u0439 \u0441\u0435\u0440\u0432\u0435\u0440.\n                        </p>',
...
function switch_modal_containers(a="service",b={}){let c=document.getElementsByClassName("close_b")[0];var d=document.getElementById("modal-info-container-c"),f=document.getElementById("modal-donate-container-c"),e=document.getElementById("modal-donate-finish-container-b");let g=document.getElementById("modal-donate-success-container"),k=document.getElementById("modal-donate-finish-container-c"),h=document.querySelector(".modal-title");d=[{name:"service",selector:f,title:"\u0422\u043e\u0432\u0430\u0440"},
{name:"service_coins",selector:e,title:"\u041e\u043f\u043b\u0430\u0442\u0430 \u043f\u043e\u0436\u0435\u0440\u0442\u0432\u043e\u0432\u0430\u043d\u0438\u044f"},{name:"info",selector:d,title:"\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435"},{name:"success",selector:g,title:"\u0427\u0435\u043a"},{name:"donate_finish",selector:k,title:"\u041a\u043e\u0440\u0437\u0438\u043d\u0430"}];for(f=0;f<d.length;f++)e="none",a===d[f].name&&(e="block",h.innerText=d[f].title),d[f].selector.style.display=e;"info"===
...
function buildPlayersSwiper(){let a=document.getElementById("players-swiper-array");(function(b){requestCall(function(c){b(c)},"assets/data/badges.json","GET",!0)})(function(b){requestCall(function(c){shuffle(c);for(let d=0;d<c.length;d++){glob_players.push(c[d].name);let f=function(){let g="";c[d].badges.sort();for(let k=0;k<c[d].badges.length;k++){let h=c[d].badges[k];h&&h.length&&"verified"!==h&&!h.includes("clan-")&&(g+=`
    ...
    `,f=document.getElementById("items_count_donate"),e=document.getElementById("donate_count_text_hint"),g=document.getElementById("donate_button_add_to_cart"),k=get_cookie_cart(),h=function(){g.setAttribute("onClick",`donate_cart(${a.service_id}, ${f.value})`)};f.value=1;h();var l=k.hasOwnProperty(a.service_id.toString());if((b.includes(a.type)||"group"===a.type)&&groupAlreadyInCart(k)){switch_modal_containers("info");let m="";m="group"===a.type?"\u0412\u044b \u0443\u0436\u0435 \u0432\u044b\u0431\u0440\u0430\u043b\u0438 \u043f\u0440\u0438\u0432\u0438\u043b\u0435\u0433\u0438\u044e. \u0423\u0434\u0430\u043b\u0438\u0442\u0435 \u0435\u0451 \u0438\u0437 \u043a\u043e\u0440\u0437\u0438\u043d\u044b, \u0435\u0441\u043b\u0438 \u0445\u043e\u0442\u0438\u0442\u0435 \u0432\u044b\u0431\u0440\u0430\u0442\u044c \u0434\u0440\u0443\u0433\u0443\u044e.":
...
"block";b.includes(a.type)&&(l="none");f.style.display=l;e.style.display=l;let n=function(){f.value=f.value.replace(/\D+/g,"");if(!b.includes(a.type)){let m=parseInt(f.value)*a.price,p=k[a.service_id],q="";if(isNaN(m)||1>Math.sign(m))m=0;p&&(q=`
                    \u0423\u0436\u0435 \u0432 \u043a\u043e\u0440\u0437\u0438\u043d\u0435 - 
                        <span class="text-primary fw-semibold">
                            ${p}
                        </span>
                `);c.innerHTML=`${d}
                    ...
                    <br/>
                    ${q}
                `;h()}};c.innerHTML=d;n();f.addEventListener("input",function(m){n()});modal_open_()}function donate_get_service_by_id(a){for(let b=0;b<donate_services_array.length;b++)if(donate_services_array[b].id===parseInt(a))return donate_services_array[b];return null}
...
function couponCheck(a){a="";coins_sell_mode&&(a="-c");let b=document.getElementById("coupon-input"+a),c=document.getElementById("coupon-button"+a),d="";try{d=b.value.trim().toUpperCase()}catch(k){}let f=function(){notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${failed_coupon}</span> \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d`)},e=function(k,h){if(k)for(h=0;h<k.length;h++)if(k[h].id===current_c_item)return!0;return!1};if(d.length)if(20<d.length)notify("\u041a\u0443\u043f\u043e\u043d \u0441\u043b\u0438\u0448\u043a\u043e\u043c \u0434\u043b\u0438\u043d\u043d\u044b\u0439");
else if(/^[A-z\d_]+$/.test(d))if(checked_coupon===d)notify("\u042d\u0442\u043e\u0442 \u043a\u0443\u043f\u043e\u043d \u0443\u0436\u0435 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u0443\u0435\u0442\u0441\u044f");else if(failed_coupon===d)f();else{var g=function(k=!1){k?(b.setAttribute("disabled",""),c.setAttribute("disabled",""),c.innerText="\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c"):(b.removeAttribute("disabled"),c.removeAttribute("disabled"),c.innerText="\u041f\u0440\u043e\u0432\u0435\u0440\u0438\u0442\u044c")};
g(!0);check_coupon(function(k){if(k){let h=function(){checked_coupon=d;notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${d}</span> \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439`)};coins_sell_mode?e(k.products,current_c_item)?(h(),document.getElementById("donate-coins-payment").innerHTML=`<li class="list-group-item d-flex justify-content-between bg-light">
                        ...
                        <span class="text-muted text-end" style="width: 30%">
                            ${k.discount}%</span>
                    </li>`):notify("\u042d\u0442\u043e\u0442 \u043a\u0443\u043f\u043e\u043d \u043d\u0435\u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439"):(h(),donateCartCall(d,!1))}else failed_coupon=d,f();g()},d)}else notify("\u041a\u0443\u043f\u043e\u043d \u0443\u043a\u0430\u0437\u0430\u043d \u043d\u0435\u0432\u0435\u0440\u043d\u043e");else notify("\u0412\u044b \u043d\u0435 \u0443\u043a\u0430\u0437\u0430\u043b\u0438 \u043a\u0443\u043f\u043e\u043d")}
...
JSON.parse(`{"${donate_services_array[a-1].id}": ${b}}`):get_cookie_cart();d.setAttribute("disabled","");d.innerText="\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c \u0434\u0430\u043d\u043d\u044b\u0435...";b=(g=>{for(let k=0;k<products_by_serverid.length;k++)if(parseInt(products_by_serverid[k].id)===parseInt(g))return products_by_serverid[k]})(current_c_item);create_payment(function(g){g?(d.removeAttribute("disabled"),d.innerText="\u041e\u043f\u043b\u0430\u0442\u0438\u0442\u044c",payment_url_global=
...
f.style.display="";var k=g.product.name.toLowerCase();var h=k.includes("\u0442\u043e\u043a\u0435\u043d")?1:k.includes("\u043f\u0440\u043e\u0445\u043e\u0434\u043a\u0430")?2:void 0;k=`
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        <h6 class="my-0 text-start">
                            \u0421\u0438\u0441\u0442\u0435\u043c\u0430
            ...
            `;coins_sell_mode&&(1===h?l=`
                    ...
                    `));if(!g.enrolled||1>g.enrolled)l="";if(!g.email.length||g.email.match("undefined"))g.email="\u041d\u0443 \u0443\u043a\u0430\u0437\u0430\u043d\u043e";if(!g.payment_system||g.payment_system.match("undefined"))k="";g.created_at&&g.created_at.length?(h=new Date(g.created_at),g.created_at=`${h.toLocaleDateString()} ${h.toLocaleTimeString()}`):g.created_at="\u041d\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043d\u043e";c.innerHTML=`
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        <h6 class="my-0 text-start">
                            \u041d\u0438\u043a\u043d\u0435\u0439\u043c
...
function initSmoothScrollObserver(){let a=new SmoothScroll("section"),b=()=>{let c=linkHash().toLowerCase();c&&c.length&&!["private_rules"].includes(c)&&a.animateScroll(document.querySelector(`section[id="${c}"]`),null,{offset:50})};b();window.onhashchange=b}function autoAuthTelegramObserver(){checkTelegramAuthData(function(a){console.log(`Telegram auth check status : ${a}`);a&&document.querySelector(".avatar-container").removeAttribute("onclick")})}
const initCore=function(){initHost();initCrypto();initLanding();observerSystemTheme();buildPlayersSwiper();appendPostsNews();initComments();appendServices();updateCartCount();gameServerUpdater();initDonate();initEventsList();initJarallax();finishLoad();successPay();ytVideoSetter(skip=!0);donateContainerHash();rulesPrivateContainerHash();adminsContactContainerHash();autoAuthTelegramObserver();let a=document.getElementById("dark-perm-set-bv");a.parentNode.removeChild(a);window.onload=function(){if(!debug_lock_init){let b=
