...
function check_coupon(a,b){re_check(function(c){requestCall(function(d){d.coupon&&d.success&&a(d.coupon)},`${backend_host}/donate/coupon`,"POST",!0,{code:b,token:c})})}function checkPayment(a,b){re_check(function(c){requestCall(function(d){a(d.payment)},`${backend_host}/donate/payment_get`,"POST",!0,{payment_id:parseInt(b),token:c,tokens_send:coins_sell_mode})})}
...
g(!0);check_coupon(function(h){console.log("call");if(h){let k=function(){checked_coupon=d;notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${d}</span> \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439`)};coins_sell_mode?e(h.products)?(k(),document.getElementById("donate-coins-payment").innerHTML=`<li class="list-group-item d-flex justify-content-between bg-light">
