...
function create_payment(a,b,d,c=null,e=null){grecaptcha.ready(function(){grecaptcha.execute(re_token,{action:"submit"}).then(function(f){request_call(function(g){g.success?a(g.payment):a(null)},`${backend_host}/donate/payment/create`,"POST",!0,{customer:b,products:d,email:c,coupon:e,token:f})})})}
...
function donate_cart(a,b,d=!1){var c=Cookies.get(cart_cookie),e=get_cookie_cart();let f=0;try{f=+e[a]}catch(g){}Number.isInteger(a)&&Number.isInteger(b)?1>Math.sign(b)?notify("\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u0440\u0430\u0432\u043d\u043e \u043d\u0443\u043b\u044e \u0438\u043b\u0438 \u043c\u0435\u043d\u044c\u0448\u0435"):1E5<f+b?notify("\u041c\u0430\u043a\u0441\u0438\u043c\u0430\u043b\u044c\u043d\u043e\u0435 \u043a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e - 100 \u0442\u044b\u0441\u044f\u0447"):
(c||Cookies.set(cart_cookie,JSON.stringify({})),c=JSON.parse(Cookies.get(cart_cookie)),e=donate_get_service_by_id(a),d?(delete c[a],notify(`\u0422\u043e\u0432\u0430\u0440 ${'<span style="color: #a4a6ff !important">'} ${e.name}</span> \u0443\u0431\u0440\u0430\u043d \u0438\u0437 \u043a\u043e\u0440\u0437\u0438\u043d\u044b`)):c[a]?(c[a]+=b,notify(`\u0412 \u043a\u043e\u0440\u0437\u0438\u043d\u0443 \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u043e ${'<span style="color: #a4a6ff !important">'} ${b} </span>`+
`${getNoun(b,"\u0435\u0434\u0438\u043d\u0438\u0446\u0430","\u0435\u0434\u0438\u043d\u0438\u0446\u044b","\u0435\u0434\u0438\u043d\u0438\u0446")}`+`\u0442\u043e\u0432\u0430\u0440\u0430 ${'<span style="color: #a4a6ff !important">'} ${e.name} </span>`)):(c[a]=b,notify(`\u0422\u043e\u0432\u0430\u0440 ${'<span style="color: #a4a6ff !important">'} ${e.name}</span> \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d \u0432 \u043a\u043e\u0440\u0437\u0438\u043d\u0443`)),Cookies.set(cart_cookie,JSON.stringify(c)),
modal_close_(),donate_init(),update_cart_count(),donate_reset_payment_state()):console.log("Error data donate_cart")}function donate_cart_button(a={}){const b=document.querySelectorAll(".donate-cart-button-cn");for(let d=0;d<b.length;d++){let c=b[d].style;countProperties(a)?(c.display="flex",setTimeout(function(){c.opacity=1;c.marginTop="15px";b[d].removeAttribute("disabled")},50)):(b[d].setAttribute("disabled",""),c.opacity=0,c.marginTop="-50px",setTimeout(function(){c.display="none"},350))}}
