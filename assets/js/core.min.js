const cart_cookie="cart_box",channels=2,backend_host="https://backend.zalupa.world",development_hosts=["localhost","zalupa.world"],links_lt=[{name:"twitch",link:"https://www.twitch.tv/bratishkinoff"},{name:"youtube",link:"https://www.youtube.com/channel/UCg2uAOEoY-la2d-95uMmLuQ"},{name:"telegram",link:"https://t.me/zalupaonline"},{name:"discord",link:"https://discord.gg/qEqbVbMeEx"}];var donate_services_array=[],notify_hidden=!0,glob_players=[],timer_notify,payment_url_global;
function shuffle(a){let b=a.length,d;for(;0!==b;)d=Math.floor(Math.random()*b),b--,[a[b],a[d]]=[a[d],a[b]];return a}function validateEmail(a){return String(a).toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)}
function request_call(a,b,d,c=!1,e=null){let f=new XMLHttpRequest,g={};f.open(d,b,!0);"POST"===d.toUpperCase()&&(f.setRequestHeader("Content-Type","application/json;charset=UTF-8"),g=JSON.stringify(e));f.onload=function(){200<=f.status&&400>f.status?c?a(JSON.parse(f.responseText)):a(f.responseText):console.log(`Request status code is ${f.status}`)};f.onerror=function(h){console.log(`Error make request! Details: ${h}`)};f.send(g)}
...
function game_server_updater(){monitoring_game_server_update();setInterval(monitoring_game_server_update,5E3)}function get_donate_services(a){request_call(function(b){b.success&&a(b.services)},`${backend_host}/donate/services`,"GET",!0)}function create_payment(a,b,d,c=null,e=null){request_call(function(f){f.success?a(f.payment):a(null)},`${backend_host}/donate/payment/create`,"POST",!0,{customer:b,products:d,email:c,coupon:e})}
...
title:"\u041a\u043e\u0440\u0437\u0438\u043d\u0430"}];for(c=0;c<d.length;c++)e="none",a===d[c].name&&(e="block",f.innerText=d[c].title),d[c].selector.style.display=e;b.onclick=function(){modal_close_()}}function get_cookie_cart(){let a={};try{a=JSON.parse(Cookies.get(cart_cookie))}catch(b){}return a}function update_cart_count(){document.getElementById("count_cart_items_dn").innerText=countProperties(get_cookie_cart())}
function group_already_in_cart(a){a=Object.keys(a);for(let b=0;b<donate_services_array.length;b++)if("group"===donate_services_array[b].type&&a.includes(donate_services_array[b].id.toString()))return!0;return!1}function comments_init(){new Swiper("#comment_swipe_container",{spaceBetween:12,loop:!0,observer:!0,observeParents:!0,pagination:{el:".swiper-pagination-comments",clickable:!0},navigation:{prevEl:"#prev_comment",nextEl:"#next_comment"}})}
function build_players_swiper(){let a=document.getElementById("players-swiper-array");request_call(function(b){shuffle(b);for(let d=0;d<b.length;d++)glob_players.push(b[d].name),a.innerHTML+=`
...
"\u0440\u0443\u0431\u043b\u044f","\u0440\u0443\u0431\u043b\u0435\u0439")}</span>.`,e=document.getElementById("items_count_donate"),f=document.getElementById("donate_count_text_hint"),g=document.getElementById("donate_button_add_to_cart");var h=get_cookie_cart();let m=function(){g.setAttribute("onClick",`donate_cart(${a.service_id}, ${e.value})`)};e.value=1;m();var l=h.hasOwnProperty(a.service_id.toString());(b.includes(a.type)||"group"===a.type)&&group_already_in_cart(h)&&(switch_modal_containers("info"),
h="",h="group"===a.type?"\u0412\u044b \u0443\u0436\u0435 \u0432\u044b\u0431\u0440\u0430\u043b\u0438 \u043f\u0440\u0438\u0432\u0438\u043b\u0435\u0433\u0438\u044e. \u0423\u0434\u0430\u043b\u0438\u0442\u0435 \u0435\u0451 \u0438\u0437 \u043a\u043e\u0440\u0437\u0438\u043d\u044b, \u0435\u0441\u043b\u0438 \u0445\u043e\u0442\u0438\u0442\u0435 \u0432\u044b\u0431\u0440\u0430\u0442\u044c \u0434\u0440\u0443\u0433\u0443\u044e.":l?"\u041e\u0448\u0438\u0431\u043a\u0430, \u0432\u044b \u043c\u043e\u0436\u0435\u0442\u0435 \u0434\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u0442\u043e\u0432\u0430\u0440 "+
...
h);l="block";b.includes(a.type)&&(l="none");e.style.display=l;f.style.display=l;const n=function(){e.value=e.value.replace(/\D+/g,"");if(!b.includes(a.type)){let k=parseInt(e.value)*a.price;if(isNaN(k)||1>Math.sign(k))k=0;d.innerHTML=`${c}<br/>\u0421\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c - `+`<span class="text-primary fw-semibold">${k} `+`${getNoun(k,"\u0440\u0443\u0431\u043b\u044c","\u0440\u0443\u0431\u043b\u044f","\u0440\u0443\u0431\u043b\u0435\u0439")}</span>`;m()}};d.innerHTML=c;n();
e.addEventListener("input",function(k){n()});modal_open_()}function donate_get_service_by_id(a){for(let b=0;b<donate_services_array.length;b++)if(donate_services_array[b].id===parseInt(a))return donate_services_array[b];return null}
...
function donate_cart(a,b,d=!1){if(Number.isInteger(a)&&Number.isInteger(b))if(1>Math.sign(b))notify("\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u0440\u0430\u0432\u043d\u043e \u043d\u0443\u043b\u044e \u0438\u043b\u0438 \u043c\u0435\u043d\u044c\u0448\u0435");else{Cookies.get(cart_cookie)||Cookies.set(cart_cookie,JSON.stringify({}));var c=JSON.parse(Cookies.get(cart_cookie)),e=donate_get_service_by_id(a);d?(delete c[a],
notify(`\u0422\u043e\u0432\u0430\u0440 ${'<span style="color: #a4a6ff !important">'} ${e.name}</span> \u0443\u0431\u0440\u0430\u043d \u0438\u0437 \u043a\u043e\u0440\u0437\u0438\u043d\u044b`)):c[a]?(c[a]+=b,notify(`\u0412 \u043a\u043e\u0440\u0437\u0438\u043d\u0443 \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u043e ${'<span style="color: #a4a6ff !important">'} ${b} </span>`+`${getNoun(b,"\u0435\u0434\u0438\u043d\u0438\u0446\u0430","\u0435\u0434\u0438\u043d\u0438\u0446\u044b","\u0435\u0434\u0438\u043d\u0438\u0446")}`+
`\u0442\u043e\u0432\u0430\u0440\u0430 ${'<span style="color: #a4a6ff !important">'} ${e.name} </span>`)):(c[a]=b,notify(`\u0422\u043e\u0432\u0430\u0440 ${'<span style="color: #a4a6ff !important">'} ${e.name}</span> \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d \u0432 \u043a\u043e\u0440\u0437\u0438\u043d\u0443`));Cookies.set(cart_cookie,JSON.stringify(c));modal_close_();donate_init();update_cart_count();donate_reset_payment_state()}else console.log("Error data donate_cart")}
function donate_cart_button(a={}){const b=document.querySelectorAll(".donate-cart-button-cn");for(let d=0;d<b.length;d++){let c=b[d].style;countProperties(a)?(c.opacity=1,c.marginTop="15px"):(c.opacity=0,c.marginTop="-50px")}}function donate_flush_cart(){Cookies.remove(cart_cookie);donate_cart_button({});notify("\u041a\u043e\u0440\u0437\u0438\u043d\u0430 \u043e\u0447\u0438\u0449\u0435\u043d\u0430")}
...
function links_set_(){let a=document.getElementById("links-block-footer-v");for(let b=0;b<links_lt.length;b++)a.innerHTML=a.innerHTML+`<a href="${links_lt[b].link}" target="_blank" `+`class="btn btn-icon btn-secondary btn-${links_lt[b].name} mx-2">`+`<i class="bx bxl-${links_lt[b].name}"></i></a>`}
...
links_set_();discord_init()}function finish_load(){document.querySelector("main").setAttribute("style","");document.querySelector("footer").setAttribute("style","");document.getElementById("footer-text-blc").innerHTML="Made with &#10084;&#65039; by KovalYRS for Zalupa.Online"}
