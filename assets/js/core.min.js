...
function get_game_server_data(a){crypto_token?requestCall(function(b){setTimeout(function(){freeze_monitoring=!1},800);b.success?a(b.body):crypto_token=""},`${backend_host}/server?crypto_token=${crypto_token}`,"GET",!0):(initCrypto(),freeze_monitoring=!1)}
