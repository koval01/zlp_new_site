...
k}m="block";b.includes(a.type)&&(m="none");e.style.display=m;f.style.display=m;const q=function(){e.value=e.value.replace(/\D+/g,"");if(!b.includes(a.type)){let k=parseInt(e.value)*a.price,n=h[a.service_id],p="";if(isNaN(k)||1>Math.sign(k))k=0;n&&(p='\u0423\u0436\u0435 \u0432 \u043a\u043e\u0440\u0437\u0438\u043d\u0435 -  <span class="text-primary fw-semibold">'+`${n}</span>`);d.innerHTML=`${c}<br/>\u0421\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c - `+`<span class="text-primary fw-semibold">${k} `+
...
function call_sucess_pay_modal(a=0,b=!1){const d=document.getElementById("donate-cart-list-success"),c=document.getElementById("success-pay-text-js"),e=function(f,g=!1){b?c.innerText="\u041e\u043f\u043b\u0430\u0442\u0430 \u043f\u0440\u043e\u0448\u043b\u0430 \u0443\u0441\u043f\u0435\u0448\u043d\u043e, \u0441\u043f\u0430\u0441\u0438\u0431\u043e \u0437\u0430 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0443.":(f.email.length||(f.email="\u041d\u0443 \u0443\u043a\u0430\u0437\u0430\u043d\u043e"),d.innerHTML=
`
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        <h6 class="my-0 text-start">
                ...
                <li class="list-group-item d-flex justify-content-between">
                    <span>\u0421\u0443\u043c\u043c\u0430</span>
                    <strong>${f.enrolled} ${getNoun(f.enrolled,"\u0440\u0443\u0431\u043b\u044c","\u0440\u0443\u0431\u043b\u044f","\u0440\u0443\u0431\u043b\u0435\u0439")}</strong>
                    </li>
            `);switch_modal_containers("success");modal_open_();g&&(document.querySelector(".modal-title").innerText="\u0423\u0441\u043f\u0435\u0445")};b?e(0,!0):check_payment(function(f){f?e(f):b||notify("\u041e\u0448\u0438\u0431\u043a\u0430, \u0447\u0435\u043a \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d \u0438\u043b\u0438 EasyDonate \u0432\u0435\u0440\u043d\u0443\u043b \u043d\u0435\u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043e\u0442\u0432\u0435\u0442")},
a)}function success_pay(a="",b=!1){let d="";try{d=parseInt(a.match(/^(success_pay_i)+([\d]+)$/)[2])}catch(c){}b&&/^(success_pay_i)+[\d]+$/.test(linkHash())||a.length?call_sucess_pay_modal(d,"success_pay_i_ok"===a):console.log("error call success_pay")}
