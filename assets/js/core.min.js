...
function check_coupon(a,b){re_check(function(c){requestCall(function(d){d.coupon&&d.success&&a(d.coupon);a(null)},`${backend_host}/donate/coupon`,"POST",!0,{code:b,token:c})})}function checkPayment(a,b){re_check(function(c){requestCall(function(d){a(d.payment)},`${backend_host}/donate/payment_get`,"POST",!0,{payment_id:parseInt(b),token:c,tokens_send:coins_sell_mode})})}
