...
clickable:!0},navigation:{prevEl:"#prev_news",nextEl:"#next_news"}}),c())};get_news_(function(b){a(b)},1)}
...
function initSmoothScrollObserver(){let a=["donate","main"],b=new SmoothScroll("section"),c=()=>{let d=linkHash().toLowerCase();d&&d.length&&(a.includes(d)||b.animateScroll(document.querySelector(`section[id="${d}"]`),null,{offset:40}))};c();window.onhashchange=c}
