...
function openTelegramAuthModal(){console.log("Telegram auth preparing...");modal_close_();let a=document.createElement("script");a.src="https://telegram.org/js/telegram-widget.js?21";a.setAttribute("async","");a.setAttribute("data-telegram-login",telegram_bot_username);a.setAttribute("data-size","large");a.setAttribute("data-radius","8");a.setAttribute("data-onauth","onTelegramAuth(user)");a.onload=function(){switch_modal_containers("info",{title:"\u0410\u0432\u0442\u043e\u0440\u0438\u0437\u0430\u0446\u0438\u044f",
content:""});modal_open_()};let b=document.createElement("div");document.getElementById("info-content-modal").appendChild(b);b.id="telegram-auth-container";b.appendChild(a)}function initJarallax(){jarallax(document.querySelectorAll(".jarallax"),{speed:.15,type:"scale-opacity"})}
