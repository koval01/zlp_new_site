...
function donateFlushCart(){Cookies.remove(cart_cookie);donate_cart_button({});notify("\u041a\u043e\u0440\u0437\u0438\u043d\u0430 \u043e\u0447\u0438\u0449\u0435\u043d\u0430")}function onTelegramAuth(a){Cookies.set(telegram_cookie_token,utf8_to_b64(JSON.stringify(a)))}function getTelegramAuth(a=!1){let b=Cookies.get(telegram_cookie_token);if(a)return b;if(b)return JSON.parse(b64_to_utf8(b))}
