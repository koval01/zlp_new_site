...
count:a[e].number,description:a[e].description,type:a[e].type,service_id:a[e].id,server_id:a[e].server_id};products_by_serverid.push(a[e]);let h="",k="p-3",l=`
                ...
                `;var f="";e&&b.length>=e&&c.classList.add(b[e-1]);let n=`onClick="donate_element_click(${JSON.stringify(g)})"`;coins_sell_mode?(f="","\u0442\u043e\u043a\u0435\u043d"===a[e].name.toLowerCase()?(h=`${a[e].price} ${getNoun(a[e].price,"\u0440\u0443\u0431\u043b\u044c","\u0440\u0443\u0431\u043b\u044f","\u0440\u0443\u0431\u043b\u0435\u0439")} = ${a[e].number} ${getNoun(a[e].number,"\u0442\u043e\u043a\u0435\u043d","\u0442\u043e\u043a\u0435\u043d\u0430","\u0442\u043e\u043a\u0435\u043d\u043e\u0432")}`,
