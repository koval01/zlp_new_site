...
function get_yt_video_(a,b,c=!1){c?a(null):re_check(function(d){requestCall(function(f){a(f.body)},`${backend_host}/youtube_get`,"POST",!0,{token:d,video_id:b})})}function get_news_(a,b){re_check(function(c){requestCall(function(d){a(d.messages)},`${backend_host}/channel_parse?choice=${b}`,"POST",!0,{token:c})})}
function appendPostsNews(){let a=function(b,c){c=document.getElementById("news_swipe_array");b=b.reverse();for(let e=0;e<b.length;e++){var d=b[e].text,f=new Date(b[e].datetime_utc);b[e].cover||(b[e].cover="assets/images/spawn.webp");c.innerHTML+=`
            ...
            `;f=document.getElementById(`background-news-${e}`);d=document.getElementById(`news_text_${e}`);f.style.backgroundImage=`url(${b[e].cover})`;d.classList.add("text-light");f=d.innerText.length;d.innerText.split(" ");f=.4*(f- -8)/100;let g=(h,k,l=.32,m=.9)=>h<l?k/m*l:h;d.style.fontSize=`calc(${g(parseFloat(1.7-f),f)}vw + ${g(parseFloat(1.7-f),f)}vh + ${g(parseFloat(1.8-f),f)}vmin)`;d.style.padding=`${g(parseFloat(1.3-f),f,.22,1.05)}rem`;getImageLightness(b[e].cover,function(h){h=`#000000${((parseFloat(h)/
255*100).toFixed()+64).toString(16).slice(0,2)}`;document.getElementById(`news-overlay-${e}`).style.background=h})}c=function(){setTimeout(function(){let e=document.getElementById("telegram_block_load"),g=document.getElementById("news_zlp_buttons");try{e.parentNode.removeChild(e),g.style.display=""}catch(h){}},150)};b&&(new Swiper("#news_swipe_container",{spaceBetween:12,loop:!0,observer:!0,observeParents:!0,preventClicks:!1,preventClicksPropagation:!1,autoplay:{delay:1E4},pagination:{el:"#news_swiper_pagination",
clickable:!0},navigation:{prevEl:"#prev_news",nextEl:"#next_news"}}),c())};get_news_(function(b){a(b,1)},1)}
function donateSwitchContainer(a){let b=document.querySelector(".donate-global-container"),c=function(d){setTimeout(function(){b.style.zIndex=d},850)};!donate_displayed||a?(document.body.style.overflowY="hidden",window.scrollTo({top:0,behavior:"smooth"}),b.style.minHeight="",c(""),donate_displayed=!0,location.hash="#donate"):(b.style.minHeight="0",b.style.zIndex="-1",document.body.style.overflowY="",donate_displayed=!1,location.hash="#main")}
...
function check_coupon(a,b){re_check(function(c){requestCall(function(d){d.coupon&&d.success&&a(d.coupon);a(null)},`${backend_host}/donate/coupon`,"POST",!0,{code:b,token:c})})}function checkFeedbackStatus(a){re_check(function(b){requestCall(function(c){a(c.success)},`${backend_host}/feedback/check`,"POST",!0,{token:b})})}function sendFeedback(a,b){re_check(function(c){requestCall(function(d){d.coupon&&d.success&&a(d.coupon);a(null)},`${backend_host}/feedback/send`,"POST",!0,{text:b,token:c})})}
...
"block";b.includes(a.type)&&(l="none");f.style.display=l;e.style.display=l;let m=function(){f.value=f.value.replace(/\D+/g,"");if(!b.includes(a.type)){let n=parseInt(f.value)*a.price,p=h[a.service_id],q="";if(isNaN(n)||1>Math.sign(n))n=0;p&&(q=`
                    \u0423\u0436\u0435 \u0432 \u043a\u043e\u0440\u0437\u0438\u043d\u0435 - 
                        <span class="text-primary fw-semibold">
                            ${p}
                        </span>
                `);c.innerHTML=`${d}
                    ...
                    <br/>
                    ${q}
                `;k()}};c.innerHTML=d;m();f.addEventListener("input",function(n){m()});modal_open_()}function donate_get_service_by_id(a){for(let b=0;b<donate_services_array.length;b++)if(donate_services_array[b].id===parseInt(a))return donate_services_array[b];return null}
...
function donateModalCall(a,b,c=!0){let d=document.getElementById("donate_sum"),f=document.getElementById("donate_customer_c"),e=document.getElementById("sum-tokens-container"),g=document.getElementById("customer-email-tokens-container").classList,h=document.getElementById("donate-text-span"),k,l=[document.getElementById("donate_sum"),document.getElementById("donate_customer_c"),document.getElementById("donate_email_c"),document.getElementById("coupon-input-c")],m=document.querySelector(".modal-title"),
n;current_c_item=b;1===a?(e.style.display="",g.remove("col-sm-6"),g.add("col-12"),k="\n            \u0412\u043e\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0432\u0448\u0438\u0441\u044c \u044d\u0442\u043e\u0439 \u0444\u043e\u0440\u043c\u043e\u0439, \u0432\u044b \u043c\u043e\u0436\u0435\u0442\u0435 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u0430\u0442\u044c \u043f\u0440\u043e\u0435\u043a\u0442 \u0444\u0438\u043d\u0430\u043d\u0441\u043e\u0432\u043e.\n            \u0417\u0430 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0443 \u0432\u044b \u043f\u043e\u043b\u0443\u0447\u0438\u0442\u0435 \u0432\u043e\u0437\u043d\u0430\u0433\u0440\u0430\u0436\u0434\u0435\u043d\u0438\u0435 \u2013 \u0437\u0430 \u043a\u0430\u0436\u0434\u044b\u0439 \u0440\u0443\u0431\u043b\u044c \u043f\u043e \u043e\u0434\u043d\u043e\u043c\u0443 \u0438\u0433\u0440\u043e\u0432\u043e\u043c\u0443 \u0442\u043e\u043a\u0435\u043d\u0443.\n        ",
n="\u0422\u043e\u043a\u0435\u043d\u044b",d.addEventListener("input",function(p){donateCoinsPay()})):2===a&&(e.style.display="none",g.remove("col-12"),g.add("col-sm-6"),k="\n            \u0412\u044b \u043c\u043e\u0436\u0435\u0442\u0435 \u0441\u043e\u0432\u0435\u0440\u0448\u0438\u0442\u044c \u0440\u0430\u0437\u043e\u0432\u044b\u0439 \u043f\u043b\u0430\u0442\u0435\u0436 \u0438 \u043f\u043e\u043b\u0443\u0447\u0438\u0442\u044c \u043f\u0440\u043e\u043f\u0443\u0441\u043a \u043d\u0430 \u0441\u0435\u0437\u043e\u043d \u043a \u043f\u0440\u0438\u0432\u0430\u0442\u043d\u043e\u043c\u0443 \u0441\u0435\u0440\u0432\u0435\u0440\u0443 \n            \u0432 \u043a\u0430\u0447\u0435\u0441\u0442\u0432\u0435 \u0432\u043e\u0437\u043d\u0430\u0433\u0440\u0430\u0436\u0434\u0435\u043d\u0438\u044f \u0437\u0430 \u0444\u0438\u043d\u0430\u043d\u0441\u043e\u0432\u0443\u044e \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0443 \u043f\u0440\u043e\u0435\u043a\u0442\u0430.\n        ",
n="\u041f\u0440\u043e\u043f\u0443\u0441\u043a",f.addEventListener("input",function(p){donateCoinsPay(a)}));h.innerText=k.replaceAll("\n","");for(b=0;b<l.length;b++)l[b].addEventListener("input",function(p){donateResetPaymentState(a)});switch_modal_containers("service_coins");modal_open_();c&&(shuffle(glob_players),document.querySelector("input#donate_customer_c").setAttribute("placeholder",glob_players[0]));donateResetPaymentState(a,!1,!0);(p=>{m.innerText=m.innerText.replace(/\([\s\S]*?\)/).trim();
m.innerText=`${m.innerText} (${p})`})(n)}function linksSet(a,b=!1){a=document.getElementById(a);let c="margin-left: 0 !important";for(let d=0;d<links_lt.length;d++){if(!b||d)c="";a.innerHTML+=`<a href="${links_lt[d].link}" 
...
function callSucessPayModal(a=0){let b,c=document.getElementById("donate-cart-list-success"),d=document.getElementById("success-pay-text-js"),f=document.getElementById("only-ok-payment"),e=document.querySelector(".modal-title");donateSwitchContainer(display=!0);checkPayment(function(g){if("undefined"!==typeof g.status){if(g.status&&a==parseInt(g.id)){b=g;d.innerText="\u041e\u043f\u043b\u0430\u0442\u0430 \u043f\u0440\u043e\u0448\u043b\u0430 \u0443\u0441\u043f\u0435\u0448\u043d\u043e, \u0428\u0435\u0444 \u0434\u043e\u0432\u043e\u043b\u0435\u043d, \u0441\u043f\u0430\u0441\u0438\u0431\u043e \u0442\u0435\u0431\u0435.";
