...
function modal_close_(){document.body.classList.remove("modal-open");document.getElementById("scroll_butt_container").style.display="";document.getElementsByTagName("html")[0].style.overflowY="";let a=document.getElementById("donate_item_modal");a.style.opacity=0;setTimeout(function(){a.style.display="none"},350)}
function modal_open_(a=!1){document.body.classList.add("modal-open");document.getElementById("scroll_butt_container").style.display="none";document.getElementsByTagName("html")[0].style.overflowY="hidden";let b=document.getElementById("donate_item_modal");b.style.display="block";setTimeout(function(){b.style.opacity=1},50);a||(window.onclick=function(c){c.target===b&&modal_close_()})}
...
function donateContainerHash(){observerContainerHash(["donate","donate_block"],function(){donate_displayed=!0;donateSwitchContainer(donate_displayed)})}function rulesPrivateContainerHash(){observerContainerHash(["private_rules"],function(){let a="";get_rules_private_server(function(b){for(let c=0;c<b.length;c++)a+=`
                    <li class="list-group-item d-flex justify-content-between lh-sm">
                        <div>
                            <h6 class="my-0 text-start">
                                ${c+1}
            ...
            `});modal_open_()})})}
function adminsContactContainerHash(){observerContainerHash(["contact","support","bug","report"],function(){switch_modal_containers("info",{title:"\u041e\u0431\u0440\u0430\u0442\u043d\u0430\u044f \u0441\u0432\u044f\u0437\u044c",content:'\n                <p class="mb-2 mb-lg-3 mb-xl-4 text-start">\n                    \u042d\u0442\u043e \u0444\u043e\u0440\u043c\u0430 \u0434\u043b\u044f \u043f\u0440\u0435\u0434\u043b\u043e\u0436\u0435\u043d\u0438\u0439 \u0438 \u0436\u0430\u043b\u043e\u0431, \u043e\u043f\u0438\u0448\u0438\u0442\u0435 \u043f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430 \u043a\u0440\u0430\u0442\u043a\u043e \u0438 \n                    \u044f\u0441\u043d\u043e \u0441\u0432\u043e\u044e \u0438\u0434\u0435\u044e \u0438\u043b\u0438 \u043f\u0440\u0435\u0434\u043b\u043e\u0436\u0435\u043d\u0438\u0435 \u0431\u0435\u0437 \u0432\u043e\u0434\u044b.\n                </p>\n                <div id="contant-input-container">\n                    <label for="admin-message">0/0</label>\n                    <textarea id="admin-message" name="admin-message" class="form-control" maxlength="0">\n                    </textarea>\n                </div>\n                <button onclick="alert(\'this test\')" class="w-100 btn btn-primary btn-lg btn-shadow-hide mt-3 mt-lg-4 type="button">\n                    \u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c\n                </button>\n            '});let a=
document.getElementById("admin-message"),b=document.querySelector('label[for="admin-message"]');a.value.includes(" ".repeat(3))&&(a.value=a.value.trim());a.maxLength=3E3;let c=()=>{b.innerText=`${a.value.length}/${3E3}`};c();addEventListener("keydown",d=>c());addEventListener("keyup",d=>c());modal_open_(onclick_lock=!0)})}function observerContainerHash(a,b){a.includes(linkHash())&&b();addEventListener("hashchange",c=>{a.includes(linkHash())&&b()})}
function initJarallax(){jarallax(document.querySelectorAll(".jarallax"),{speed:.15,type:"scale-opacity"})}
...
const initCore=function(){initHost();initCrypto();initLanding();observerSystemTheme();donateContainerHash();rulesPrivateContainerHash();adminsContactContainerHash();buildPlayersSwiper();appendPostsNews();initComments();appendServices();updateCartCount();gameServerUpdater();initDonate();initEventsList();initJarallax();finishLoad();successPay();ytVideoSetter(skip=!0);let a=document.getElementById("dark-perm-set-bv");a.parentNode.removeChild(a);window.onload=function(){if(!debug_lock_init){let b=document.querySelector(".page-loading");
