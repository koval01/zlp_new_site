...
function donateContainerHash(){observerContainerHash(["donate","donate_block"],function(){donate_displayed=!0;donateSwitchContainer(donate_displayed)})}function rulesPrivateContainerHash(){observerContainerHash(["private_rules"],function(){let a="";get_rules_private_server(function(b){for(let c=0;c<b.length;c++)a+=`
            ...
            `});modal_open_()})})}
function adminsContactContainerHash(){observerContainerHash(["contact","support","bug","report"],function(){checkTelegramAuthData(function(a){if(a){switch_modal_containers("info",{title:"\u041e\u0431\u0440\u0430\u0442\u043d\u0430\u044f \u0441\u0432\u044f\u0437\u044c",content:'\n                        <p class="mb-2 mb-lg-3 mb-xl-4 text-start">\n                            \u042d\u0442\u043e \u0444\u043e\u0440\u043c\u0430 \u0434\u043b\u044f \u043f\u0440\u0435\u0434\u043b\u043e\u0436\u0435\u043d\u0438\u0439 \u0438 \u0436\u0430\u043b\u043e\u0431, \u043e\u043f\u0438\u0448\u0438\u0442\u0435 \u043f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430 \u043a\u0440\u0430\u0442\u043a\u043e \u0438 \n                            \u044f\u0441\u043d\u043e \u0441\u0432\u043e\u044e \u0438\u0434\u0435\u044e \u0438\u043b\u0438 \u043f\u0440\u0435\u0434\u043b\u043e\u0436\u0435\u043d\u0438\u0435 \u0431\u0435\u0437 \u0432\u043e\u0434\u044b.\n                        </p>\n                        <div id="contant-input-container">\n                            <label for="admin-message">0/0</label>\n                            <textarea id="admin-message" name="admin-message" class="form-control" maxlength="0">\n                            </textarea>\n                        </div>\n                        <button onclick="sendFeedbackAction()" class="w-100 btn btn-primary btn-lg btn-shadow-hide mt-3 mt-lg-4" id="send-feedback-button" type="button">\n                            \u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c\n                        </button>\n                    '});let b=
document.getElementById("admin-message"),c=document.querySelector('label[for="admin-message"]');b.value.includes(" ".repeat(3))&&(b.value=b.value.trim());b.maxLength=2500;let d=()=>{c.innerText=`${b.value.length}/${2500}`};d();addEventListener("keydown",f=>d());addEventListener("keyup",f=>d());modal_open_(onclick_lock=!0)}else console.log("Error check Telegram auth")})})}
function observerContainerHash(a,b){a.includes(linkHash())&&b();addEventListener("hashchange",c=>{a.includes(linkHash())&&b()})}
