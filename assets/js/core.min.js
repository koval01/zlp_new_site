...
function initHost(){const a=Object.keys(site_domains);for(let b=0;b<a.length;b++)site_domains[a[b]]===window.location.hostname&&(work_domain_v=site_domains[a[b]])}function linkHash(){return window.location.hash.substring(1)}function utf8_to_b64(a){return window.btoa(unescape(encodeURIComponent(a)))}function b64_to_utf8(a){return decodeURIComponent(escape(window.atob(a)))}
function getAvatarColorIDforTG(a){for(var b=0,c=1;0<a;)b+=a%7*c,c*=10,a=Math.floor(a/7);return parseInt(b.toString().slice(-1))}function getHash(a){a=window.location.hash.substr(1);return Object.keys(a.split("&").reduce(function(b,c){c=c.split("=");b[c[0]]=c[1];return b},{}))[0]}function re_check(a){grecaptcha.ready(function(){grecaptcha.execute(re_token,{action:"submit"}).then(function(b){a(b)})})}
function shuffle(a){let b=a.length,c;for(;0!==b;)c=Math.floor(Math.random()*b),b--,[a[b],a[c]]=[a[c],a[b]];return a}function alternateSort(a){let b;for(let d=0;d<a.length;d++){b=d;var c=a[d];for(let f=d+1;f<a.length;f++)a[f]<c&&(c=a[f],b=f);c<a[d]&&(c=a[d],a[d]=a[b],a[b]=c)}}
function getImageLightness(a,b){const c=document.createElement("img");c.src=a;c.crossOrigin="Anonymous";c.style.display="none";document.body.appendChild(c);let d=0;c.onload=function(){var f=document.createElement("canvas");f.width=this.width;f.height=this.height;var e=f.getContext("2d");e.drawImage(this,0,0);f=e.getImageData(0,0,f.width,f.height).data;let g,h;for(let k=0,l=f.length;k<l;k+=4)e=f[k],g=f[k+1],h=f[k+2],e=Math.floor((e+g+h)/3),d+=e;b(Math.floor(d/(this.width*this.height)));c.remove()}}
...
function getNoun(a,b="\u0438\u0433\u0440\u043e\u043a",c="\u0438\u0433\u0440\u043e\u043a\u0430",d="\u0438\u0433\u0440\u043e\u043a\u043e\u0432"){a=Math.abs(a);a%=100;if(5<=a&&20>=a)return d;a%=10;return 1===a?b:2<=a&&4>=a?c:d}function getCrypto(a){re_check(function(b){requestCall(function(c){c.success?a(c.token):a("")},`${backend_host}/crypto`,"POST",!0,{token:b})})}function get_events_(a){re_check(function(b){requestCall(function(c){a(c.events)},`${backend_host}/events`,"POST",!0,{token:b})})}
...
function appendPostsNews(){const a=function(b){var c=document.getElementById("news_swipe_array");b=b.reverse();for(let e=0;e<b.length;e++){var d=b[e].text,f=new Date(b[e].datetime_utc);b[e].cover||(b[e].cover="assets/images/spawn.webp");c.innerHTML+=`
...
k=>h());setInterval(h,100);getImageLightness(b[e].cover,function(k){k=`#000000${((parseFloat(k)/255*100).toFixed()+64).toString(16).slice(0,2)}`;document.getElementById(`news-overlay-${e}`).style.background=k})}c=function(){setTimeout(function(){const e=document.getElementById("telegram_block_load"),g=document.getElementById("news_zlp_buttons");try{e.parentNode.removeChild(e),g.style.display=""}catch(h){}},150)};b&&(new Swiper("#news_swipe_container",{spaceBetween:12,loop:!0,observer:!0,observeParents:!0,
...
function donateSwitchContainer(a){const b=document.querySelector(".donate-global-container"),c=function(d){setTimeout(function(){b.style.zIndex=d},850)};!donate_displayed||a?(document.body.style.overflowY="hidden",window.scrollTo({top:0,behavior:"smooth"}),b.style.minHeight="",c(""),donate_displayed=!0,location.hash="#donate"):(b.style.minHeight="0",b.style.zIndex="-1",document.body.style.overflowY="",donate_displayed=!1,location.hash="#")}
function get_game_server_data(a){crypto_token?requestCall(function(b){setTimeout(function(){freeze_monitoring=!1},800);b.success?a(b.body):crypto_token=""},`${backend_host}/server?crypto_token=${encodeURIComponent(crypto_token)}`,"GET",!0):(initCrypto(),freeze_monitoring=!1)}
...
function initEventsList(){const a=document.getElementById("events-row-container");document.getElementById("events_block_load");const b=document.getElementById("events-c-button"),c=["row-cols-md-2","row-cols-lg-2","row-cols-xl-3"];get_events_(function(d){if(d&&d.length){events_block_load.remove();d.sort(function(g,h){g=new Date(g.date_start);h=new Date(h.date_start);return g<h?-1:g>h?1:0});const e=function(g){const h=6E4*-g.getTimezoneOffset();return new Date(g.getTime()-h)};for(let g=0;g<d.length;g++){b.removeAttribute("disabled");
3>g>0&&a.classList.add(c[g]);var f=e(new Date(d[g].date_start));const h=e(new Date(d[g].date_end)),k=new Date((new Date).toLocaleString("en-US",{timeZone:"Europe/Moscow"}));let l="";f>k?l="\u0421\u043a\u043e\u0440\u043e":k>h&&(l="\u0417\u0430\u0432\u0435\u0440\u0448\u0435\u043d\u043e");f=`
                    <div class="col">
...
function generateGiftLink(a,b){getCrypto(function(c){a(`${backend_host}/gift/private_server?payment_id=${b}&crypto_token=${encodeURIComponent(c)}`)})}function check_coupon(a,b){re_check(function(c){requestCall(function(d){d.coupon&&d.success?a(d.coupon):a(null)},`${backend_host}/donate/coupon`,"POST",!0,{code:b,token:c})})}
function checkTelegramAuthData(a){const b=getTelegramAuth(!0);b?requestCall(function(c){c?a(c.success):a(!1)},`${backend_host}/telegram/auth/check`,"POST",!0,{tg_auth_data:b}):a(!1)}function checkFeedbackStatus(a){const b=getTelegramAuth(!0);b&&re_check(function(c){requestCall(function(d){d?a(d.success):a(!1)},`${backend_host}/feedback/check`,"POST",!0,{token:c,tg_auth_data:b})})}
function sendFeedback(a,b){const c=getTelegramAuth(!0);c&&re_check(function(d){requestCall(function(f){f?a(f.success):a(!1)},`${backend_host}/feedback/send`,"POST",!0,{text:b,token:d,tg_auth_data:c})})}
function sendFeedbackAction(){const a=document.getElementById("send-feedback-button"),b=document.getElementById("admin-message").value;if(20>b.length)notify("\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435 \u043e\u0447\u0435\u043d\u044c \u043a\u043e\u0440\u043e\u0442\u043a\u043e\u0435!");else{var c=(d=!0)=>{d?a.setAttribute("disabled",""):a.removeAttribute("disabled");a.innerText=d?"\u041e\u0436\u0438\u0434\u0430\u0439\u0442\u0435...":"\u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c"};
...
function appendServices(){get_donate_services(function(a){donate_services_array=a;const b=["row-cols-sm-2","row-cols-md-3","row-cols-lg-4"],c=document.getElementById("donate_items_list"),d=(e,g)=>{e=e.toLowerCase();g=g.toLowerCase();if(e.includes("\u0442\u043e\u043a\u0435\u043d")&&"currency"===g)return 1;if(e.includes("\u043f\u0440\u043e\u0445\u043e\u0434\u043a\u0430")&&"other"===g)return 2};if(a.length){donate_check_services_cart();for(let e=0;e<a.length;e++){const g={name:a[e].name,price:a[e].price,
...
""),f.removeAttribute("disabled"),c.style.top="-2rem",b.style.top="0",events_page_state="news"))}function redirect_(a){return window.location.replace(a)}function ytVideoSetter(a=!1){const b=function(c,d,f){get_yt_video_(function(e){c.innerHTML=e&&e.video.x720.url&&!a?`
                ...
                `},d,a)};for(let c of Array.from(document.getElementsByClassName("ytVideoSetter"))){const d=c.getAttribute("video_id");d&&d.length&&20>d.length&&b(c,d,params={autoplay:c.getAttribute("autoplay"),muted:c.getAttribute("muted"),loop:c.getAttribute("loop"),controls:c.getAttribute("controls")})}}
function modal_close_(){if(modal_displayed){document.body.classList.remove("modal-open");document.getElementById("scroll_butt_container").style.display="";document.getElementsByTagName("html")[0].style.overflowY="";const a=document.getElementById("donate_item_modal");a.style.opacity=0;setTimeout(function(){a.style.display="none"},350);modal_displayed=!1}}
...
function initComments(){const a=document.getElementById("comment_swipe_array"),b=function(c){requestCall(function(d){c(d)},"assets/data/players.json","GET",!0)};requestCall(function(c){shuffle(c);b(function(d){for(let e=0;e<c.length;e++){var f;a:{for(f=0;f<d.length;f++)if(d[f].name===c[e].name){f=d[f];break a}f=void 0}a.innerHTML+=`
                        <div class="swiper-slide h-auto px-2">
...
autoplay:{delay:8E3},pagination:{el:".swiper-pagination",clickable:!0},navigation:{prevEl:"#prev_comment",nextEl:"#next_comment"}})},"assets/data/comments.json","GET",!0)}
function buildPlayersSwiper(){const a=document.getElementById("players-swiper-array");(function(b){requestCall(function(c){b(c)},"assets/data/badges.json","GET",!0)})(function(b){requestCall(function(c){shuffle(c);for(let d=0;d<c.length;d++){glob_players.push(c[d].name);const f=function(){let g="";c[d].badges.sort();for(let h=0;h<c[d].badges.length;h++){const k=c[d].badges[h];k&&k.length&&"verified"!==k&&!k.includes("clan-")&&(g+=`
...
function donate_element_click(a){switch_modal_containers("service");const b=["group"],c=document.getElementById("donate_item_select_text"),d=`\u0422\u043e\u0432\u0430\u0440 <span class="text-primary fw-semibold">${a.name}</span>,
...
"block";b.includes(a.type)&&(l="none");f.style.display=l;e.style.display=l;const n=function(){f.value=f.value.replace(/\D+/g,"");if(!b.includes(a.type)){let m=parseInt(f.value)*a.price;const p=h[a.service_id];let q="";if(isNaN(m)||1>Math.sign(m))m=0;p&&(q=`
                    \u0423\u0436\u0435 \u0432 \u043a\u043e\u0440\u0437\u0438\u043d\u0435 - 
                        <span class="text-primary fw-semibold">
                            ${p}
                        </span>
...
function donate_cart_button(a={}){const b=document.querySelectorAll(".donate-cart-button-cn");if(!coins_sell_mode)for(let c=0;c<b.length;c++){const d=b[c].style;countProperties(a)?(d.display="flex",setTimeout(function(){d.opacity=1;d.marginTop="15px";b[c].removeAttribute("disabled")},50)):(b[c].setAttribute("disabled",""),d.opacity=0,d.marginTop="-50px",setTimeout(function(){d.display="none"},350))}}
function donateFlushCart(){Cookies.remove(cart_cookie);donate_cart_button({});notify("\u041a\u043e\u0440\u0437\u0438\u043d\u0430 \u043e\u0447\u0438\u0449\u0435\u043d\u0430")}
function onTelegramAuth(a){Cookies.set(telegram_cookie_token,utf8_to_b64(JSON.stringify(a)));modal_close_();notify(`\u0412\u044b \u0443\u0441\u043f\u0435\u0448\u043d\u043e \u0430\u0432\u0442\u043e\u0440\u0438\u0437\u043e\u0432\u0430\u043b\u0438\u0441\u044c \u043a\u0430\u043a <span class="text-gradient-primary">${a.first_name} ${a.last_name}</span>`)}function getTelegramAuth(a=!1){const b=Cookies.get(telegram_cookie_token);if(b){if(a)return b;if(b)return JSON.parse(b64_to_utf8(b))}}
function couponCheck(a){a="";coins_sell_mode&&(a="-c");const b=document.getElementById("coupon-input"+a),c=document.getElementById("coupon-button"+a);let d="";try{d=b.value.trim().toUpperCase()}catch(h){}const f=function(){notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${failed_coupon}</span> \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d`)},e=function(h,k){if(h)for(k=0;k<h.length;k++)if(h[k].id===current_c_item)return!0;return!1};if(d.length)if(20<d.length)notify("\u041a\u0443\u043f\u043e\u043d \u0441\u043b\u0438\u0448\u043a\u043e\u043c \u0434\u043b\u0438\u043d\u043d\u044b\u0439");
...
g(!0);check_coupon(function(h){if(h){const k=function(){checked_coupon=d;notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${d}</span> \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439`)};coins_sell_mode?e(h.products,current_c_item)?(k(),document.getElementById("donate-coins-payment").innerHTML=`<li class="list-group-item d-flex justify-content-between bg-light">
...
function donate_enable_coupon(a=!0){const b=document.getElementById("coupon-input"),c=document.getElementById("coupon-button");a?(b.setAttribute("placeholder","BRFF"),c.setAttribute("onClick","couponCheck()"),b.removeAttribute("disabled"),c.removeAttribute("disabled")):(b.setAttribute("disabled",""),b.setAttribute("placeholder","\u0421\u0435\u0439\u0447\u0430\u0441 \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u043e"),c.setAttribute("disabled",""))}
function generatePaymentLink(a=1,b=0){var c="";coins_sell_mode&&(c="_c");const d=document.getElementById("payment-button-donate"+c),f=document.getElementById("donate_customer"+c).value.trim();c=document.getElementById("donate_email"+c).value.trim();let e="";try{e=checked_coupon.trim()}catch(g){}if(1===a)if(Number.isInteger(b)&&Number.isInteger(b)){if(1>Math.sign(b)){notify("\u0421\u0443\u043c\u043c\u0430 \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0440\u0430\u0432\u043d\u044f\u0442\u044c\u0441\u044f \u043d\u0443\u043b\u044e \u0438\u043b\u0438 \u043c\u0435\u043d\u044c\u0448\u0435");
...
function donate_check_services_cart(){const a=Object.keys(get_cookie_cart());var b=donate_services_array;const c=[];for(var d=0;d<b.length;d++)c.push(b[d].id);for(b=0;b<a.length;b++)c.includes(parseInt(a[b]))||(d=JSON.parse(Cookies.get(cart_cookie)),delete d[parseInt(a[b])],Cookies.set(cart_cookie,JSON.stringify(d)),console.log(`Remove ${a[b]} from cart`))}function initDonate(){let a={};try{a=JSON.parse(Cookies.get(cart_cookie))}catch(b){}donate_cart_button(a);donate_enable_coupon(!0)}
function donateCartCall(a=null,b=!0){const c=get_cookie_cart(),d=Object.keys(c),f=document.getElementById("donate-cart-list");var e=[document.getElementById("donate_customer"),document.getElementById("donate_email"),document.getElementById("coupon-input")];switch_modal_containers("donate_finish");modal_open_();f.innerHTML="";let g=0;for(var h=0;h<e.length;h++)e[h].addEventListener("input",function(k){donateResetPaymentState()});for(e=0;e<d.length;e++){h=donate_get_service_by_id(d[e]);const k=h.price*
c[h.id];g+=k;f.innerHTML+=`
        ...
        `}a&&(f.innerHTML+=`<li class="list-group-item d-flex justify-content-between bg-light">
            ...
            </li>`;b&&(shuffle(glob_players),document.querySelector("input#donate_customer").setAttribute("placeholder",glob_players[0]))}function donateCoinsPay(a=1){const b=document.getElementById("payment-button-donate_c");let c=document.getElementById("donate_sum");c=c.value||/^[\d]+$/.test(c.value)?c.value:0;b.setAttribute("onClick",`generatePaymentLink(${a}, ${2===a?1:c})`)}
function donateModalCall(a,b,c=!0){const d=document.getElementById("donate_sum"),f=document.getElementById("donate_customer_c"),e=document.getElementById("sum-tokens-container"),g=document.getElementById("customer-email-tokens-container").classList,h=document.getElementById("donate-text-span");let k;const l=[document.getElementById("donate_sum"),document.getElementById("donate_customer_c"),document.getElementById("donate_email_c"),document.getElementById("coupon-input-c")],n=document.querySelector(".modal-title");
let m;current_c_item=b;1===a?(e.style.display="",g.remove("col-sm-6"),g.add("col-12"),k="\n            \u0412\u043e\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0432\u0448\u0438\u0441\u044c \u044d\u0442\u043e\u0439 \u0444\u043e\u0440\u043c\u043e\u0439, \u0432\u044b \u043c\u043e\u0436\u0435\u0442\u0435 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u0430\u0442\u044c \u043f\u0440\u043e\u0435\u043a\u0442 \u0444\u0438\u043d\u0430\u043d\u0441\u043e\u0432\u043e.\n            \u0417\u0430 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0443 \u0432\u044b \u043f\u043e\u043b\u0443\u0447\u0438\u0442\u0435 \u0432\u043e\u0437\u043d\u0430\u0433\u0440\u0430\u0436\u0434\u0435\u043d\u0438\u0435 \u2013 \u0437\u0430 \u043a\u0430\u0436\u0434\u044b\u0439 \u0440\u0443\u0431\u043b\u044c \u043f\u043e \u043e\u0434\u043d\u043e\u043c\u0443 \u0438\u0433\u0440\u043e\u0432\u043e\u043c\u0443 \u0442\u043e\u043a\u0435\u043d\u0443.\n        ",
...
"This site uses Google ReCaptcha technology")}function observerSystemTheme(){const a=["dark","light"],b=document.querySelector('[data-bs-toggle="mode"]').querySelector(".form-check-input");for(let c=0;c<a.length;c++)window.matchMedia(`(prefers-color-scheme: ${a[c]})`).addEventListener("change",d=>{if(d=d.matches)"dark"===a[c]?(root.classList.add("dark-mode"),b.checked=!0):(root.classList.remove("dark-mode"),b.checked=!1),d=void 0;return d})}
function callSucessPayModal(a=0){let b;const c=document.getElementById("donate-cart-list-success"),d=document.getElementById("success-pay-text-js"),f=document.getElementById("only-ok-payment"),e=document.querySelector(".modal-title");donateSwitchContainer(!0);checkPayment(function(g){if("undefined"!==typeof g.status){if(g.status&&a==parseInt(g.id)){b=g;d.innerText="\u041e\u043f\u043b\u0430\u0442\u0430 \u043f\u0440\u043e\u0448\u043b\u0430 \u0443\u0441\u043f\u0435\u0448\u043d\u043e, \u0428\u0435\u0444 \u0434\u043e\u0432\u043e\u043b\u0435\u043d, \u0441\u043f\u0430\u0441\u0438\u0431\u043e \u0442\u0435\u0431\u0435.";
...
`\u0427\u0435\u043a #${g.id}`}else notify("\u041e\u0448\u0438\u0431\u043a\u0430, \u0447\u0435\u043a \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d \u0438\u043b\u0438 EasyDonate \u0432\u0435\u0440\u043d\u0443\u043b \u043d\u0435\u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043e\u0442\u0432\u0435\u0442")},a)}function successPay(){const a=(new URL(window.location.href)).searchParams.get("pg_order_id");a&&callSucessPayModal(a)}
...
document.getElementById("admin-message"),c=document.querySelector('label[for="admin-message"]');b.value.includes(" ".repeat(3))&&(b.value=b.value.trim());b.maxLength=3E3;const d=()=>{c.innerText=`${b.value.length}/${3E3}`};d();addEventListener("keydown",f=>d());addEventListener("keyup",f=>d());modal_open_(onclick_lock=!0)}else console.log("Error check Telegram auth"),openTelegramAuthModal(),notify("\u0412\u0430\u043c \u043d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u043e \u0430\u0432\u0442\u043e\u0440\u0438\u0437\u043e\u0432\u0430\u0442\u0441\u044f \u0434\u043b\u044f \u044d\u0442\u043e\u0439 \u0444\u0443\u043d\u043a\u0446\u0438\u0438")})}
...
function initSmoothScrollObserver(){const a=new SmoothScroll("section"),b=()=>{const c=linkHash().toLowerCase();c&&c.length&&!["private_rules"].includes(c)&&a.animateScroll(document.querySelector(`section[id="${c}"]`),null,{offset:50})};b();window.onhashchange=b}
function autoAuthTelegramObserver(){checkTelegramAuthData(function(a){console.log(`Telegram auth check status : ${a}`);a&&(a=document.getElementById("contact-button-land"),document.querySelector(".avatar-container").removeAttribute("onclick"),a.style.display="")})}
const initCore=function(){initHost();initCrypto();initLanding();observerSystemTheme();buildPlayersSwiper();appendPostsNews();initComments();appendServices();updateCartCount();gameServerUpdater();initDonate();initEventsList();initJarallax();finishLoad();successPay();ytVideoSetter(!0);donateContainerHash();rulesPrivateContainerHash();adminsContactContainerHash();autoAuthTelegramObserver();const a=document.getElementById("dark-perm-set-bv");a.parentNode.removeChild(a);window.onload=function(){if(!debug_lock_init){const b=
document.querySelector(".page-loading");setTimeout(function(){b.classList.remove("active");donate_displayed||(document.body.style.overflowY="");window.scrollTo({top:0})},1500);setTimeout(function(){b.remove();initTooltip();initSmoothScrollObserver()},1600)}}};script_core.onload=function(){initCore()};
