...
function appendPostsNews(){let a=function(b,c){c=document.getElementById("news_swipe_array");b=b.reverse();for(let e=0;e<b.length;e++){var d=b[e].text.split("<br>"),f=new Date(b[e].datetime_utc);b[e].cover||(b[e].cover="assets/images/spawn.webp");c.innerHTML+=`
            ...
            `;f=document.getElementById(`background-news-${e}`);d=document.getElementById(`news_text_${e}`);f.style.backgroundImage=`url(${b[e].cover})`;d.classList.add("text-light");f=d.innerText.length;d.innerText.split(" ");f=.4*(f- -8)/100;d.style.fontSize=`calc(${parseFloat(1.8-f)}vw + ${parseFloat(1.8-f)}vh + ${parseFloat(1.6-f)}vmin)`;getImageLightness(b[e].cover,function(g){g=`#000000${((parseFloat(g)/255*100).toFixed()+64).toString(16).slice(0,2)}`;document.getElementById(`news-overlay-${e}`).style.background=
g})}c=function(){setTimeout(function(){let e=document.getElementById("telegram_block_load"),g=document.getElementById("news_zlp_buttons");try{e.parentNode.removeChild(e),g.style.display=""}catch(h){}},150)};b&&(new Swiper("#news_swipe_container",{spaceBetween:12,loop:!0,observer:!0,observeParents:!0,preventClicks:!1,preventClicksPropagation:!1,autoplay:{delay:1E4},pagination:{el:"#news_swiper_pagination",clickable:!0},navigation:{prevEl:"#prev_news",nextEl:"#next_news"}}),c())};get_news_(function(b){a(b,
...
count:a[e].number,description:a[e].description,type:a[e].type,service_id:a[e].id,server_id:a[e].server_id};products_by_serverid.push(a[e]);let h="",k="p-3",l=`
                ...
                `;var f="";e&&b.length>=e&&c.classList.add(b[e-1]);let n=`onClick="donate_element_click(${JSON.stringify(g)})"`;coins_sell_mode?(f="","\u0442\u043e\u043a\u0435\u043d\u044b"===a[e].name.toLowerCase()?(h=`${a[e].price} ${getNoun(a[e].price,"\u0440\u0443\u0431\u043b\u044c","\u0440\u0443\u0431\u043b\u044f","\u0440\u0443\u0431\u043b\u0435\u0439")} = ${a[e].number} ${getNoun(a[e].number,"\u0442\u043e\u043a\u0435\u043d","\u0442\u043e\u043a\u0435\u043d\u0430","\u0442\u043e\u043a\u0435\u043d\u043e\u0432")}`,
...
function couponCheck(a){a="";coins_sell_mode&&(a="-c");let b=document.getElementById("coupon-input"+a),c=document.getElementById("coupon-button"+a),d="";try{d=b.value.trim()}catch(h){}let f=function(){notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${failed_coupon}</span> \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d`)},e=function(h){if(h)for(let k=0;k<h.length;k++)if(h[k].id===donate_services_array[0].id)return!0;return!1};if(d.length)if(20<d.length)notify("\u041a\u0443\u043f\u043e\u043d \u0441\u043b\u0438\u0448\u043a\u043e\u043c \u0434\u043b\u0438\u043d\u043d\u044b\u0439");
...
g(!0);check_coupon(function(h){if(h){let k=function(){checked_coupon=d;notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${d}</span> \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439`)};coins_sell_mode?e(h.products)?(k(),document.getElementById("donate-coins-payment").innerHTML=`<li class="list-group-item d-flex justify-content-between bg-light">
