...
function check_coupon(a,b){re_check(function(c){requestCall(function(d){d.coupon&&d.success?a(d.coupon):a(null)},`${backend_host}/donate/coupon`,"POST",!0,{code:b,token:c})})}function checkTelegramAuthData(a){let b=getTelegramAuth();b?requestCall(function(c){c?a(c.success):a(!1)},`${backend_host}/telegram/auth/check`,"POST",!0,{tg_auth_data:b}):a(!1)}
function checkFeedbackStatus(a){re_check(function(b){requestCall(function(c){c?a(c.success):a(!1)},`${backend_host}/feedback/check`,"POST",!0,{token:b})})}function sendFeedback(a,b){re_check(function(c){requestCall(function(d){d?a(d.success):a(!1)},`${backend_host}/feedback/send`,"POST",!0,{text:b,token:c})})}
...
function donateFlushCart(){Cookies.remove(cart_cookie);donate_cart_button({});notify("\u041a\u043e\u0440\u0437\u0438\u043d\u0430 \u043e\u0447\u0438\u0449\u0435\u043d\u0430")}function onTelegramAuth(a){Cookies.set(telegram_cookie_token,utf8_to_b64(JSON.stringify(a)))}function getTelegramAuth(){let a=Cookies.get(telegram_cookie_token);if(a)return JSON.parse(b64_to_utf8(a))}
