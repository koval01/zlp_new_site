...
function donate_cart(a,b,d=!1){var c=Cookies.get(cart_cookie),e=get_cookie_cart();let f=0;try{let h=e[a];Number.isInteger(h)&&(f=+h)}catch(h){}Number.isInteger(a)&&Number.isInteger(b)?1>Math.sign(b)?notify("\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u0440\u0430\u0432\u043d\u043e \u043d\u0443\u043b\u044e \u0438\u043b\u0438 \u043c\u0435\u043d\u044c\u0448\u0435"):(console.log(f),console.log(b),console.log(15E3),15E3<
...
function coupon_check(){const a=document.getElementById("coupon-input"),b=document.getElementById("coupon-button"),d=a.value.trim();if(d.length)if(20<d.length)notify("\u041a\u0443\u043f\u043e\u043d \u0441\u043b\u0438\u0448\u043a\u043e\u043c \u0434\u043b\u0438\u043d\u043d\u044b\u0439");else if(/^[A-z\d_]+$/.test(d)){var c=function(e=!1){e?(a.setAttribute("disabled",""),b.setAttribute("disabled",""),b.innerText="\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c"):(a.removeAttribute("disabled"),
b.removeAttribute("disabled"),b.innerText="\u041f\u0440\u043e\u0432\u0435\u0440\u0438\u0442\u044c")};c(!0);check_coupon(function(e){e?(notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${d}</span> \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439`),donate_cart_call(d,!1)):notify(`\u041a\u0443\u043f\u043e\u043d <span class="text-primary fw-semibold">${d}</span> \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d`);c()},d)}else notify("\u041a\u0443\u043f\u043e\u043d \u0443\u043a\u0430\u0437\u0430\u043d \u043d\u0435\u0432\u0435\u0440\u043d\u043e");
...
function generate_payment_link(){const a=document.getElementById("payment-button-donate"),b=document.getElementById("donate_customer").value.trim();let d=document.getElementById("donate_email").value.trim(),c=document.getElementById("coupon-input").value.trim();if(b.length)if(40<b.length)notify("\u0412\u0430\u0448 \u043d\u0438\u043a\u043d\u0435\u0439\u043c \u0441\u043b\u0438\u0448\u043a\u043e\u043c \u0434\u043b\u0438\u043d\u043d\u044b\u0439");else{/^[A-z\d_]+$/.test(b)||notify("\u041d\u0438\u043a\u043d\u0435\u0439\u043c \u043d\u0435 \u0441\u043e\u043e\u0442\u0432\u0435\u0441\u0442\u0432\u0443\u0435\u0442 \u0444\u043e\u0440\u043c\u0430\u0442\u0443");
